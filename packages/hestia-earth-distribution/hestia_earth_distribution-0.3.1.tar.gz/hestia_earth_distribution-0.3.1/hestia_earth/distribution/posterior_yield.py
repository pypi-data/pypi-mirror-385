...
def update_all_post(country_id: str, overwrite=True):
    """
    Update crop posterior yield data for a specific country and all products.
    ...
    return update_all_post_data(df_prior, country_id, overwrite=overwrite)
...
def get_post(country_id: str, product_id: str):
    ...
    """
    return get_post_data(country_id, product_id)
