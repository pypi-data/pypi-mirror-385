...
class UserDAO:
    ...
    def create(self, user: User, password: Optional[str] = None, temporary: bool = False) -> OperationResult[User]:
        ...
        try:
            ...
            if password:
                self.client.set_user_password(user.id, password, temporary=temporary)
