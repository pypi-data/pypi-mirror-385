...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ut_arr/.git/
...
git remote add ut_arr https://github.com/bs291048/ut_arr.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ut_arr'
