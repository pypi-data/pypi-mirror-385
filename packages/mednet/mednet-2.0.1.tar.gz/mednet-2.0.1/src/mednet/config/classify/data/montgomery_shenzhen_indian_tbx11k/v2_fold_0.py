...
""":py:mod:`Montgomery/Shenzhen/Indian/TBX11k aggregated database <mednet.data.classify.montgomery_shenzhen_indian_tbx11k>` (v2: healthy, sick and latent vs active TB; cross validation fold 0)."""
