...
from ..losses import BCEWithLogitsLossWeightedPerBatch
...
class Model(BaseModel):
    """Base model type for object detection tasks.
    ...
    def __init__(
        self,
        name: str,
        loss_type: type[torch.nn.Module] | None = BCEWithLogitsLossWeightedPerBatch,
