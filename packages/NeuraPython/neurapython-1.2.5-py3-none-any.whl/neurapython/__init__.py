...
def Translator(language_to_detect="English", output_language="Urdu", input_text="Hello"):
    async def _translate_async():
        ...
        if not output_lang_code:
            return f"❌ Output language '{output_language}' not supported."

        # Translate text
        translation = await translator.translate(input_text, src=detected_lang_code, dest=output_lang_code)
        return {
    ...
    # Run the async function and return result synchronously
