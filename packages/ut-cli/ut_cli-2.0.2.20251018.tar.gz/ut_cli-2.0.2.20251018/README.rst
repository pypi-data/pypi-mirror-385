...
#. **Modules**
   ...
   #. **kwargs.py** *Dictionary of Kewword Arguments Module*
   #. **task.py** *Command Line Module*
...
========
  ...
  .. table:: *Modules*
   ...
   |doeq.py  |Dictionary of Equates module         |
   +---------+-------------------------------------+
   |kwargs.py|Dictionary of Keword arguments module|
   +---------+-------------------------------------+
...
The static Class ``AoEq`` contains no variables and only static- or class-methods
to manage array of equates. Equates are statements which contains a key,
...
The static Class ``DoEq`` contains two message variables and only static- or class-methods
to manage dictionary of equates.
...
^^^^^^^
  ...
  .. table:: *Methods of class DoEq*
   ...
   |Name            |Description                                            |
   +================+=======================================================+
   |verify_key_value|Verify key, value with Parameter dictionary.           |
   +----------------+-------------------------------------------------------+
   |verify_value    |Verify value with type.                                |
   +----------------+-------------------------------------------------------+
...
""""""""""""
  ...
  .. table:: *Return Value of Method verify_key_value*
   ...
   |Name       |Type |Description                                     |
   +===========+=====+================================================+
   |key, _value|TyTup|Original key and formated value according to the|
   |           |     |type defined by he dictionary of parameters.    |
   +-----------+-----+------------------------------------------------+
...
The Method ``verify_value`` is a method without return value.
