...
@dataclass_json
@dataclass
class CtvpcBandwidthQueryRenewPriceRequest:
...
@dataclass_json
@dataclass
class CtvpcBandwidthQueryRenewPriceReturnObjSubOrderPricesOrderItemPricesResponse:
...
@dataclass_json
@dataclass
class CtvpcBandwidthQueryRenewPriceReturnObjSubOrderPricesResponse:
    serviceTag: Optional[str] = None  # 服务类型
    totalPrice: Optional[Any] = None  # 子订单总价格（单位：元）
    finalPrice: Optional[Any] = None  # 最终价格（单位：元）
    orderItemPrices: Optional[
        List[Optional[CtvpcBandwidthQueryRenewPriceReturnObjSubOrderPricesOrderItemPricesResponse]]] = None  # item价格信息


@dataclass_json
@dataclass
class CtvpcBandwidthQueryRenewPriceReturnObjResponse:
    """业务数据"""
    totalPrice: Optional[Any] = None  # 总价格（单位：元）
    discountPrice: Optional[Any] = None  # 折后价格（单位：元）
    finalPrice: Optional[Any] = None  # 最终价格（单位：元）
    subOrderPrices: Optional[
        List[Optional[CtvpcBandwidthQueryRenewPriceReturnObjSubOrderPricesResponse]]] = None  # 子订单价格信息


@dataclass_json
@dataclass
class CtvpcBandwidthQueryRenewPriceResponse:
    ...
    returnObj: Optional[CtvpcBandwidthQueryRenewPriceReturnObjResponse] = None  # 业务数据


# 续订询价。
class CtvpcBandwidthQueryRenewPriceApi:
    ...
    def do(credential: Credential, client: CtyunClient, endpoint: str,
           request: CtvpcBandwidthQueryRenewPriceRequest) -> CtvpcBandwidthQueryRenewPriceResponse:
        url = endpoint + "/v4/bandwidth/query-renew-price"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcBandwidthQueryRenewPriceResponse.from_dict(response.json())
