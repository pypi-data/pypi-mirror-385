...
@dataclass_json
@dataclass
class CtvpcBandwidthRenewRequest:
...
@dataclass_json
@dataclass
class CtvpcBandwidthRenewReturnObjResponse:
    """接口业务数据"""
...
@dataclass_json
@dataclass
class CtvpcBandwidthRenewResponse:
    ...
    returnObj: Optional[CtvpcBandwidthRenewReturnObjResponse] = None  # 接口业务数据


# 续订共享带宽
class CtvpcBandwidthRenewApi:
    ...
    def do(credential: Credential, client: CtyunClient, endpoint: str,
           request: CtvpcBandwidthRenewRequest) -> CtvpcBandwidthRenewResponse:
        url = endpoint + "/v4/bandwidth/renew"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcBandwidthRenewResponse.from_dict(response.json())
