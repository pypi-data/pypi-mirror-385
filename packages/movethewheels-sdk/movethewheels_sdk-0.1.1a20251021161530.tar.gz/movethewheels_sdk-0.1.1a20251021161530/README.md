# Movethewheels Sdk-python

A Python SDK movethewheels for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from movethewheels_sdk import BoilerSDK, BoilerSDKConfig
from movethewheels_sdk.types.common import UserRegisterInput
...
```python
from movethewheels_sdk import BoilerSDKConfig
...
pytest --cov=movethewheels_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/movethewheels-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/movethewheels-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../movethewheels-frontend) - Frontend movethewheels
- [Boiler Backend](../movethewheels-python-be-graphql) - Python GraphQL backend movethewheels