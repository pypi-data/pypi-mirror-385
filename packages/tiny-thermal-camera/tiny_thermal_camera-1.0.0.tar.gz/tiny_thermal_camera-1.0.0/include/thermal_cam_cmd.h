...
#include "all_config.h"
     ...
     * @file
     *
     * @brief Header file for command of ac010 chips
     *
     */

#if defined(THERMAL_CAM_CMD)
#pragma pack (1)
    ...
    enum prop_image_params
    {
        ...
        /// DDE(digital detail enhance) level.Range:0-3, 4 is manual mode.
    ...
    enum pseudo_color_types
    {
        ...
        PSEUDO_COLOR_MODE_2,
        /// pseudo color mode 3
        PSEUDO_COLOR_MODE_3 = 3,
        /// pseudo color mode 4
        PSEUDO_COLOR_MODE_4 = 4,
        /// pseudo color mode 5
        PSEUDO_COLOR_MODE_5 = 5,
        /// pseudo color mode 6
        PSEUDO_COLOR_MODE_6 = 6,
        /// pseudo color mode 7
        PSEUDO_COLOR_MODE_7 = 7,
        /// pseudo color mode 8
        PSEUDO_COLOR_MODE_8 = 8,
        /// pseudo color mode 9
        PSEUDO_COLOR_MODE_9 = 9,
        /// pseudo color mode 10
        PSEUDO_COLOR_MODE_10 = 10,
        /// pseudo color mode 11
        PSEUDO_COLOR_MODE_11 = 11,
        /// pseudo color mode 12
        PSEUDO_COLOR_MODE_12 = 12,
    };
    ...
    /**
     * @brief Voltage select types value
     */
    enum voltage_select_types
    {
        /// voltage = 3.3V
        VOLTAGE_3_3V = 0,
        /// voltage = 1.8V
...
#pragma pack()
    ...
    /**
     * @brief Set property page's overexposure parameters,unsupported for tc module.
     *
    ...
    /**
     * @brief Get property page's overexposure parameters,unsupported for tc module.
     *
     * @param[in] ovexp_param overexposure's parameter type
    ...
    /**
     * @brief Get tpd nuc_t table for TC1C_256 and TC1C_160
     *
     * @param[out] value tpd's parameter value
     *
     * @return see iruvc_error_t
    ...
    /**
     * @brief Set a PN string,unsupported for tc module.
     *
    ...
    /**
     * @brief Get a SN string,unsupported for tc module.
     *
    ...
    /**
     * @brief Set a SN string,unsupported for tc module.
     *
    ...
    /**
     * @brief Start capture mode,unsupported for tc module.
     *
     *
     * @return see iruvc_error_t
     */
    ...
    /**
     * @brief Get capture data,unsupported for tc module.
     *
     *
     * @return see iruvc_error_t
     */
    ...
    /**
     * @brief Exit capture mode,unsupported for tc module.
     *
     *
     * @return see iruvc_error_t
     */
    ...
    /**
     * @brief Get current shutter's vtemp.unsupported for tc module.
     *
    ...
    /**
     * @brief Get current vtemp of the lens.unsupported for tc module.
     *
     * @param[in] cur_vtemp vtemp
     *
     * @return see iruvc_error_t
    ...
    /**
     * @brief Get current tecless temp area,unsupported for tc module.
     *
    ...
    /**
     * @brief Calculate the lens k.unsupported for tc module.
     *
     * @return see iruvc_error_t
     */
    ...
    /**
     * @brief Get the distance value of tpd module,unsupported for tc module.
     *
    ...
    /**
     * @brief switch voltage in dvp. only support WN256
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t switch_dvp_voltage(void);

    /**
     * @brief select voltage in dvp. only support WN256
     * @param[in] 
     * 
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t select_dvp_voltage(enum voltage_select_types);


    /**
     * @brief set vospi y8 mode
     * @param[in] enable Y8 mode(0:disable/1:enable)
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t set_vospi_y8_mode(uint8_t enable);


    /**
     * @brief get vospi y8 mode
     * @param[in] enable Y8 mode(0:disable/1:enable)
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t get_vospi_y8_mode(uint8_t* enable);


    /**
     * @brief switch fps
     * @param[in] flag 0:disable 25fps   1:enable 25fps
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t switch_fps(uint8_t flag);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t get_tpd_kt_array(uint8_t* data);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t set_tpd_kt_array(uint8_t* data);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t get_tpd_bt_array(uint8_t* data);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t set_tpd_bt_array(uint8_t* data);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t get_tpd_nuc_t_array(uint8_t* data);
     ...
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t set_tpd_nuc_t_array(uint8_t* data);


    /**
     * @brief set nuc-t array to ddr
     * @param[out] data the nuc-t array (size:8192*2 bytes)
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t set_tpd_nuc_t_array_to_ddr(uint8_t* data);


    /**
     * @brief get tpd calibration parameter(include Ktemp,Btemp,AddressCA)
     * @param[out] temp_param_t  the calibration parameter for corrcetion
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t get_tpd_calib_param(TempCalibParam_t* temp_calib_param);


    /**
    * @brief Read data from flash's OEM section
    *
    * @param[in] dev_type supported device types
    * @param[in] data_len the data length(max number 4096)
    * @param[out] data the data read from memory
    *
    * @return see iruvc_error_t
    */
    DLLEXPORT iruvc_error_t oem_read(enum device_types dev_type, uint16_t data_len, uint8_t* data);

    /**
     * @brief Write data from flash's OEM section
     * When this interface is called, the entire oem area is completely erased from all previous data
     *
     * @param[in] dev_type supported device types
     * @param[in] data_len the data length(max number 4096)
     * @param[in] data the data write to memory
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t oem_write(enum device_types dev_type, uint16_t data_len, uint8_t* data);

    /**
     * @brief Erase data in flash's OEM section,erase 4096 bytes
     * 
     * @param[in] dev_type supported device types
     *
     * @return see iruvc_error_t
     */
    DLLEXPORT iruvc_error_t oem_erase(enum device_types dev_type);
