...
class S3Uploader(object):
    ...
    def __init__(self, s3_client, bucket_name, prefix=None, kms_key_id=None, force_upload=False, transfer_manager=None):
    ...
    def upload(self, file_name, remote_path):
        ...
        if not self.force_upload and self.file_exists(remote_path):
            LOG.debug("File with same data already exists at {0}. " "Skipping upload".format(remote_path))
