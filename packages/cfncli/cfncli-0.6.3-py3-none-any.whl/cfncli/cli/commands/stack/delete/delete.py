...
def delete(ctx, quiet, no_wait, ignore_missing, show_physical_ids):
    """Delete stacks.
    ...
    options = StackDeleteOptions(no_wait=no_wait, ignore_missing=ignore_missing, show_physical_ids=show_physical_ids)
