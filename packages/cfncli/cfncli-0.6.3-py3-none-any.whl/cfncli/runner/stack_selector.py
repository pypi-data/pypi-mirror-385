...
class StackSelector(object):
    ...
    def matches(self, qualified_name):
        ...
        return fnmatch.fnmatchcase(stage_name, self.stage_pattern) and fnmatch.fnmatchcase(
            stack_name, self.stack_pattern
        )

    def __repr__(self):
        return "{}({}.{})".format(self.__class__.__name__, self.stage_pattern, self.stack_pattern)
