...
class SemanticCacheStats(BaseModel):
    ...
    SemanticCacheStats
    """ # noqa: E501
    avg_similarity_score: Union[StrictFloat, StrictInt] = Field(description="Average similarity score for cache hits")
    cost_saved: Union[StrictFloat, StrictInt] = Field(description="Total cost saved from cache hits")
    hit_rate: Union[StrictFloat, StrictInt] = Field(description="Cache hit rate as a percentage")
    tokens_saved: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total tokens saved from cache hits")
    total_hits: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of cache hits")
    total_misses: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of cache misses")
    __properties: ClassVar[List[str]] = ["avg_similarity_score", "cost_saved", "hit_rate", "tokens_saved", "total_hits", "total_misses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "avg_similarity_score": obj.get("avg_similarity_score"),
            "cost_saved": obj.get("cost_saved"),
            "hit_rate": obj.get("hit_rate"),
            "tokens_saved": obj.get("tokens_saved"),
            "total_hits": obj.get("total_hits"),
            "total_misses": obj.get("total_misses")
        })
        return _obj
