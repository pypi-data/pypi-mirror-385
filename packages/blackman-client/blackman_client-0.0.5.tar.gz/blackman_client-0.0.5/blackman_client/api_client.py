...
from blackman_client.configuration import Configuration
from blackman_client.api_response import ApiResponse, T as ApiResponseT
import blackman_client.models
from blackman_client import rest
from blackman_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(blackman_client.models, klass)
