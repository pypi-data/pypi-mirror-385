...
class TestSemanticCacheStats(unittest.TestCase):
    """SemanticCacheStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SemanticCacheStats:
        ...
        """
        model = SemanticCacheStats()
        if include_optional:
            return SemanticCacheStats(
                avg_similarity_score = 1.337,
                cost_saved = 1.337,
                hit_rate = 1.337,
                tokens_saved = 0,
                total_hits = 0,
    ...
    def testSemanticCacheStats(self):
        """Test SemanticCacheStats"""
