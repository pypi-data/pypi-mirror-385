...
class TestCompletionOptions(unittest.TestCase):
    """CompletionOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompletionOptions:
    ...
    def testCompletionOptions(self):
        """Test CompletionOptions"""
