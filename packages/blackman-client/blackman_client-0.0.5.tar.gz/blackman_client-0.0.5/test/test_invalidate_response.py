...
class TestInvalidateResponse(unittest.TestCase):
    """InvalidateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvalidateResponse:
    ...
    def testInvalidateResponse(self):
        """Test InvalidateResponse"""
