...
class DatasetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListDataset = channel.unary_unary(
                '/DatasetService/ListDataset',
                request_serializer=data_dot_v1_dot_dataset__pb2.ListDatasetRequest.SerializeToString,
                response_deserializer=data_dot_v1_dot_dataset__pb2.ListDatasetResponse.FromString,
                )
...
def add_DatasetServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListDataset': grpc.unary_unary_rpc_method_handler(
                    servicer.ListDataset,
                    request_deserializer=data_dot_v1_dot_dataset__pb2.ListDatasetRequest.FromString,
                    response_serializer=data_dot_v1_dot_dataset__pb2.ListDatasetResponse.SerializeToString,
            ),
...
class DatasetService(object):
    ...
    def ListDataset(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DatasetService/ListDataset',
            data_dot_v1_dot_dataset__pb2.ListDatasetRequest.SerializeToString,
            data_dot_v1_dot_dataset__pb2.ListDatasetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
