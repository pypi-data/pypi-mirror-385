...
setup(
    ...
    version="0.2.4",                        # bump when you publish
    description="A Python package for developing extreme water level prediction models using a Bi-LSTM architecture with custom attention, designed to transfer trained models across gauging stations.",
