...
def test_scinum_trailing_zeros():
    assert scinum(340, no_trailing_zeros=True) == r"340\,"
    assert scinum(340, no_trailing_zeros=False) == r"340.00\,"
    assert scinum(340, no_trailing_zeros=False, ndigits=4) == r"340.0000\,"
    assert (
