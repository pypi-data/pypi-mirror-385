...
class CommonSettings(BaseSettings):
    ...
    AUTH_HOST: str = Field(
        default="http://localhost:8001", description="Authentication service host"
    )
    AUTH_ENABLED: bool = Field(default=True, description="Enable authentication system")
    AUTH_API_VERSION: str = Field(
        default="v1", description="Authentication API version"
    )

    # Database Settings
    MONGODB_SERVER: str = Field(default="localhost:27017", description="MongoDB host")
