...
1. ALPHA (α)
   ...
   - Interpretation:
     * α > 0 and significant: Strategy adds value (skill)
     * α ≈ 0 or not significant: Returns explained by factor exposures
     * α < 0: Strategy destroys value
...
5. TIMING COEFFICIENT (γ)
   - What it means: Market timing ability
   - Good values: γ > 0 and statistically significant
   - Interpretation:
     * γ > 0: Higher exposure in up markets (good timing)
     * γ < 0: Lower exposure in up markets (poor timing)
