...
from selenium_package.actions import CloseAllTabsExceptThatHasTitle
...
class TestCloseAllTabsExceptThatHasTitle:
    def test_if_raises_value_error_if_title_is_not_str(self):
        with pytest.raises(ValueError):
            CloseAllTabsExceptThatHasTitle(
    ...
    def test_if_closes_all_tabs_except_the_one_with_desired_title(
        ...
        # Make sure it did NOT close the tab with the desired title
        assert 'id_2' in switched_tabs
