...
class DocumentApp(App[None]):
    ...
    def show_help(self) -> None:
        ...
        conv_log.write("")
        conv_log.write("[bold]⚡ Session Control[/bold]")
        conv_log.write("• /[bold]help[/bold] - Show this help message")
        conv_log.write("• /[bold]exit[/bold] or /[bold]quit[/bold] - Exit clippy-code")
        conv_log.write(
            "• /[bold]reset[/bold], /[bold]clear[/bold], /[bold]new[/bold] - Reset conversation"
        )
        conv_log.write("")
        ...
        conv_log.write("")
        conv_log.write("[bold]🤖 Model Management[/bold]")
        ...
        conv_log.write(
            "• /[bold]subagent set <type> <model>[/bold] - Set model for a subagent type"
        )
        conv_log.write("• /[bold]subagent clear <type>[/bold] - Clear model override")
        conv_log.write("• /[bold]subagent reset[/bold] - Clear all model overrides")
        conv_log.write("")
        conv_log.write("[bold]🌐 Providers[/bold]")
        conv_log.write("• /[bold]providers[/bold] - List available providers")
        conv_log.write("• /[bold]provider <name>[/bold] - Show provider details")
        conv_log.write("")
        conv_log.write("[bold]🔐 Permissions[/bold]")
        ...
        conv_log.write("")
        conv_log.write("[bold]🔌 MCP Servers[/bold]")
