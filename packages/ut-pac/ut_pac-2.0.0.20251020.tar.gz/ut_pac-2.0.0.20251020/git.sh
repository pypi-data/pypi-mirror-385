...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ut_uts/.git/

# Add Remote Repository: Link your local repository to the GitHub repository you created:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ut_uts
git remote add ut_uts https://github.com/bs291048/ut_uts.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ut_uts'
