...
The Module ``aopac.py`` contains the static class ``AoPac``

Class: AoPac
------------

The static Class ``AoPac`` provides methods for package arrays;
it contains the subsequent methods.

Methods
^^^^^^^

  .. Methods-of-class-AoPac-label:
  .. table:: *Methods-of-class-AoPac*

   +----------------------------+--------------------------------------+
   |Name                        |Description                           |
   +============================+======================================+
   |sh_path_by_path_if_exists   |Show the path, if it exists, from the |
   |                            |iteration of the paths created by the |
   |                            |array of packages and the given path. |
   +----------------------------+--------------------------------------+
   |sh_aopath_by_path           |Show the array of paths created by the|
   |                            |array of packages and the given path. |
   +----------------------------+--------------------------------------+
   |sh_aopath_by_path_and_prefix|Show the array of paths created by the|
   |                            |array of packages and the given path  |
   |                            |extended by the given prefix.         |
   +----------------------------+--------------------------------------+

Method: sh_path_by_path_if_exists
"""""""""""""""""""""""""""""""""

Parameter
.........

  .. Parameter-of-sh_path_by_path_if_exists-label:
  .. table:: *Parameter of sh_path_by_path_if_exists*

   +-----+-------+-------------+
   |Name |Type   |Description  |
   +=====+=======+=============+
   |aopac|TyAoPac|Package array|
   +-----+-------+-------------+
   |path |TyPath |Path         |
   +-----+-------+-------------+
...
............
  ...
  .. Return-value-of-sh_path_by_path_if_exists-label:
  .. table:: *Return value of sh_path_by_path_if_exists*
...
Method: sh_aopath_by_path
"""""""""""""""""""""""""

Parameter
.........

  .. Parameter-of-sh_aopath_by_path-label:
  .. table:: *Parameter of aopath_by_path*
...
............
  ...
  .. Return-value-of-sh_aopath_by_path-label:
  .. table:: *Return value of sh_aopath_by_path*

   +-------+------+-------------+
   |Name   |Type  |Description  |
   +=======+======+=============+
   |_aopath|TyPath|Package array|
   +-------+------+-------------+

Method: sh_aopath_by_path_and_prefix
""""""""""""""""""""""""""""""""""""

Parameter
.........

  .. Parameter-of-sh_aopath_by_path_and_prefix-label:
  .. table:: *Parameter of sh_aopath_by_path_and_prefix*
...
............
  ...
  .. Return-value-of-sh_aopath_by_path_and_prefix-label:
  .. table:: *Return value of sh_aopath_by_path_and_prefix*
...
The Module ``cls.py`` contains the static class ``Cls``

Class: Cls
----------

The static Class ``Cls`` provides methods for application classes;
it contains the subsequent methods.
...
^^^^^^^
  ...
  .. table:: *Methods-of-class-AoPac*
   ...
   |                  |array of packages and the given path. |
   +------------------+--------------------------------------+
   |sh_aopath_by_paths|Show the array of paths created by the|
   |                  |array of packages and the given path  |
   |                  |extended by the given prefix.         |
   +------------------+--------------------------------------+
