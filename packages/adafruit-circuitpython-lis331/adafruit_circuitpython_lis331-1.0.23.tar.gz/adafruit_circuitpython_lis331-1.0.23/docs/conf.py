...
htmlhelp_basename = "AdafruitLis331Librarydoc"
...
latex_documents = [
    (
        master_doc,
        "AdafruitLIS331Library.tex",
        "AdafruitLIS331 Library Documentation",
        author,
        "manual",
    ),
]
...
man_pages = [
    (
        master_doc,
        "AdafruitLIS331library",
        "Adafruit LIS331 Library Documentation",
        [author],
        1,
    ),
]
