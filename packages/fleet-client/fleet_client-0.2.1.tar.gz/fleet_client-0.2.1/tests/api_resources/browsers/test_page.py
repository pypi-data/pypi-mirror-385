...
class TestPage:
    ...
    def test_raw_response_get(self, client: Fleet) -> None:
        response = client.browsers.page.with_raw_response.get(
            "browser_id",
        )
    ...
    def test_streaming_response_get(self, client: Fleet) -> None:
        with client.browsers.page.with_streaming_response.get(
            "browser_id",
        ) as response:
    ...
    def test_path_params_get(self, client: Fleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            client.browsers.page.with_raw_response.get(
                "",
            )
    ...
    def test_method_get_full(self, client: Fleet) -> None:
        page = client.browsers.page.get_full(
            "browser_id",
        )
    ...
    def test_raw_response_get_full(self, client: Fleet) -> None:
        response = client.browsers.page.with_raw_response.get_full(
            "browser_id",
        )
    ...
    def test_streaming_response_get_full(self, client: Fleet) -> None:
        with client.browsers.page.with_streaming_response.get_full(
            "browser_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get_full(self, client: Fleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            client.browsers.page.with_raw_response.get_full(
                "",
            )
    ...
    def test_method_get_text(self, client: Fleet) -> None:
        page = client.browsers.page.get_text(
            "browser_id",
        )
    ...
    def test_raw_response_get_text(self, client: Fleet) -> None:
        response = client.browsers.page.with_raw_response.get_text(
            "browser_id",
        )
    ...
    def test_streaming_response_get_text(self, client: Fleet) -> None:
        with client.browsers.page.with_streaming_response.get_text(
            "browser_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get_text(self, client: Fleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            client.browsers.page.with_raw_response.get_text(
                "",
            )
...
class TestAsyncPage:
    ...
    async def test_method_get(self, async_client: AsyncFleet) -> None:
        page = await async_client.browsers.page.get(
            "browser_id",
        )
        assert_matches_type(PageGetResponse, page, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncFleet) -> None:
        response = await async_client.browsers.page.with_raw_response.get(
            "browser_id",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncFleet) -> None:
        async with async_client.browsers.page.with_streaming_response.get(
            "browser_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncFleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            await async_client.browsers.page.with_raw_response.get(
                "",
            )
    ...
    async def test_method_get_full(self, async_client: AsyncFleet) -> None:
        page = await async_client.browsers.page.get_full(
            "browser_id",
        )
        assert_matches_type(PageGetFullResponse, page, path=["response"])
    ...
    async def test_raw_response_get_full(self, async_client: AsyncFleet) -> None:
        response = await async_client.browsers.page.with_raw_response.get_full(
            "browser_id",
        )
    ...
    async def test_streaming_response_get_full(self, async_client: AsyncFleet) -> None:
        async with async_client.browsers.page.with_streaming_response.get_full(
            "browser_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_full(self, async_client: AsyncFleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            await async_client.browsers.page.with_raw_response.get_full(
                "",
            )
    ...
    async def test_method_get_text(self, async_client: AsyncFleet) -> None:
        page = await async_client.browsers.page.get_text(
            "browser_id",
        )
        assert_matches_type(PageGetTextResponse, page, path=["response"])
    ...
    async def test_raw_response_get_text(self, async_client: AsyncFleet) -> None:
        response = await async_client.browsers.page.with_raw_response.get_text(
            "browser_id",
        )
    ...
    async def test_streaming_response_get_text(self, async_client: AsyncFleet) -> None:
        async with async_client.browsers.page.with_streaming_response.get_text(
            "browser_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_text(self, async_client: AsyncFleet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_id` but received ''"):
            await async_client.browsers.page.with_raw_response.get_text(
                "",
            )
