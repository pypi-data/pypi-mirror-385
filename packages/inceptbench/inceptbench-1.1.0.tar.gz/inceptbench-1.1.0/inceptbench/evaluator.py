...
# Import evaluate_content directly to avoid triggering full dependency chain
try:
    from edu_agents.eval.content_evaluator import evaluate_content
except ImportError:
    # Fallback if the module structure changes
    try:
        from edu_agents.eval import evaluate_content
    except ImportError:
        evaluate_content = None
