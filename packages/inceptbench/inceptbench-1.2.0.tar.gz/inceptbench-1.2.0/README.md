...
Educational question evaluation CLI tool with comprehensive AI-powered assessment. Evaluates questions locally using multiple evaluation modules including ti_question_qa, answer_verification, reading_question_qc, and EduBench tasks.
...
**Available Modules:**
- `ti_question_qa` - Internal evaluator (scaffolding + DI compliance)
...
### ti_question_qa (Internal Evaluator)
