...
def _import_evaluate_content():
    ...
    try:
        ...
        # First, ensure api_key_manager can be imported (content_evaluator depends on it)
        ...
        # Now load content_evaluator directly
        spec = importlib.util.spec_from_file_location("_content_evaluator_direct", content_eval_path)
