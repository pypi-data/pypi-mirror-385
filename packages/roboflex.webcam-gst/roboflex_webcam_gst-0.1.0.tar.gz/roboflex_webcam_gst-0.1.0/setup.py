...
setup(
    ...
    url="https://github.com/flexrobotics/roboflex_webcam_gst",
    ...
    ext_modules=[CMakeExtension('roboflex/webcam_gst/roboflex_webcam_gst_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.webcam_gst'],
    package_dir={'roboflex.webcam_gst': 'python'},
)
