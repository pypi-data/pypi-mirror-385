...
async def get_version_tool() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "description": "DcisionAI MCP Server v2.1 - Modular Architecture with OR-Tools MathOpt Integration + Trust Validation",
            "features": [
                "Modular Architecture",
                "OR-Tools MathOpt Integration",
                "Enhanced JSON Serialization",
                "Complete Optimization Workflow",
                "8 Optimization Tools (including Trust Validation)",
