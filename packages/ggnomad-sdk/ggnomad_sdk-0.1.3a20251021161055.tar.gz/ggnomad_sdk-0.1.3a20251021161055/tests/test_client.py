...
import httpx
from ggnomad_sdk.client.base_client import BaseGraphQLClient, GGNomadSDKConfig, AuthTokens


def test_config_creation():
    """Test GGNomadSDKConfig creation"""
...
def test_headers_generation():
    ...
    config = GGNomadSDKConfig(endpoint="https://api.test.com/graphql", api_key="test-key")
    client = BaseGraphQLClient(config)
