"""
Advanced usage example for GGNomad SDK Python
...
async def advanced_example():
    ...
    async with GGNomadSDK(config).client as client:
        ...
        try:
            ...
            if existing_tokens:
                print(
                    f"Using existing tokens: "
                    f"{existing_tokens['access_token'][:20]}..."
                )
            else:
            ...
            try:
                ...
                print(f"Available workspaces: {workspace_count}")
...
async def token_refresh_example():
    ...
    """
    config = GGNomadSDKConfig(endpoint="https://api.example.com/graphql")
