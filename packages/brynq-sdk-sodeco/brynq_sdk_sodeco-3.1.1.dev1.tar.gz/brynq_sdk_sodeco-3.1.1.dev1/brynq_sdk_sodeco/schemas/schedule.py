...
class ScheduleWeekGet(BrynQPanderaDataFrameModel):
    ...
    week_number: Series[pd.Int64Dtype] = pa.Field(coerce=True, nullable=False, description="Week number", alias="WeekNumber")
    day_1: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 1", alias="Day1")
    day_2: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 2", alias="Day2")
    day_3: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 3", alias="Day3")
    day_4: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 4", alias="Day4")
    day_5: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 5", alias="Day5")
    day_6: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 6", alias="Day6")
    day_7: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Hours for day 7", alias="Day7")
...
class ScheduleGet(BrynQPanderaDataFrameModel):
    ...
    schedule_id: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Schedule identifier", alias="ScheduleID")
    description: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Schedule description", alias="Description")
    start_date: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Schedule start date in YYYYMMDD format", alias="StartDate")
    week: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Week data as JSON string", alias="Week")
    employer: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Employer name", alias="employer")
