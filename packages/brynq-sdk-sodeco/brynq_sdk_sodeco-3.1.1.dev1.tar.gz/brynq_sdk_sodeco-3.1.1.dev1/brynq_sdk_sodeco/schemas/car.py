...
class CarCreate(BaseModel):
    ...
    worker_id: Optional[int] = Field(None, alias="WorkerId", description="Worker ID associated with the car", example=12345)
...
class CarGet(BrynQPanderaDataFrameModel):
    ...
    # Required fields
    starting_date: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Car start date in YYYYMMDD format", alias="StartingDate")
    license_plate: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Car license plate number", alias="LicensePlate")

    # Optional fields
    ending_date: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Car end date in YYYYMMDD format", alias="EndingDate")
    worker_id: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="Worker ID associated with the car", alias="WorkerId")
    ...
    motor_type: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Type of motor/engine", alias="MotorType")
    tax_horsepower: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="Tax horsepower rating", alias="TaxHorsepower")
    co2_emissions_hybride_wltp: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="CO2 emissions hybrid WLTP", alias="Co2EmissionsHybrideWLTP")
    co2_emissions_hybride: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="CO2 emissions hybrid", alias="Co2EmissionsHybride")
    co2_emissions_wltp: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="CO2 emissions WLTP", alias="Co2EmissionsWLTP")
    co2_emissions: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="CO2 emissions", alias="Co2Emissions")
    code: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="Salary code for car benefits", alias="Code")
    fuel_card: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Fuel card number", alias="FuelCard")
    brand: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Car brand/manufacturer", alias="Brand")
    order_date: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Car order date in YYYYMMDD format", alias="OrderDate")
    registration_date: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Car registration date in YYYYMMDD format", alias="RegistrationDate")
    catalog_price: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Car catalog price", alias="CatalogPrice")
    informative: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Is this entry informative only", alias="Informative")
    light_truck: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Is this a light truck", alias="LightTruck")
    pool_car: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Is this a pool car", alias="PoolCar")
    pers_contribution_amount: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Personal contribution amount", alias="PersContributionAmount")
    pers_contribution_percentage: Optional[Series[pd.Float64Dtype]] = pa.Field(coerce=True, nullable=True, description="Personal contribution percentage", alias="PersContributionPercentage")
    pers_contribution_code: Optional[Series[pd.Int64Dtype]] = pa.Field(coerce=True, nullable=True, description="Personal contribution salary code", alias="PersContributionCode")
    pers_contribution_startdate: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Personal contribution start date in YYYYMMDD format", alias="PersContributionStartdate")
    pers_contribution_enddate: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Personal contribution end date in YYYYMMDD format", alias="PersContributionEnddate")
