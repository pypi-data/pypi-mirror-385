...
class CommunicationGet(BrynQPanderaDataFrameModel):
    ...
    # Required fields
    communication_type: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Type of communication method", alias="CommunicationType")
    value: Series[pd.StringDtype] = pa.Field(coerce=True, nullable=False, description="Communication value (phone number, email, etc.)", alias="Value")

    # Optional fields
    id: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Communication ID", alias="ID")
    contact_person: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Contact person name", alias="ContactPerson")
    contact_person_firstname: Optional[Series[pd.StringDtype]] = pa.Field(coerce=True, nullable=True, description="Contact person first name", alias="ContactPersonFirstname")
