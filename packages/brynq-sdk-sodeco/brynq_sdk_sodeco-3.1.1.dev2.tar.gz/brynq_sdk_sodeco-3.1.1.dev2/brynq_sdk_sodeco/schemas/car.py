...
class CarGet(BrynQPanderaDataFrameModel):
    ...
    worker_id: Optional[int] = pa.Field(coerce=True, nullable=True, description="Worker ID associated with the car", alias="WorkerId")
    cat_rsz: Optional[str] = pa.Field(coerce=True, nullable=True, description="Social security category code", alias="CatRSZ")
    motor_type: Optional[MotorTypeEnum] = pa.Field(coerce=True, nullable=True, description="Type of motor/engine", alias="MotorType")
    ...
    informative: Optional[YesNoEnum] = pa.Field(coerce=True, nullable=True, description="Is this entry informative only", alias="Informative")
    light_truck: Optional[YesNoEnum] = pa.Field(coerce=True, nullable=True, description="Is this a light truck", alias="LightTruck")
    pool_car: Optional[YesNoEnum] = pa.Field(coerce=True, nullable=True, description="Is this a pool car", alias="PoolCar")
