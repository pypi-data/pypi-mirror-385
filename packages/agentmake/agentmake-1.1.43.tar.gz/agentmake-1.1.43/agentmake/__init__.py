        ...
        if agent_response is not None:
            ...
            if func:
                ...
                try:
                    ...
                    if not dictionary_output:
                        try:
                            function_response = func()
                        except:
                            # Note: When user use keyboard to interrupt with `Cltr+C`, the `getDictionaryOutput` function returns {}, which breaks func with required arguments.
                            return []
                    else:
                        function_response = func(
                            **dictionary_output,
