...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v2/external/auth/login",
    }
...
) -> Optional[Union[HTTPValidationError, LoginResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, LoginResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, LoginResponse]
    """
