...
T = TypeVar("T", bound="AiAgentToolsItemRetryExponential")


@_attrs_define
class AiAgentToolsItemRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ai_agent_tools_item_retry_exponential = cls(
            attempts=attempts,
        ...
        ai_agent_tools_item_retry_exponential.additional_properties = d
        return ai_agent_tools_item_retry_exponential
