...
T = TypeVar("T", bound="AiAgentToolsItemStopAfterIf")


@_attrs_define
class AiAgentToolsItemStopAfterIf:
    """
    Attributes:
        expr (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ai_agent_tools_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        ai_agent_tools_item_stop_after_if.additional_properties = d
        return ai_agent_tools_item_stop_after_if
