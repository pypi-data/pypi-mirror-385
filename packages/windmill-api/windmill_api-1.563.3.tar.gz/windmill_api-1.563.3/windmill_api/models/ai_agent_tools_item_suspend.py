...
if TYPE_CHECKING:
    from ..models.ai_agent_tools_item_suspend_resume_form import AiAgentToolsItemSuspendResumeForm
    from ..models.ai_agent_tools_item_suspend_user_groups_required_type_0 import (
        AiAgentToolsItemSuspendUserGroupsRequiredType0,
    )
    from ..models.ai_agent_tools_item_suspend_user_groups_required_type_1 import (
        AiAgentToolsItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="AiAgentToolsItemSuspend")


@_attrs_define
class AiAgentToolsItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, AiAgentToolsItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['AiAgentToolsItemSuspendUserGroupsRequiredType0',
            'AiAgentToolsItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "AiAgentToolsItemSuspendResumeForm"] = UNSET
    user_auth_required: Union[Unset, bool] = UNSET
    user_groups_required: Union[
        "AiAgentToolsItemSuspendUserGroupsRequiredType0", "AiAgentToolsItemSuspendUserGroupsRequiredType1", Unset
    ] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, AiAgentToolsItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = AiAgentToolsItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, AiAgentToolsItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = AiAgentToolsItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, AiAgentToolsItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = AiAgentToolsItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        ai_agent_tools_item_suspend = cls(
        ...
        ai_agent_tools_item_suspend.additional_properties = d
        return ai_agent_tools_item_suspend
