...
**Utilities for Tuples of Dictionaries**
...
Package ``ut_tod`` can be installed from PyPI.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ut_tod
...
The Package ``ut_tod`` consist of the following file types (c.f.: **Appendix**: `Python Glossary`):
...
#. **Modules**
   ...
   #. **Module for Dictionaries**
      ...
      a. *tod.py* `Management of Tuples of Dictionaries`

********************************
Module forTuple of  Dictionaries
********************************

Module: tod
===========

Classes of module: tod
----------------------

The Module ``tod.py`` contains the followinga static classes:

   +----+-----------------------------------+
   |Name|Description                        |
   +====+===================================+
   |ToD |Management of Tuple of Dictionaries|
   +----+-----------------------------------+

Class: Dic of module: tod
-------------------------

The static Class ``ToD`` is used to manage Dictionaries;
The Methods of Class ``ToD`` could be classified into the following method types:
...
Miscellenous Methods of Class: ToD
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

  .. Miscellenous-Methods-of-class-ToD-label:
  .. table:: *Miscellenous Methods of class ToD*
   ...
   +-------------------------+-----------------------------------------------------------------+
   |change_filter_keys_by_dic|Change the keys of the dictionary by the values of the keyfilter.|
   +-------------------------+-----------------------------------------------------------------+
   |change_keys_by_dic       |Change the keys of the dictionary by the values of the keyfilter |
   |                         |Dictionary with the same keys.                                   |
   +-------------------------+-----------------------------------------------------------------+
   |merge                    |Merge two dictionaries                                           |
   +-------------------------+-----------------------------------------------------------------+
   |new_d_index_d_values     |Create index and value dictionary from dictionary and pivot      |
   |                         |dictionary.                                                      |
   +-------------------------+-----------------------------------------------------------------+
   |union                    |                                                                 |
   +-------------------------+-----------------------------------------------------------------+

Set Methods of class: ToD
^^^^^^^^^^^^^^^^^^^^^^^^^

  .. Set-Methods-of_class-ToD-label:
  .. table:: *Set Methods of class ToD*

   +--------------------------------------+-----------------------------------------------------------------+
   |set_first_tgt_with_src_by_d_src2tgt   |Replace value of first dictionary target key found in the source |
   |                                      |to target dictionary by the source value found in the dictionary.|
   +--------------------------------------+-----------------------------------------------------------------+
   |set_first_tgt_with_src_by_d_tgt2src   |Replace value of first dictionary target key found in the target |
   ...
   +--------------------------------------+-----------------------------------------------------------------+
   |set_tgt_with_src_by_doaod_tgt2src     |Loop through the target to source dictionaries of the values of  |
   |                                      |the dictionary of the arrays of target to source dictionaries    |
   |                                      |until the return value of the function                           | 
   |                                      |"set_nonempty_tgt_with_src_by_d_tgt2src" is defined.             |
   +--------------------------------------+-----------------------------------------------------------------+
   |set_nonempty_tgt_with_src_by_d_tgt2src|Execute the function "set_tgt_with_src_by_d_tgt2src" if all      |
   |                                      |dictionary values for the keys provided by the values|of the     |
   |                                      |target to source dictionary are defined.                         |
   +--------------------------------------+-----------------------------------------------------------------+
   |set_tgt_with_src_by_d_src2tgt         |                                                                 |
   +--------------------------------------+-----------------------------------------------------------------+
   |set_tgt_with_src_by_d_tgt2src         |                                                                 |
   +--------------------------------------+-----------------------------------------------------------------+

Yield Methods of class ToD
^^^^^^^^^^^^^^^^^^^^^^^^^^

  .. Yield-Methods-of-class-ToD-label:
  .. table:: *Yield Methods of class ToD*
