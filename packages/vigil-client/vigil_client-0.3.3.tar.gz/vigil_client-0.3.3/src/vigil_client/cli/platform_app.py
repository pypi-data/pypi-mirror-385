...
def config_get() -> None:
    ...
    from .config import get_config as get_config_func
    get_config_func()

def config_set_remote(url: str) -> None:
    """Set the platform URL."""
    from .config import set_remote as set_remote_func
    set_remote_func(url)
...
def config_get() -> None:
    """Show current config (project, org, API URL, token expiry)."""
    get_config()
