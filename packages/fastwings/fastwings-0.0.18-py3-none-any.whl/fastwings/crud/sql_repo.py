...
class SQLRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
...
class SoftDeletableRepository(SQLRepository[ModelType, CreateSchemaType, UpdateSchemaType]):
    """CRUD repository supporting soft deletion.
