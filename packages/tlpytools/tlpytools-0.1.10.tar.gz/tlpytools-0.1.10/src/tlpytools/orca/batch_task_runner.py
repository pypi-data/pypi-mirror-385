...
class BatchTaskRunner:
    ...
    def _build_python_options(self, databank_name: str, project_name: str) -> str:
        ...
        return f"--databank {databank_name} --project-folder {project_name} --action run_models --mode cloud_production"
...
def main():
    ...
    parser.add_argument("--databank-name", required=True, help="Databank name")
