...
Examples:
  ...
  python -m tlpytools.orca.cli --action adls_sync --databank db_test --sync-action upload --project-folder my_custom_project
  ...
  python -m tlpytools.orca.cli --action run_models --databank db_test --mode cloud_production --iterations 3 --resume --project-folder my_custom_project
        """,
    )
    ...
    if args.action == "run_models":
        ...
        if args.project_folder:
            action_logger.info("Project folder (override): %s", args.project_folder)
