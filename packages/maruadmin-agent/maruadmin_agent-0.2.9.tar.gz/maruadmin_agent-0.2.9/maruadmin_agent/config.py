...
class AgentConfig:
    ...
    certificate_domain: Optional[str] = None  # Domain for certificate (full name)
    cert_reuse: bool = True  # Allow certificate reuse (backend alias)
    cert_domain: Optional[str] = None  # Domain for certificate (short name)
    cert_path: Optional[str] = None  # Path to certificate file
    cert_key_path: Optional[str] = None  # Path to certificate key file
