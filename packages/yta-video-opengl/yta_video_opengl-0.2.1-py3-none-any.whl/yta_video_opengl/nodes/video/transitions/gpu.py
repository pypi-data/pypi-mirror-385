    ...
    *For internal use only*
    ...
    def _prepare_input_textures(
        ...
        *This method should be overwritten*
        ...
        self.textures.add('second_texture', 0)
...
# TODO: Make it customizable (choose the side to 
...
class CircleOpeningTransitionProcessorGPU(_TransitionProcessorGPU):
    ...
    def fragment_shader(
        ...
        return (
            ...
            uniform sampler2D second_texture;
            uniform float progress;  // 0.0 → full A, 1.0 → full B
            uniform float edge; // 0.02 is a good value
            uniform vec2 output_size; // (width, height)
            ...
            void main() {
                ...
                float mask = 1.0 - smoothstep(radius - edge * max_radius, radius + edge * max_radius, dist);
    ...
    def fragment_shader(
        ...
        return (
            ...
            void main() {
                ...
                // With smooth circle
                // TODO: Make this customizable
                float mask = smoothstep(radius - edge * max_radius, radius + edge * max_radius, dist);
                output_color = mix(first_color, second_color, mask);
            }
            """
        )
