...
misunderstandings.
"""
from yta_video_opengl.blender.utils import _validate_inputs_and_mix_weights, _ensure_uint8
...
class AlphaBlenderCPU(_BlenderCPU):
    ...
    def _blend(
        ...
        *For internal use only*
        ...
        main method.
        """
        base = base_input.astype(np.float32) / 255.0
        overlay = overlay_input.astype(np.float32) / 255.0

        base_rgb, base_a = base[..., :3], base[..., 3:4]
        overlay_rgb, overlay_a = overlay[..., :3], overlay[..., 3:4]
