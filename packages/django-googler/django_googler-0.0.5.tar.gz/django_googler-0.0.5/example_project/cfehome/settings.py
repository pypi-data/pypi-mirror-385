...
SECRET_KEY = "django-insecure-^7km+m03kh138ydt(f4c!k+l!h1@5@g(u@z2ok8x@+xx^$-i8l"
...
# Optional: Store OAuth tokens in session (useful for API calls on behalf of user)
# Default: False
