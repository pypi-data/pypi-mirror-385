...
class TestMiru:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Miru) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.config_instances.with_streaming_response.retrieve(config_instance_id="cfg_inst_123").__enter__()
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/config_instances/cfg_inst_123").mock(side_effect=retry_handler)

        response = client.config_instances.with_raw_response.retrieve(config_instance_id="cfg_inst_123")
    ...
    def test_omit_retry_count_header(self, client: Miru, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        response = client.config_instances.with_raw_response.retrieve(
            config_instance_id="cfg_inst_123", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.config_instances.with_raw_response.retrieve(
            config_instance_id="cfg_inst_123", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncMiru:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncMiru) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await async_client.config_instances.with_streaming_response.retrieve(
    ...
    async def test_retries_taken(
        ...
        response = await client.config_instances.with_raw_response.retrieve(config_instance_id="cfg_inst_123")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.config_instances.with_raw_response.retrieve(
            config_instance_id="cfg_inst_123", extra_headers={"x-stainless-retry-count": Omit()}
        )
