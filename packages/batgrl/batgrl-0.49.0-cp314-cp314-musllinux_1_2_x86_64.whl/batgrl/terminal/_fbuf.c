...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "src/batgrl/terminal/_fbuf.h"
        ],
        "include_dirs": [
            "src/batgrl/terminal"
        ],
        "name": "batgrl.terminal._fbuf",
        "sources": [
            "src/batgrl/terminal/_fbuf.pyx"
        ]
    },
    "module_name": "batgrl.terminal._fbuf"
}
END: Cython Metadata */
...
#define __PYX_HAVE__batgrl__terminal___fbuf
#define __PYX_HAVE_API__batgrl__terminal___fbuf
/* Early includes */
#include <stdint.h>
#include "_fbuf.h"
#ifdef _OPENMP
...
/* Module declarations from "batgrl.terminal._fbuf" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "batgrl.terminal._fbuf"
extern int __pyx_module_is_main_batgrl__terminal___fbuf;
int __pyx_module_is_main_batgrl__terminal___fbuf = 0;

/* Implementation of "batgrl.terminal._fbuf" */
...
static int __pyx_pymod_exec__fbuf(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__fbuf},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit__fbuf(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__fbuf(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__fbuf(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_fbuf' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_fbuf" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__fbuf", 0);
  ...
  if (__pyx_module_is_main_batgrl__terminal___fbuf) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "batgrl.terminal._fbuf")) {
      if (unlikely((PyDict_SetItemString(modules, "batgrl.terminal._fbuf", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init batgrl.terminal._fbuf", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init batgrl.terminal._fbuf");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
