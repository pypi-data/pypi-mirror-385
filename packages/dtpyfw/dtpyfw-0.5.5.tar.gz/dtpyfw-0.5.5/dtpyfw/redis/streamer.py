...
class RedisStreamer:
    ...
    async def _async_cleanup_channels_loop(
        self, cleanup_interval: float = 300.0
    ):
        """
        ...
        """
        controller = f"{__name__}.AsyncConsumer._async_cleanup_channels_loop"
    ...
    async def async_persist_cleanup_channels(
        self, cleanup_interval: float = 300.0
    ):
        """
