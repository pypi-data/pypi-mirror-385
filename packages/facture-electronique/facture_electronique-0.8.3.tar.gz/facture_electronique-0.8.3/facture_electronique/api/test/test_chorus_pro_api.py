...
def _structures_swagger_path():
    """Chemin vers le Swagger Flow Service"""
    return Path(__file__).parent.parent / "swagger" / "Structures.json"


@pytest.fixture
def structures_swagger_path():
    return _structures_swagger_path()


def _factures_swagger_path():
    """Chemin vers le Swagger Directory Service"""
    return Path(__file__).parent.parent / "swagger" / "Factures.json"


@pytest.fixture
def factures_swagger_path():
    return _factures_swagger_path()
