...
if __name__ == "__main__":
    ...
    logger.debug(
        msg=f"Génération de la facture Factur-X (profil EN16931) vers '{facturx_output}'..."
    )
    try:
        ...
        logger.debug(msg=f"Facture Factur-X générée avec succès : {resultat['chemin_fichier']}")
    except Exception as e:
        logger.debug(msg=f"ERREUR lors de la génération Factur-X : {e}")
