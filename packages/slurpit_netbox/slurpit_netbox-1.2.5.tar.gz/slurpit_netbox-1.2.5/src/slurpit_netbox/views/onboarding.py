        ...
        if '_apply' in request.POST:
            ...
            if migrate == 'create':                
                ...
                for obj in self.queryset:
                    ...
                    set_device_custom_fields(device, {
                        ...
                        'slurpit_ipv4': obj.ipv4 if obj.ipv4 else obj.address,
                ...
                for obj in self.queryset:
                    ...
                    # Interface
                    _mgmt_ip = record.ipv4 if record.ipv4 else record.address
                    if _mgmt_ip:
            ...
            if conflic == 'create':
                ...
                for obj in self.queryset:
                    ...
                    _mgmt_ip = obj.ipv4 if obj.ipv4 else obj.address
                    set_device_custom_fields(device, {
                        'slurpit_hostname': obj.hostname,
                        'slurpit_fqdn': obj.fqdn,
                        'slurpit_platform': obj.device_os,
