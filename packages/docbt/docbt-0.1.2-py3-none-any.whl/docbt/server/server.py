...
LLM_PROVIDERS = ["lmstudio", "ollama", "openai"]
...
class DocbtServer:
    ...
    def write_header(self):
        ...
        st.write(
            """Generate yaml-formatted configuration files for your chosen dbt node or snapshot.
            Leverage open and closed source AI to document and test your data or chat about it."""
        )
    ...
    def setup_llm_provider(self) -> str:
        ...
        provider = st.radio(
            ...
            or LLM_PROVIDERS.index(DEFAULT_PROVIDER),
    ...
    def setup_openai_config(self) -> tuple[str, str]:
        ...
        st.info("🤖 **OpenAI Provider Selected**")
    ...
    def setup_ollama_config(self) -> tuple[str, str, dict]:
        ...
        st.info("🦙 **Ollama Provider Selected**")
    ...
    def setup_lmstudio_config(self) -> tuple[str, str, dict]:
        ...
        st.info("🏠 **LmStudio Provider Selected**")
...
Use this context to provide relevant and informed responses."""
    ...
    def get_sample_size(self) -> int:
        ...
        return st.number_input(
            ...
            step=1,
            help="Number of rows to fetch as a sample from the selected table.",
        )
    ...
    def render_node_tab(self) -> None:
        ...
        if st.session_state.get("node") is not None:
            st.subheader("🗂️ Properties Configuration")
            ...
            for col in st.session_state["configuration"]["models"][0]["columns"]:
                ...
                with st.expander(colname.upper(), expanded=False):
                    ...
                    col_tags = st.text_input(
                        ...
                        placeholder="e.g., pii, financial, etc.",
                        value=st.session_state["configuration"]["models"][0]["columns"][i]["tags"]
                        or None,
                        key=f"{colname}_tags",
                    )
                    ...
                    if ai_suggestion_button:
                        ...
                        with st.spinner("🤔 Thinking..."):
                            if st.session_state.llm_provider == "lmstudio":
                                ...
                                logger.info(st.session_state.ai_suggestion)
                        ...
                        if not st.session_state.ai_suggestion:
                            ...
                            st.session_state.configuration["models"][0]["description"] = (
                                st.session_state["ai_suggestion"]["content"]["dataset_description"]
                            )
    ...
    def run(self) -> None:
        ...
        tab_ai, tab_chat, tab_data, tab_node, tab_columns = st.tabs(
            ["AI", "Chat", "Data", "Node", "Columns"]
        )
