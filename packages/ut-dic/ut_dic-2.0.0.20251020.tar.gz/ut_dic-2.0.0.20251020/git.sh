...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ut_dic/.git/

# Add Remote Repository: Link your local repository to the GitHub repository you created:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ut_dic
git remote add ut_dic https://github.com/bs291048/ut_dic.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ut_dic'
