...
class NeuronAssistant:
    ...
    def _show_model_selection(self):
        ...
        models = {
            "1": {
                ...
                "vram_required": 0,
                "mode": "gpt4all",
                "description": "Lightweight, fast, works on any PC"
            },
            "2": {
        ...
        for k, m in models.items():
            ...
            if m["ram_required"] > self.ram_gb:
                ...
                if k == "1":  # GPT4All
                    if self.ram_gb >= 8 and self.device == "cpu":
                        recommendation = "✅ Recommended for your PC"
                    elif self.ram_gb < 8:
                        recommendation = "✅ Best choice for your PC"
                    else:
                        recommendation = "✅ Compatible with your PC"
                else:  # Mistral
    ...
    def _get_smart_recommendation(self, models):
        ...
        # Mid-range systems: Recommend Mistral if GPU is adequate
        elif self.pc_tier == "Mid-Range" and self.device == "cuda" and self.gpu_vram_gb >= 8:
            return {
                "choice": "2", 
                "reason": "Your mid-range PC can run Mistral, though GPT4All would be faster"
            }
        
        # Standard/Basic systems: Always recommend GPT4All
        else:
            return {
                "choice": "1",
                "reason": "GPT4All is optimized for your system specs and will run smoothly"
            }
