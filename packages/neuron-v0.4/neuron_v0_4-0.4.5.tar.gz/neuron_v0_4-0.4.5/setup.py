...
setup(
    ...
    version=VERSION,
    author="Dev Patel",
    author_email="dev@example.com",  # Replace with actual email
    ...
    py_modules=["neuron_assistant"],  # If your main file is neuron_assistant.py
    ...
    entry_points={
        "console_scripts": [
            "neuron=neuron_assistant:main",
            "neuron-v0.4=neuron_assistant:main",  # Version-specific command
        ],
    },
