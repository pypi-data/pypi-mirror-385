...
@dataclass_json
@dataclass
class CtvpcAttachPortBmRequest:
...
@dataclass_json
@dataclass
class CtvpcAttachPortBmResponse:
...
class CtvpcAttachPortBmApi:
    ...
    def do(credential: Credential, client: CtyunClient, endpoint: str,
           request: CtvpcAttachPortBmRequest) -> CtvpcAttachPortBmResponse:
        url = endpoint + "/v4/eip/attach-port-bm"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcAttachPortBmResponse.from_dict(response.json())
