...
@dataclass_json
@dataclass
class CtvpcAttachEipToPortRequest:
...
@dataclass_json
@dataclass
class CtvpcAttachEipToPortResponse:
...
class CtvpcAttachEipToPortApi:
    ...
    def do(credential: Credential, client: CtyunClient, endpoint: str,
           request: CtvpcAttachEipToPortRequest) -> CtvpcAttachEipToPortResponse:
        url = endpoint + "/v4/eip/attach-port-vm"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcAttachEipToPortResponse.from_dict(response.json())
