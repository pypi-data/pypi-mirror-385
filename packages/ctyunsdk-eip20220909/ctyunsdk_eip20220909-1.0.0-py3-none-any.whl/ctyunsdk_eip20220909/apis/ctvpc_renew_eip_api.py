...
@dataclass_json
@dataclass
class CtvpcRenewEipReturnObjResponse:
    """返回结果"""
...
class CtvpcRenewEipResponse:
    ...
    returnObj: Optional[CtvpcRenewEipReturnObjResponse] = None  # 返回结果


# 续订 EIP
class CtvpcRenewEipApi:
    ...
    def do(credential: Credential, client: CtyunClient, endpoint: str,
           request: CtvpcRenewEipRequest) -> CtvpcRenewEipResponse:
        url = endpoint + "/v4/eip/renew"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcRenewEipResponse.from_dict(response.json())
