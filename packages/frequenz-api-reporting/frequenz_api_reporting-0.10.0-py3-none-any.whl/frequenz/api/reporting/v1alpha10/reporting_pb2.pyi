...
class SimpleAggregatedMetricValue(google.protobuf.message.Message):
    ...
    @property
    def sample(self) -> frequenz.api.common.v1alpha8.metrics.metrics_pb2.SimpleMetricValue:
    ...
    def __init__(
        ...
        *,
        ...
        sample: frequenz.api.common.v1alpha8.metrics.metrics_pb2.SimpleMetricValue | None = ...,
    ) -> None: ...
...
class ReceiveMicrogridComponentsDataStreamRequest(google.protobuf.message.Message):
    ...
    @property
    def microgrid_components(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[frequenz.api.common.v1alpha8.microgrid.microgrid_pb2.MicrogridElectricalComponentIDs]:
    ...
    def __init__(
        self,
        *,
        microgrid_components: collections.abc.Iterable[frequenz.api.common.v1alpha8.microgrid.microgrid_pb2.MicrogridElectricalComponentIDs] | None = ...,
...
class ReceiveMicrogridComponentsDataStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def components(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[frequenz.api.common.v1alpha8.microgrid.electrical_components.electrical_components_pb2.ElectricalComponentTelemetry]:
    ...
    def __init__(
        ...
        *,
        microgrid_id: builtins.int = ...,
        components: collections.abc.Iterable[frequenz.api.common.v1alpha8.microgrid.electrical_components.electrical_components_pb2.ElectricalComponentTelemetry] | None = ...,
    ) -> None: ...
...
class ReceiveMicrogridSensorsDataStreamRequest(google.protobuf.message.Message):
    ...
    FILTER_FIELD_NUMBER: builtins.int
    @property
    def microgrid_sensors(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[frequenz.api.common.v1alpha8.microgrid.microgrid_pb2.MicrogridSensorIDs]:
    ...
    def __init__(
        self,
        *,
        microgrid_sensors: collections.abc.Iterable[frequenz.api.common.v1alpha8.microgrid.microgrid_pb2.MicrogridSensorIDs] | None = ...,
        metrics: collections.abc.Iterable[global___MetricConnections] | None = ...,
...
class ReceiveMicrogridSensorsDataStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def sensors(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[frequenz.api.common.v1alpha8.microgrid.sensors.sensors_pb2.SensorTelemetry]:
    ...
    def __init__(
        ...
        *,
        microgrid_id: builtins.int = ...,
        sensors: collections.abc.Iterable[frequenz.api.common.v1alpha8.microgrid.sensors.sensors_pb2.SensorTelemetry] | None = ...,
    ) -> None: ...
