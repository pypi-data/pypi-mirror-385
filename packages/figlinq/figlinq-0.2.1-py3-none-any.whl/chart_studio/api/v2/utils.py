...
def get_headers():
    ...
    if os.getenv("PLOTLY_CSRF_ON"):
        headers["x-csrftoken"] = os.getenv("PLOTLY_CSRF_ON")
...
def get_cookies():
    cookies = {}
    if os.getenv("PLOTLY_CSRF_ON"):
        cookies["plotly_csrf_on"] = os.getenv("PLOTLY_CSRF_ON")
    if os.getenv("PLOTLY_SESS_ON"):
        cookies["plotly_sess_on"] = os.getenv("PLOTLY_SESS_ON")
    return cookies
