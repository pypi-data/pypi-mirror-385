...
from arcade_outlook_mail._utils import send_reply_email
from arcade_outlook_mail.client import get_client
from arcade_outlook_mail.enums import ReplyType
from arcade_outlook_mail.message import Message, Recipient
...
async def create_and_send_email(
    ...
    body_type: Annotated[
        BodyType,
        "The content type of the email body. Defaults to 'text'",
    ] = BodyType.Text,
