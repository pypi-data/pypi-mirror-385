...
class FormatCompiler:
    """A class that compiles format strings for log records and does substitutions."""

    def __init__(self, fmt: str) -> None:
        """Initialize the FormatCompiler with a format string."""
        self.template = Template(fmt)

    def compile(self, **substitutions) -> str:
        """Compile the format string with the given substitutions.

        Returns:
            A compiled format string with substitutions applied.
        """
