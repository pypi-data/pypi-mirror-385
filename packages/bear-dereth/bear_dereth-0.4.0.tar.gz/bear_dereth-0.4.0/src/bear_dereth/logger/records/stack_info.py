...
from bear_dereth.models.general import FrozenModel
...
# get_frame: Callable[[int], FrameType] | Callable[[int], FrameType | None] = load_get_frame_function()
