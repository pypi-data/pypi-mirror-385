...
def _infer_relationships(
    ...
    *,
    ...
    # Only keep one direction (FK -> PK) to avoid duplicates like ORDERS<->LINEITEM
    ...
    for (left_table, right_table), column_pairs in pairs.items():
        ...
        # If we already have this pair (in either direction), skip the duplicate
        ...
        # Check if we already processed this canonical pair
