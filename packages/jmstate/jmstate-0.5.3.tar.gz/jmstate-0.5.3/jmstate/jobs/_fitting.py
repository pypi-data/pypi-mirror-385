...
DEFAULT_OPT_KWARGS: Final[dict[str, Any]] = {"lr": 0.5}
...
class Fit(Job):
    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        """Creates the fitting class. By default, it uses Adam and lr=0.5.
    ...
    def __init__(  # type: ignore
        ...
        **kwargs: Any,
        ...
        """Initializes the fitting class. By default, it uses Adam and lr=0.5.

        Args:
            opt_factory (type[torch.optim.Optimizer] | None): The optimizer factory.
                Defaults to None.
            fit_extra (bool, optional): An option to fit extra parameters or not.
                Defaults to True.
        ...
        self.opt = (opt_factory or DEFAULT_OPT_FACTORY)(
            opt_params, **{**DEFAULT_OPT_KWARGS, **kwargs}
        )
        info.opt = self.opt
