...
from mace_descriptor.tools.utils import get_cache_dir
...
mace_mp_urls = {
    ...
    "mace_descriptor-matpes-pbe-0": "https://github.com/ACEsuit/mace-foundations/releases/download/mace_matpes_0/MACE-matpes-pbe-omat-ft.model",
    "mace_descriptor-matpes-r2scan-0": "https://github.com/ACEsuit/mace-foundations/releases/download/mace_matpes_0/MACE-matpes-r2scan-omat-ft.model",
}
...
def download_mace_mp_checkpoint(model: Union[str, Path] = None) -> str:
    ...
    ASL_checkpoint_urls = {
        ...
        mace_mp_urls["mace_descriptor-matpes-pbe-0"],
        mace_mp_urls["mace_descriptor-matpes-r2scan-0"],
    }
