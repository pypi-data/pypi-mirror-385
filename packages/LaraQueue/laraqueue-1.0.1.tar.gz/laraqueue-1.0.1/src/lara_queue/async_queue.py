...
class AsyncMetricsCollector:
    """Async metrics collector for tracking queue performance."""
    ...
    def __init__(self, max_history_size: int = 1000):
        ...
        # Processing history (for calculating averages)
    ...
    def record_job_start(self, job_name: str) -> float:
        """Records the start of job processing and returns timestamp."""
        return time.time()
    
    def record_job_success(self, job_name: str, start_time: float, processing_time: float) -> None:
        """Records successful job processing."""
    ...
    def get_recent_jobs(self, limit: int = 100) -> List[Dict[str, Any]]:
        """Returns recently processed jobs."""
