...
from dmp_af.parser.dbt_profiles import KubernetesTarget, Profile, Target, VenvTarget
...
class DmpAfMaintenanceConfig(pydantic.BaseModel):
...
class DbtNodeConfig(pydantic.BaseModel):
    ...
    maintenance: DmpAfMaintenanceConfig = pydantic.Field(default_factory=DmpAfMaintenanceConfig)
