# Planmagnet Sdk-python

A Python SDK planmagnet for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from planmagnet_sdk import BoilerSDK, BoilerSDKConfig
from planmagnet_sdk.types.common import UserRegisterInput
...
```python
from planmagnet_sdk import BoilerSDKConfig
...
pytest --cov=planmagnet_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/planmagnet-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/planmagnet-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../planmagnet-frontend) - Frontend planmagnet
- [Boiler Backend](../planmagnet-python-be-graphql) - Python GraphQL backend planmagnet