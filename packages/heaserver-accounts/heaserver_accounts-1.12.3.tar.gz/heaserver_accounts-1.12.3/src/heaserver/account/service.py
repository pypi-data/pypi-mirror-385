                    ...
                    try:
                        ...
                        if "ObjectRemoved" in event_name:
                            if (current_doc and current_doc.is_delete_marker
                                ...
                                logger.debug(f"Marking {search_aws_obj.path} as deleted.")
                            yield search_aws_obj

                        elif "DeleteMarkerCreated" in event_name:
                            search_aws_obj.is_delete_marker = True
                            yield search_aws_obj

                        elif "Put" in event_name or "CompleteMultipartUpload" in event_name:
                            search_aws_obj.is_delete_marker = False
                            yield search_aws_obj
