...
def get_system_tool_selection(available_tools: list, tool_descriptions: str) -> str:
    ...
    """
    possible_system_file_path_2 = os.path.join(PACKAGE_PATH, "systems", "computemate", "tool_selection_lite.md" if config.lite else "tool_selection.md")
    possible_system_file_path_1 = os.path.join(AGENTMAKE_USER_DIR, "systems", "computemate", "tool_selection_lite.md" if config.lite else "tool_selection.md")
