...
from backend.database import SessionLocal, Project, ParameterCategory, Parameter, ParameterValue
from backend.io_formats.validation import ProjectConsistencyValidator, validate_import_consistency
...
def main():
    ...
    if args.database:
        ...
        from backend.database import create_engine, sessionmaker
