...
class Debugging:
    """
    Utilities for debugging GitHub Actions workflows.

    Provides methods to inspect the execution environment and troubleshoot issues.
    """
    ...
    def print_directory_tree(max_level: int = 3) -> None:
        ...
        :param max_level: Maximum depth to traverse (default: 3)
        """
