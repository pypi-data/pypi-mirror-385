...
# 💾 بکاپ و پایگاه داده
# ---------------------------
# نکته: دو کلید جدید برای هماهنگی با منطق بکاپ اضافه شده:
# - bk_wipe_window_minutes: پنجرهٔ زمانی برای شمردن حذف‌ها (تشخیص wipe)
# - bk_cooldown_minutes: فاصلهٔ دو بکاپ خودکار برای یک چت (جلوگیری از اسپم)
backup_config = {
    "bk_enabled": True,
    "bk_db": "downloads/backup.db",
    "bk_dir": "downloads/bk_exports",
    "bk_wipe_threshold": 50,
    "bk_wipe_window_minutes": 10,  # پیش‌فرض: ۱۰ دقیقه
    "bk_cooldown_minutes": 5,      # پیش‌فرض: ۵ دقیقه
}
...
def _reset_state_to_defaults():
    ...
    backup_config.update({
        ...
        "bk_dir": "downloads/bk_exports",
        "bk_wipe_threshold": 50,
        "bk_wipe_window_minutes": 10,
        "bk_cooldown_minutes": 5,
    })
