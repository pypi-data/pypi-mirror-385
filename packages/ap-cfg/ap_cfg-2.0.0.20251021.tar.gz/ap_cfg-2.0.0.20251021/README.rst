...
The package ``ap_cfg`` can be installed from PyPI.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ap_cfg
...
The Package ``ap_cfg`` consist of the following file types (c.f.: **Appendix**: `Python Glossary`):
...
The Package ``ap_cfg`` contains the following Setup Control Modules.

  .. Setup Control-Modules-label:
  .. table:: *Setup Control Modules*

   +--------+--------------------------+
   |Name    |Decription                |
   +========+==========================+
   |app.py  |Setup main control        |
   +--------+--------------------------+
   |parms.py|Setup parameter processing|
   +--------+--------------------------+
   |task.py |Setup task control        |
   +--------+--------------------------+
...
The Package ``ap_cfg`` contains the following Setup Processing Modules.

  .. Setup-Processing-Modules-label:
  .. table:: *Setup Processing Modules*
