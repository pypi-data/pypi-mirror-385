...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ap_cfg/.git/

# Add Remote Repository: Link your local repository to the GitHub repository you created:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ap_cfg
git remote add ap_cfg https://github.com/bs291048/ap_cfg.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ap_cfg'
