...
class TestProponentAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.debate_pattern import ProponentAgent
...
class TestOpponentAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.debate_pattern import OpponentAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
...
class TestJudgeAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.debate_pattern import JudgeAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
...
class TestDebatePatternSharedMemory:
    ...
    def test_memory_segments_organization(self):
        ...
        argument_in_judgments = any(
            "argument" in jdg.get("tags", []) for jdg in judgments
        )
