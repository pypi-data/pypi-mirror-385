...
class TestSupervisorAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.supervisor_worker import SupervisorAgent
    ...
    def test_check_all_tasks_completed(self):
        ...
        # Before execution
        completed_before = pattern.supervisor.check_all_tasks_completed(request_id)
        ...
        # After execution
        completed_after = pattern.supervisor.check_all_tasks_completed(request_id)
...
class TestWorkerAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.supervisor_worker import WorkerAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
...
class TestCoordinatorAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.supervisor_worker import CoordinatorAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
...
class TestSharedMemoryCoordination:
    ...
    def test_request_id_isolates_different_requests(self):
        ...
        insights_1 = pattern.get_shared_insights(tags=[request_id_1])
        insights_2 = pattern.get_shared_insights(tags=[request_id_2])
