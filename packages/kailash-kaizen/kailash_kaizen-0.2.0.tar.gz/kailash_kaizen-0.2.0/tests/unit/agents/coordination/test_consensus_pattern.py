...
class TestProposerAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.consensus_pattern import ProposerAgent
...
class TestVoterAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.consensus_pattern import VoterAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
    ...
    def test_vote_signature_used(self):
        ...
        from kaizen.agents.coordination import create_consensus_pattern
        from kaizen.agents.coordination.consensus_pattern import VotingSignature
...
class TestAggregatorAgent:
    ...
    def test_initialization(self):
        ...
        from kaizen.agents.coordination.consensus_pattern import AggregatorAgent
        from kaizen.core.base_agent import BaseAgentConfig
        from kaizen.memory import SharedMemoryPool
