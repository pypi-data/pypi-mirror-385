...
class TestToolDefinition:
    ...
    def test_create_simple_tool_definition(self):
        ...
        tool = ToolDefinition(
            ...
            parameters=[
                ToolParameter("text", str, "Input text")
            ],
            returns={"result": "str"},
    ...
    def test_validate_parameters_all_required_present(self):
        ...
        tool = ToolDefinition(
            ...
            danger_level=DangerLevel.SAFE,
            parameters=[
                ToolParameter("name", str, "User name", required=True)
            ],
    ...
    def test_validate_parameters_unknown_parameter_raises_error(self):
        ...
        tool = ToolDefinition(
            ...
            danger_level=DangerLevel.SAFE,
            parameters=[
                ToolParameter("name", str, "User name")
            ],
            returns={"greeting": "str"},
            executor=lambda name: {"greeting": f"Hello {name}"}
        )
    ...
    def test_validate_parameters_with_optional_params(self):
        ...
        # With optional param
        assert tool.validate_parameters({"path": "/tmp/file.txt", "encoding": "latin1"}) is True
