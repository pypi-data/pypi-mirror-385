...
class MemoryAgent(BaseAgent):
    ...
    Usage:
        ...
        result = agent.chat("My name is Alice", session_id="user_123")
        result = agent.chat("What is my name?", session_id="user_123")
    ...
    def chat(self, message: str, session_id: str = "default") -> Dict[str, Any]:
        ...
        Example:
            >>> agent = MemoryAgent()
            >>> result = agent.chat("My name is Bob", session_id="user_1")
            >>> result = agent.chat("What is my name?", session_id="user_1")
            >>> print(result["response"])
            Your name is Bob.
        """
        # Input validation
