...
// Stable tie/strut switching (physical, not 1e-6)
const AXIAL_SLACK_TOLERANCE_DEFAULT: f64 = 5.0; // N
const AXIAL_REACTIVATION_BUFFER: f64 = 10.0; // N hysteresis band
const FINAL_SIGN_EPS: f64 = 1.0e-9; // N
