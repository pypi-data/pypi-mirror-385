# Eventfullymanaged Sdk-python

A Python SDK eventfullymanaged for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from eventfullymanaged_sdk import BoilerSDK, BoilerSDKConfig
from eventfullymanaged_sdk.types.common import UserRegisterInput
...
```python
from eventfullymanaged_sdk import BoilerSDKConfig
...
cd eventfullymanaged-sdk-python
...
pytest --cov=eventfullymanaged_sdk --cov-report=html
```
...
# Run with coverage
pytest --cov=eventfullymanaged_sdk
...
```bash
mypy src/eventfullymanaged_sdk
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/eventfullymanaged-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/eventfullymanaged-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../eventfullymanaged-frontend) - Frontend eventfullymanaged
- [Boiler Backend](../eventfullymanaged-python-be-graphql) - Python GraphQL backend eventfullymanaged