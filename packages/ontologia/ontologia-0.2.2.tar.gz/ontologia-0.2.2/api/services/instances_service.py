...
class ObjectInstanceQueryService(_InstancesServiceBase):
    def get_object(
        self, object_type_api_name: str, pk_value: str, *, as_of: datetime | None = None
    ...
    def search_objects(
        ...
        if getattr(body, "traverse", None):
            ...
            return result
        result = self.search_objects_base(object_type_api_name, body)
        result.data = self._apply_object_validity_filter(result.data, as_of)
        return result
...
class InstancesService:
    ...
    def get_object(
        ...
        return self._queries.get_object(object_type_api_name, pk_value, as_of=as_of)
    ...
    def list_objects(
        ...
        *,
        ...
        return self._queries.list_objects(
            object_type_api_name, limit=limit, offset=offset, valid_at=valid_at
        )
    ...
    def search_objects_base(
        ...
        """
        return self._queries.search_objects_base(object_type_api_name, body)
        # Pagination
        limit = int(body.limit or 100)
        offset = int(body.offset or 0)
        as_of = getattr(body, "asOf", None)
