...
from browzy.browser.cloud import CloudBrowserAuthError, CloudBrowserError, get_cloud_browser_cdp_url
...
from browzy.browser.events import (
...
from browzy.browser.profile import BrowserProfile, ProxySettings
from browzy.browser.views import BrowserStateSummary, TabInfo
from browzy.dom.views import DOMRect, EnhancedDOMTreeNode, TargetInfo
from browzy.observability import observe_debug
from browzy.utils import _log_pretty_url, is_new_tab_page

if TYPE_CHECKING:
	from browzy.actor.page import Page
...
class CDPSession(BaseModel):
	...
	async def for_target(
		...
		if new_socket:
			...
			logger = logging.getLogger(f'browzy.CDPSession.{target_id[-4:]}')
...
class BrowserSession(BaseModel):
	...
	def logger(self) -> Any:
		...
		# 	self._logger = logging.getLogger(f'browzy.{self}')
		return logging.getLogger(f'browzy.{self}')
	...
	def model_post_init(self, __context) -> None:
		...
		from browzy.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from browzy.browser.events import SaveStorageStateEvent
				...
				if self.browser_profile.use_cloud:
					...
					try:
						...
						raise CloudBrowserAuthError(
							'Authentication failed for cloud browser service. Set BROWZY_API_KEY environment variable. You can also create an API key at https://cloud.browser-use.com'
						)
	...
	async def on_NavigateToUrlEvent(self, event: NavigateToUrlEvent) -> None:
		...
		if event.new_tab:
			try:
				...
				from browzy.utils import is_new_tab_page
	...
	async def on_BrowserStopEvent(self, event: BrowserStopEvent) -> None:
		...
		try:
			...
			if self.browser_profile.use_cloud:
				try:
					from browzy.browser.cloud import cleanup_cloud_client
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from browzy.actor.page import Page as Target
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from browzy.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

		# from browzy.browser.crash_watchdog import CrashWatchdog
		from browzy.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		from browzy.browser.watchdogs.dom_watchdog import DOMWatchdog
		from browzy.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
		from browzy.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from browzy.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from browzy.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from browzy.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from browzy.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from browzy.browser.watchdogs.security_watchdog import SecurityWatchdog
		from browzy.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def navigate_to(self, url: str, new_tab: bool = False) -> None:
		...
		"""
		from browzy.browser.events import NavigateToUrlEvent
