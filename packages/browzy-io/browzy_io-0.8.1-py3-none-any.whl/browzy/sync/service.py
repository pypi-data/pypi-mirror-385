...
from browzy.sync.auth import TEMP_USER_ID, DeviceAuthClient
...
class CloudSync:
	...
	def __init__(self, base_url: str | None = None, allow_session_events_for_auth: bool = False):
		...
		self.enabled = CONFIG.BROWZY_CLOUD_SYNC
	...
	# 		wal_path = CONFIG.BROWZY_CONFIG_DIR / 'events' / f'{session_id}.jsonl'
