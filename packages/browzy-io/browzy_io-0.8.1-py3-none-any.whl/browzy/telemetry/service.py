...
from browzy.telemetry.views import BaseTelemetryEvent
from browzy.utils import singleton
...
class ProductTelemetry:
	...
	USER_ID_PATH = str(CONFIG.BROWZY_CONFIG_DIR / 'device_id')
	...
	def __init__(self) -> None:
		...
		self.debug_logging = CONFIG.BROWZY_LOGGING_LEVEL == 'debug'
