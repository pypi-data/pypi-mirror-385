...
from browzy.llm.exceptions import ModelProviderError
from browzy.llm.google.serializer import GoogleMessageSerializer
from browzy.llm.messages import BaseMessage
from browzy.llm.schema import SchemaOptimizer
from browzy.llm.views import ChatInvokeCompletion, ChatInvokeUsage
...
class ChatGoogle(BaseChatModel):
	...
	def logger(self) -> logging.Logger:
		...
		return logging.getLogger(f'browzy.llm.google.{self.model}')
