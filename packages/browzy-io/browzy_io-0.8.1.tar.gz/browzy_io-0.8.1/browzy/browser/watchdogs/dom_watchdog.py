...
from browzy.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from browzy.observability import observe_debug
from browzy.utils import time_execution_async

if TYPE_CHECKING:
	from browzy.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
		...
		try:
			...
			if screenshot_b64 and content and content.selector_map and self.browser_session.browser_profile.highlight_elements:
				try:
					...
					from browzy.browser.python_highlights import create_highlighted_screenshot_async
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from browzy.browser.views import PageInfo
