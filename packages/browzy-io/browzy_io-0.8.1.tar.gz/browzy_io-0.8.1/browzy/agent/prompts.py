...
from browzy.dom.views import NodeType, SimplifiedNode
from browzy.llm.messages import ContentPartImageParam, ContentPartTextParam, ImageURL, SystemMessage, UserMessage
from browzy.observability import observe_debug
from browzy.utils import is_new_tab_page

if TYPE_CHECKING:
	from browzy.agent.views import AgentStepInfo
...
class SystemPrompt:
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			with importlib.resources.files('browzy.agent').joinpath(template_filename).open('r', encoding='utf-8') as f:
