...
from .utils import generate_yaml_template, get_stats, insert_in_tex
...
def cmd_init(args):
    ...
    print("  artmeta generate amsart --insert main.tex")
    return 0
...
def cmd_generate(args):
    ...
    try:
        ...
        if args.insert:
            insert_in_tex(args.insert, latex_code, args.journal)
        elif args.output:
...
Exemples d'utilisation :
  ...
  artmeta switch elsarticle main.tex    # Changer de revue
  artmeta hal-xml -o metadata.xml       # Générer HAL-XML
  artmeta stats                         # Statistiques

Documentation : https://github.com/yourusername/artmeta
        """,
    )
    ...
    parser_switch.add_argument(
        "journal", choices=["amsart", "elsarticle", "svjour3", "siamart", "article"]
    )
