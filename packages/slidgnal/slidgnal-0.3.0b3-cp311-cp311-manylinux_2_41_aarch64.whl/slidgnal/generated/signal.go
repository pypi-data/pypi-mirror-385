...
#cgo CFLAGS: "-I/root/.local/share/uv/python/cpython-3.11.14-linux-aarch64-gnu/include/python3.11" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/root/.local/share/uv/python/cpython-3.11.14-linux-aarch64-gnu/lib" "-lpython3.11" -lpthread -ldl -lutil -lm
...
//export signal_Avatar_Image_Get
func signal_Avatar_Image_Get(handle CGoHandle) CGoHandle {
	op := ptrFromHandle_signal_Avatar(handle)
	return handleFromPtr_Slice_byte(&op.Image)
}

//export signal_Avatar_Image_Set
func signal_Avatar_Image_Set(handle CGoHandle, val CGoHandle) {
	op := ptrFromHandle_signal_Avatar(handle)
	op.Image = deptrFromHandle_Slice_byte(val)
}
