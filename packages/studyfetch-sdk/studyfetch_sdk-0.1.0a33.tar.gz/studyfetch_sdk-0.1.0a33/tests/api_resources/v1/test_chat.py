...
class TestChat:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_feedback_context(self, client: StudyfetchSDK) -> None:
        chat = client.v1.chat.retrieve_feedback_context(
            "feedbackId",
        )
        assert chat is None
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_feedback_context(self, client: StudyfetchSDK) -> None:
        response = client.v1.chat.with_raw_response.retrieve_feedback_context(
            "feedbackId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_feedback_context(self, client: StudyfetchSDK) -> None:
        with client.v1.chat.with_streaming_response.retrieve_feedback_context(
            "feedbackId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_retrieve_feedback_context(self, client: StudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `feedback_id` but received ''"):
            client.v1.chat.with_raw_response.retrieve_feedback_context(
                "",
            )
...
class TestAsyncChat:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_feedback_context(self, async_client: AsyncStudyfetchSDK) -> None:
        chat = await async_client.v1.chat.retrieve_feedback_context(
            "feedbackId",
        )
        assert chat is None
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_feedback_context(self, async_client: AsyncStudyfetchSDK) -> None:
        response = await async_client.v1.chat.with_raw_response.retrieve_feedback_context(
            "feedbackId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_feedback_context(self, async_client: AsyncStudyfetchSDK) -> None:
        async with async_client.v1.chat.with_streaming_response.retrieve_feedback_context(
            "feedbackId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_retrieve_feedback_context(self, async_client: AsyncStudyfetchSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `feedback_id` but received ''"):
            await async_client.v1.chat.with_raw_response.retrieve_feedback_context(
                "",
            )
