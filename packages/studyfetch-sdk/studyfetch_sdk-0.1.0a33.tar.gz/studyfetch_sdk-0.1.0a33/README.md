...
material_response = client.v1.materials.create(
    content={"type": "text"},
    name="Chapter 1 - Introduction",
)
print(material_response._id)
```
...
async def main() -> None:
    material_response = await client.v1.materials.create(
        content={"type": "text"},
        name="Chapter 1 - Introduction",
    )
    print(material_response._id)
...
print(material_response.content)
```
