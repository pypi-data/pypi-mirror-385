...
class ChatResource(SyncAPIResource):
    ...
    def retrieve_feedback_context(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._get(
            f"/api/v1/chat/feedback/{feedback_id}/context",
            options=make_request_options(
...
class ChatResourceWithRawResponse:
    def __init__(self, chat: ChatResource) -> None:
        ...
        self.retrieve_feedback_context = to_raw_response_wrapper(
            chat.retrieve_feedback_context,
        )
...
class AsyncChatResourceWithRawResponse:
    def __init__(self, chat: AsyncChatResource) -> None:
        ...
        self.retrieve_feedback_context = async_to_raw_response_wrapper(
            chat.retrieve_feedback_context,
        )
...
class ChatResourceWithStreamingResponse:
    def __init__(self, chat: ChatResource) -> None:
        ...
        self.retrieve_feedback_context = to_streamed_response_wrapper(
            chat.retrieve_feedback_context,
        )
...
class AsyncChatResourceWithStreamingResponse:
    def __init__(self, chat: AsyncChatResource) -> None:
        ...
        self.retrieve_feedback_context = async_to_streamed_response_wrapper(
            chat.retrieve_feedback_context,
        )
