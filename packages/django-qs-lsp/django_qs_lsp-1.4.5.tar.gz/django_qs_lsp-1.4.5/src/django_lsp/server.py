...
server = LanguageServer("django-qs-lsp", "v0.1")
...
class ServerInitializer:
    ...
    def _setup_logging(self, ls: LanguageServer) -> None:
        ...
        if os.environ.get("DJANGO_QS_LSP_DEBUG", "").lower() in ("true", "1", "yes"):
    ...
    def _extract_configuration(self, params: types.InitializeParams) -> None:
        ...
        if params.initialization_options:
            ...
            if debug_enabled:
                os.environ["DJANGO_QS_LSP_DEBUG"] = "true"
    ...
    def _configure_capabilities(self) -> types.ServerCapabilities:
        ...
        return types.ServerCapabilities(
            ...
            execute_command_provider=types.ExecuteCommandOptions(
                commands=[
                    "django-qs-lsp.showModels",
                    "django-qs-lsp.refreshModels",
                    "django-qs-lsp.showFieldInfo",
                    "django-qs-lsp.showLookupInfo",
                    "django-qs-lsp.showCacheInfo",
                    "django-qs-lsp.clearCache",
                    "django-qs-lsp.showWorkspaceInfo",
                ]
            ),
...
class CommandHandler:
    ...
    def handle_command(
        ...
        command_handlers = {
            "django-qs-lsp.showModels": self._show_models,
            "django-qs-lsp.refreshModels": self._refresh_models,
            "django-qs-lsp.showFieldInfo": self._show_field_info,
            "django-qs-lsp.showLookupInfo": self._show_lookup_info,
            "django-qs-lsp.showCacheInfo": self._show_cache_info,
            "django-qs-lsp.clearCache": self._clear_cache,
            "django-qs-lsp.showWorkspaceInfo": self._show_workspace_info,
        }
