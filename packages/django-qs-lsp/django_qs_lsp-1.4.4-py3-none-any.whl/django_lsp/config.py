...
class DjangoLSPConfig:
    ...
    def __init__(self) -> None:
        ...
        self._context_aware_completions = (
            True  # Default to context-aware for better user experience
        )
    ...
    @property
    def context_aware_completions(self) -> bool:
        """Whether to only show completions for models available in the current file."""
        return self._context_aware_completions

    @context_aware_completions.setter
    def context_aware_completions(self, value: bool) -> None:
        """Set context-aware completions mode."""
        self._context_aware_completions = bool(value)
    ...
    def load_from_environment(self) -> None:
        ...
        debug = os.getenv("DJANGO_LSP_DEBUG")
        if debug:
            self.debug_mode = debug.lower() == "true"

        context_aware = os.getenv("DJANGO_LSP_CONTEXT_AWARE")
        if context_aware:
            self.context_aware_completions = context_aware.lower() == "true"
