...
from agentsphere_base.sandbox.sandbox_api import SandboxInfo, SandboxApiBase, SandboxQuery, ListedSandbox
from agentsphere_base.exceptions import TemplateException
from agentsphere_base.api import AsyncApiClient, SandboxCreateResponse
from agentsphere_base.api.client.models import NewSandbox, PostSandboxesSandboxIDTimeoutBody
from agentsphere_base.api.client.api.sandboxes import (
...
from agentsphere_base.api import handle_api_exception
...
class SandboxApi(SandboxApiBase):
    ...
    async def list(
        ...
        :param api_key: API key to use for authentication, defaults to `AGENTSPHERE_API_KEY` environment variable
    ...
    async def get_info(
        ...
        :param api_key: API key to use for authentication, defaults to `AGENTSPHERE_API_KEY` environment variable
        :param domain: Domain to use for the request, defaults to `AGENTSPHERE_DOMAIN` environment variable
        :param debug: Debug mode, defaults to `AGENTSPHERE_DEBUG` environment variable
        :param request_timeout: Timeout for the request in **seconds**
        :param headers: Additional headers to send with the request
        :param proxy: Proxy to use for the request
        ...
        async with AsyncApiClient(
            ...
            if Version(res.parsed.envd_version) < Version("0.1.0"):
                ...
                raise TemplateException(
                    ...
                    "You can do this by running `agentsphere template build` in the directory with the template."
                )
