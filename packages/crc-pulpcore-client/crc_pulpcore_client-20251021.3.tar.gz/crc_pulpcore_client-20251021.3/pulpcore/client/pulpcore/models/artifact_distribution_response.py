...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "pulp_href", "no_content_change_since", "pulp_labels", "prn", "base_url", "hidden", "name", "pulp_last_updated", "content_guard", "base_path"]
