...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "no_content_change_since", "prn", "name", "pulp_last_updated", "base_path", "base_url", "pulp_labels", "hidden", "pulp_created", "pulp_href"]
