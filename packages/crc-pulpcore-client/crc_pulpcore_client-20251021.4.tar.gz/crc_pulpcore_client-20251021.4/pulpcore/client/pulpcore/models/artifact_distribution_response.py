...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "pulp_last_updated", "base_path", "prn", "base_url", "pulp_href", "no_content_change_since", "content_guard", "pulp_created", "hidden", "name"]
