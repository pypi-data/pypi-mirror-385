...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "pulp_last_updated", "no_content_change_since", "base_url", "hidden", "pulp_labels", "name", "prn", "pulp_created", "base_path", "pulp_href"]
