...
from .blank_node import cleanup_blank_nodes, get_lookup_value, group_by_term_id
...
def _format_results(
    ...
    cycle = cycle | {
        ...
        cleanup_blank_nodes(map(_format_aggregate(new_practice, _filter_practice(filter_organic)), practices)),
