    ...
    def generate(
        ...
        try:
            ...
            if not prompt_template:
                raise CodeGenerationError(
                    f"Config '{config.id}' code_generation pattern missing 'prompt' in generation_config"
                )
        ...
        for attempt in range(retry_count + 1):
            try:
                ...
                message = self.client.messages.create(
                    ...
                    or "You are an expert software developer. Generate high-quality, production-ready code.",
