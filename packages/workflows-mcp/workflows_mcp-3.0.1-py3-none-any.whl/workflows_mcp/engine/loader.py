...
def load_workflow_from_file(file_path: str | Path) -> Result[WorkflowSchema]:
    """
...
def load_workflow_from_yaml(yaml_content: str, source: str = "<string>") -> Result[WorkflowSchema]:
    """
...
def discover_workflows(directory: str | Path) -> Result[list[WorkflowSchema]]:
    """
    ...
    Returns:
        Result.success(list[WorkflowSchema]) with valid workflows
