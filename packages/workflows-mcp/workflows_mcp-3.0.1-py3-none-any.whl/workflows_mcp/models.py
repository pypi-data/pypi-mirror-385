...
class ExecuteWorkflowInput(BaseModel):
    ...
    workflow: str = Field(
        ...
        description=(
            ...
            "'git-create-feature-branch'). Use list_workflows() to see all available workflows."
        ),
        min_length=1,
        max_length=200,
    )
...
class ResumeWorkflowInput(BaseModel):
    ...
    llm_response: str = Field(
        ...
        description=(
            ...
            "For interactive blocks like ConfirmOperation, provide 'yes' or 'no'. "
            "For AskChoice, provide the selected option. "
            "For GetInput, provide the requested input value."
        ),
        max_length=10000,
    )
    response_format: Literal["minimal", "detailed"] = Field(
