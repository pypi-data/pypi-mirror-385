...
**Utilities for Dictionaries of Arrays**
...
Package ``ut_doa`` can be installed from PyPI.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ut_doa
...
The Package ``ut_doa`` consist of the following file types (c.f.: **Appendix**: `Python Glossary`):
...
^^^^^^^
  ...
  .. table:: *Methods of class DoAoD*
   ...
   |Name                  |Description                                            |
   +======================+=======================================================+
   |is_dic_value_empty    |Check if all keys of the given Dictionary of Arrays of |
   |                      |Dictionaries are found in any Dictionary of the Array  |
   |                      |of Dictionaries and the value for the key is not empty.|
   +----------------------+-------------------------------------------------------+
   |sh_d_pddf             |Convert Dictionary of Array of Dictionaries to         |
   |                      |Dictionary of Pandas dataframes.                       |
   +----------------------+-------------------------------------------------------+
   |sh_unique             |Convert Dictionary of Array of Dictionaries to         |
   |                      |Dictionary of array of distinct dictionaries.          |
   +----------------------+-------------------------------------------------------+
   |union_distinct_by_keys|Convert filtered Dictionary of Arrays of Dictionaries  |
   |                      |by keys to an Array of distinct Dictionaries.          |
   +----------------------+-------------------------------------------------------+
   |union_distinct        |Convert Dictionary of Arrays of Dictionaries to an     |
...
The static Class ``DoA`` is used to manage ``Dictionary of Arrays``;
it contains no variables and only static- or class- methods.
...
^^^^^^^
  ...
  .. table:: *Methods of class DoA*
   ...
   |Name                       |Description                                                 |
   +===========================+============================================================+
   |append_by_key_value        |Append the value to the key-value of the dictionary of      |
   |                           |Arrays if the key-value exist as an array, otherwise assign |
   |                           |the item as an array to the key and then append the value;  |
   |                           |if the item is not an array the item has to be modified as  |
   |                           |an array with the item as the only element.                 |
   +---------------------------+------------------------------------------------------------+
   |append_by_keys_value       |Locate the dictionary of arrays by the secondlast key of the|
   |                           |keys if its an array and call the append_by_key_value       |
   |                           |function with the last key of the keys array, otherwise call|
   |                           |this function with the string keys.                         |
   +---------------------------+------------------------------------------------------------+
   |append_by_key_unique_value |Append the value to the key-value of the dictionary of      |
   |                           |Arrays if the key-value exist as an array and the values    |
   |                           |does not exist in the key-value, otherwise assign the item  |
   |                           |as an array to the key and then append the value;           |
   |                           |if the item is not an array the item has to be modified as  |
   |                           |an array with the item as the only element.                 |
   +---------------------------+------------------------------------------------------------+
   |append_by_keys_unique_value|Locate the dictionary of arrays by the secondlast key of the|
   |                           |keys if its an array and call the append_by_key_unique_value|
   |                           |function with the last key of the keys array, otherwise call|
   |                           |this function with the string keys.                         |
   +---------------------------+------------------------------------------------------------+
   |extend_by_key_value        |Extend the value to the key-value of the dictionary of      |
   |                           |Arrays if the key-value exist as an array, otherwise assign |
   |                           |the item as an array to the key and then extend the value;  |
   |                           |if the item is not an array the item has to be modified as  |
   |                           |an array with the item as the only element.                 |
   +---------------------------+------------------------------------------------------------+
   |extend_by_keys_value       |Locate the dictionary of arrays by the secondlast key of the|
   |                           |keys if its an array and call the extend_by_key_value       |
   |                           |function with the last key of the keys array, otherwise call|
   |                           |this function with the string keys.                         |
   +---------------------------+------------------------------------------------------------+
   |union_distinct_by_keys     |Create new array with distinct elements of the arrays       |
   |                           |selected from the dictionary of arrays by the keys.         |
   +---------------------------+------------------------------------------------------------+
   |union_distinct             |Create new array with distinct elements of each array of the|
   |                           |dictionary of arrays.                                       |
   +---------------------------+------------------------------------------------------------+
   |union                      |Create new array with elements of each array of the         |
   |                           |dictionary of arrays.                                       |
   +---------------------------+------------------------------------------------------------+
