...
class InvocationRequest(BaseModel):
    """Invocation request model (deprecated - for reference only)
    
    NOTE: This model is NOT used by the client anymore.
    The client accepts plain dict or str for invoke() method and passes them directly to the server.
    
    Users should pass requests as:
    - str: Will be sent as {"prompt": "your string"}
    - dict: Will be sent as-is with any structure
    ...
    Example usage (without this model):
        # Direct dict - preserves all fields
        ...
        # String shorthand
        await session.invoke("Analyze this data")
    """
    ...
    # AWS Agentcore compatible fields
    ...
    stream: bool = False  # Deprecated - streaming auto-detected by server
