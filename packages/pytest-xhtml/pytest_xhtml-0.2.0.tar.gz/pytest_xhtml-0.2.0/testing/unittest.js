...
const { doInitFilter, doFilter } = require('../pytest_xhtml/scripts/filter.js')
const { doInitSort, doSort } = require('../pytest_xhtml/scripts/sort.js')
const dataModule = require('../pytest_xhtml/scripts/datamanager.js')
const storageModule = require('../pytest_xhtml/scripts/storage.js')
