...
class APISpreadsheets:
    ...
    def read_data(self, file_id=None, query=None, limit=None, count=None, dataFormat=None, access_key=None,
                  secret_key=None):
        """
        GET /data/{file_id}/
    ...
    def create_file(self, data=None, fileName=None, body=None, access_key=None, secret_key=None):
        """
    ...
    def list_files(self, page=None, pageSize=None, q=None, sortBy=None, sortOrder=None, createdAfter=None,
                   createdBefore=None, access_key=None, secret_key=None):
        """
        GET /utilities/files
    ...
    def get_file(self, file_id=None, includeSamples=None, sampleRows=None, access_key=None, secret_key=None):
        if file_id is None:
            raise APIError("Missing required path param: file_id")
    ...
    def update_file(self, file_id=None, name=None, description=None, sheetRead=None, body=None, access_key=None,
                    secret_key=None):
        if file_id is None:
            raise APIError("Missing required path param: file_id")
    ...
    def build_agent(self, access_key=None, secret_key=None, agentName=None, agentDescription=None, selectedFiles=None,
                    fileDescriptions=None, selectedOutputFormats=None, agentInstructions=None, body=None):
        """
        POST /build-agent/
