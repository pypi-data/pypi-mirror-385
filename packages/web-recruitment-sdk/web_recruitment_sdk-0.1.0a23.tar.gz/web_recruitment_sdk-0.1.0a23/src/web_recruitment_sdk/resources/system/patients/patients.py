...
from ....types.system import patient_create_params, patient_update_params, patient_get_vitals_params
from ....types.patient_read import PatientRead
from ....types.system.patient_get_vitals_response import PatientGetVitalsResponse
    ...
    def get_vitals(
        ...
        *,
        ...
        if not tenant_db_name:
            raise ValueError(f"Expected a non-empty value for `tenant_db_name` but received {tenant_db_name!r}")
        return self._post(
            f"/system/{tenant_db_name}/patients/vitals",
            body=maybe_transform({"patient_ids": patient_ids}, patient_get_vitals_params.PatientGetVitalsParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=PatientGetVitalsResponse,
        )
    ...
    async def get_vitals(
        ...
        *,
        ...
        return await self._post(
            f"/system/{tenant_db_name}/patients/vitals",
            body=await async_maybe_transform(
                {"patient_ids": patient_ids}, patient_get_vitals_params.PatientGetVitalsParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class PatientsResourceWithRawResponse:
    def __init__(self, patients: PatientsResource) -> None:
        ...
        self.get_vitals = to_raw_response_wrapper(
            patients.get_vitals,
        )
...
class AsyncPatientsResourceWithRawResponse:
    def __init__(self, patients: AsyncPatientsResource) -> None:
        ...
        self.get_vitals = async_to_raw_response_wrapper(
            patients.get_vitals,
        )
...
class PatientsResourceWithStreamingResponse:
    def __init__(self, patients: PatientsResource) -> None:
        ...
        self.get_vitals = to_streamed_response_wrapper(
            patients.get_vitals,
        )
...
class AsyncPatientsResourceWithStreamingResponse:
    def __init__(self, patients: AsyncPatientsResource) -> None:
        ...
        self.get_vitals = async_to_streamed_response_wrapper(
            patients.get_vitals,
        )
