...
class TestSites:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_context(self, client: WebRecruitmentSDK) -> None:
        site = client.sites.retrieve_context(
            0,
        )
        assert_matches_type(Optional[SiteRetrieveContextResponse], site, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_context(self, client: WebRecruitmentSDK) -> None:
        response = client.sites.with_raw_response.retrieve_context(
            0,
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_context(self, client: WebRecruitmentSDK) -> None:
        with client.sites.with_streaming_response.retrieve_context(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSites:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_context(self, async_client: AsyncWebRecruitmentSDK) -> None:
        site = await async_client.sites.retrieve_context(
            0,
        )
        assert_matches_type(Optional[SiteRetrieveContextResponse], site, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_context(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.sites.with_raw_response.retrieve_context(
            0,
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_context(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.sites.with_streaming_response.retrieve_context(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
