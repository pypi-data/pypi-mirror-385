...
class TestCriteria:
    ...
    def test_method_get_matching_progress(self, client: WebRecruitmentSDK) -> None:
        criterion = client.system.criteria.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        )
    ...
    def test_raw_response_get_matching_progress(self, client: WebRecruitmentSDK) -> None:
        response = client.system.criteria.with_raw_response.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        )
    ...
    def test_streaming_response_get_matching_progress(self, client: WebRecruitmentSDK) -> None:
        with client.system.criteria.with_streaming_response.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_matching_progress(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            client.system.criteria.with_raw_response.get_matching_progress(
                criterion_id=0,
                tenant_db_name="",
            )
...
class TestAsyncCriteria:
    ...
    async def test_method_get_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        criterion = await async_client.system.criteria.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        )
        assert_matches_type(CriterionGetMatchingProgressResponse, criterion, path=["response"])
    ...
    async def test_raw_response_get_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.system.criteria.with_raw_response.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        )
    ...
    async def test_streaming_response_get_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.system.criteria.with_streaming_response.get_matching_progress(
            criterion_id=0,
            tenant_db_name="tenant_db_name",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            await async_client.system.criteria.with_raw_response.get_matching_progress(
                criterion_id=0,
                tenant_db_name="",
            )
