...
class TestPatients:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_vitals(self, client: WebRecruitmentSDK) -> None:
        patient = client.system.patients.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        )
        assert_matches_type(PatientGetVitalsResponse, patient, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_vitals(self, client: WebRecruitmentSDK) -> None:
        response = client.system.patients.with_raw_response.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_vitals(self, client: WebRecruitmentSDK) -> None:
        with client.system.patients.with_streaming_response.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_vitals(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            client.system.patients.with_raw_response.get_vitals(
                tenant_db_name="",
                patient_ids=["string"],
            )
...
class TestAsyncPatients:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_vitals(self, async_client: AsyncWebRecruitmentSDK) -> None:
        patient = await async_client.system.patients.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        )
        assert_matches_type(PatientGetVitalsResponse, patient, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_vitals(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.system.patients.with_raw_response.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_vitals(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.system.patients.with_streaming_response.get_vitals(
            tenant_db_name="tenant_db_name",
            patient_ids=["string"],
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_vitals(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            await async_client.system.patients.with_raw_response.get_vitals(
                tenant_db_name="",
                patient_ids=["string"],
            )
