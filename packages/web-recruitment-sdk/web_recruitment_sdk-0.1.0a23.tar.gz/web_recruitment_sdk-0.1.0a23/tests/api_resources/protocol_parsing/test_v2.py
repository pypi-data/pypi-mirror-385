...
class TestV2:
    ...
    def test_method_upload(self, client: WebRecruitmentSDK) -> None:
        v2 = client.protocol_parsing.v2.upload(
            file=b"raw file contents",
            title="title",
        )
        assert_matches_type(ProtocolRead, v2, path=["response"])
    ...
    def test_raw_response_upload(self, client: WebRecruitmentSDK) -> None:
        response = client.protocol_parsing.v2.with_raw_response.upload(
            file=b"raw file contents",
            title="title",
        )
    ...
    def test_streaming_response_upload(self, client: WebRecruitmentSDK) -> None:
        with client.protocol_parsing.v2.with_streaming_response.upload(
            file=b"raw file contents",
            title="title",
        ) as response:
...
class TestAsyncV2:
    ...
    async def test_method_upload(self, async_client: AsyncWebRecruitmentSDK) -> None:
        v2 = await async_client.protocol_parsing.v2.upload(
            file=b"raw file contents",
            title="title",
        )
        assert_matches_type(ProtocolRead, v2, path=["response"])
    ...
    async def test_raw_response_upload(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.protocol_parsing.v2.with_raw_response.upload(
            file=b"raw file contents",
            title="title",
        )
    ...
    async def test_streaming_response_upload(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.protocol_parsing.v2.with_streaming_response.upload(
            file=b"raw file contents",
            title="title",
        ) as response:
            assert not response.is_closed
