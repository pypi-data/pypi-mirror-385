...
from ...types.protocols import criterion_create_params, criterion_update_params, criterion_get_matching_progress_params
...
class CriteriaResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            f"/protocols/{path_protocol_id}/criteria",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._put(
            f"/protocols/{path_protocol_id}/criteria/{criterion_id}",
            body=maybe_transform(
                {
                    "summary": summary,
                    "type": type,
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/protocols/{protocol_id}/criteria/{criterion_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def get_matching_progress(
        ...
        *,
        ...
        """
        return self._get(
            f"/protocols/{protocol_id}/criteria/matching-progress",
            options=make_request_options(
