...
class SitesResourceWithRawResponse:
    ...
    def context(self) -> ContextResourceWithRawResponse:
        return ContextResourceWithRawResponse(self._sites.context)
...
class AsyncSitesResourceWithRawResponse:
    ...
    def context(self) -> AsyncContextResourceWithRawResponse:
        return AsyncContextResourceWithRawResponse(self._sites.context)
...
class SitesResourceWithStreamingResponse:
    ...
    def context(self) -> ContextResourceWithStreamingResponse:
        return ContextResourceWithStreamingResponse(self._sites.context)
...
class AsyncSitesResourceWithStreamingResponse:
    ...
    def context(self) -> AsyncContextResourceWithStreamingResponse:
        return AsyncContextResourceWithStreamingResponse(self._sites.context)
