...
__all__ = ["AdminListAccountsResponse", "AdminListAccountsResponseItem"]


class AdminListAccountsResponseItem(BaseModel):
    id: int
...
AdminListAccountsResponse: TypeAlias = List[AdminListAccountsResponseItem]
