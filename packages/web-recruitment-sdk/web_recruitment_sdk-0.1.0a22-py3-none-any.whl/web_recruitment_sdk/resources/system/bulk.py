...
class BulkResource(SyncAPIResource):
    ...
    def update_criteria_instances(
        ...
        *,
        ...
        return self._put(
            f"/system/{tenant_db_name}/bulk/criteria_instances",
...
class AsyncBulkResource(AsyncAPIResource):
    ...
    async def update_criteria_instances(
        self,
        tenant_db_name: str,
        *,
        body: Iterable[CriteriaInstanceCreateParam],
...
class BulkResourceWithRawResponse:
    def __init__(self, bulk: BulkResource) -> None:
        ...
        self.update_criteria_instances = to_raw_response_wrapper(
            bulk.update_criteria_instances,
        )
...
class AsyncBulkResourceWithRawResponse:
    def __init__(self, bulk: AsyncBulkResource) -> None:
        ...
        self.update_criteria_instances = async_to_raw_response_wrapper(
            bulk.update_criteria_instances,
        )
...
class BulkResourceWithStreamingResponse:
    def __init__(self, bulk: BulkResource) -> None:
        ...
        self.update_criteria_instances = to_streamed_response_wrapper(
            bulk.update_criteria_instances,
        )
...
class AsyncBulkResourceWithStreamingResponse:
    def __init__(self, bulk: AsyncBulkResource) -> None:
        ...
        self.update_criteria_instances = async_to_streamed_response_wrapper(
            bulk.update_criteria_instances,
        )
