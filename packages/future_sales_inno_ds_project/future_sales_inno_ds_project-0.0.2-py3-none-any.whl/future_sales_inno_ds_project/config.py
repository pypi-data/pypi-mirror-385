...
# Check if the base directory is ds-practice
assert os.path.basename(BASE_DIR) == "ds-practice", "BASE_DIR не указывает на ds-practice"
...
HISTOGRAM_PATH = os.path.join(BASE_DIR, "shap_graph/error_histogram.png")
DYNAMIC_VS_ERROR_PATH = os.path.join(BASE_DIR, "shap_graph/dynamic_vs_error.png")
BEESWARM_PATH = os.path.join(BASE_DIR, "shap_graph/shap_beeswarm.png")
SHAP_LSTM_PATH = os.path.join(BASE_DIR, "shap_graph/shap_lstm_summary.png")


# To retrain base rfr model for feature selection
