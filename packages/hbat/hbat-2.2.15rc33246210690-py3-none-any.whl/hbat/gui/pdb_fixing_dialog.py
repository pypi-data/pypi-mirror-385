...
class PDBFixingDialog:
    ...
    def _init_variables(self):
        ...
        self.fix_pdb_add_hydrogens = tk.BooleanVar(value=ParametersDefault.FIX_PDB_ADD_HYDROGENS)
        self.fix_pdb_add_heavy_atoms = tk.BooleanVar(value=ParametersDefault.FIX_PDB_ADD_HEAVY_ATOMS)
        self.fix_pdb_replace_nonstandard = tk.BooleanVar(value=ParametersDefault.FIX_PDB_REPLACE_NONSTANDARD)
        self.fix_pdb_remove_heterogens = tk.BooleanVar(value=ParametersDefault.FIX_PDB_REMOVE_HETEROGENS)
        self.fix_pdb_keep_water = tk.BooleanVar(value=ParametersDefault.FIX_PDB_KEEP_WATER)
    ...
    def _reset_defaults(self):
        ...
        self.fix_pdb_replace_nonstandard.set(ParametersDefault.FIX_PDB_REPLACE_NONSTANDARD)
    ...
    def _open_preset_manager(self):
        ...
        if result and "parameters" in result and "pdb_fixing" in result["parameters"]:
            ...
            messagebox.showwarning("Warning", "Selected preset does not contain PDB fixing parameters")