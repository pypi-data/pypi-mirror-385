...
def decompose_goal(
    ...
    client: AIAPIClient = AIAPIClient.from_config(global_config)  # type: ignore[assignment]
...
def review_task(
    ...
    """
    ws_config, global_config = get_workspace_or_exit()
    ai_client: AIAPIClient = AIAPIClient.from_config(global_config)  # type: ignore[assignment]
    task_client: TasksAPIClient = TasksAPIClient.from_config(global_config)  # type: ignore[assignment]
