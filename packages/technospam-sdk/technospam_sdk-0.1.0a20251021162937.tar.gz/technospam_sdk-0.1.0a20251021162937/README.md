# Technospam Sdk-python

A Python SDK technospam for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
from technospam_sdk.types.common import UserRegisterInput

async def main():
    # Initialize the SDK
    config = TechnospamSDKConfig(
        endpoint="https://api.example.com/graphql",
        api_key="your-api-key"  # Optional
    )
    
    sdk = TechnospamSDK(config)
...
The SDK is configured using the `TechnospamSDKConfig` class:

```python
from technospam_sdk import TechnospamSDKConfig
...
pytest --cov=technospam_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/technospam-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/technospam-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../technospam-frontend) - Frontend technospam
- [Boiler Backend](../technospam-python-be-graphql) - Python GraphQL backend technospam