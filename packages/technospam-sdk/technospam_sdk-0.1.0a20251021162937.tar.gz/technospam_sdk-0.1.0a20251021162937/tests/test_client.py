...
from technospam_sdk.client.base_client import AuthTokens, BaseGraphQLClient, TechnospamSDKConfig


def test_config_creation():
    """Test TechnospamSDKConfig creation"""
...
async def test_client_initialization():
    ...
    config = TechnospamSDKConfig(endpoint="https://api.test.com/graphql")
...
def test_headers_generation():
    ...
    config = TechnospamSDKConfig(endpoint="https://api.test.com/graphql", api_key="test-key")
    client = BaseGraphQLClient(config)
