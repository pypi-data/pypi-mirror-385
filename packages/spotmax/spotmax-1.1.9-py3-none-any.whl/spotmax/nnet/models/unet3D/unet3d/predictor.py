...
class NumpyPredictor(_AbstractPredictor):
    """
    Applies the model on the given dataset znd return the Numpy Array.
    ...
    def _get_results(self, prediction_maps, normalization_masks, output_heads, dataset):
        predictions = []
