"""
Implementation of the DefaultNode type.
"""
...
class DefaultNodeType(NodeType):
    """Default node type with basic functionality."""
    ...
    def enhance_prompt(self, prompt: str, node_config: Dict[str, Any]) -> str:
        ...
        """
        # Default node doesn't need to enhance the prompt
        return prompt
    ...
    async def execute(
        ...
        """
        Execute the default node's action with automatic retry on Anthropic overload errors.
