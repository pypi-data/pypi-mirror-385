...
# ---------------------------
azure_storage_connection_string: "DefaultEndpointsProtocol=https;AccountName=swmdocuments;..."
azure_storage_container_name: "service-workflow-documents"

# Files will be stored in Azure Blob Storage
# Example: https://swmdocuments.blob.core.windows.net/service-workflow-documents/1/task/123/20250120_143000_document.pdf


# prod.yaml (Production)
# -----------------------
azure_storage_connection_string: "DefaultEndpointsProtocol=https;AccountName=swmprod;..."
