...
class DeviceClass(K8sResource):
    ...
    api_path_: ClassVar[str] = 'apis/resource.k8s.io/v1/deviceclasses'
    plural_: ClassVar[str] = 'deviceclasses'
    is_namespaced_: ClassVar[bool] = False
    group_: ClassVar[Optional[str]] = 'resource.k8s.io'
    apiVersion_: ClassVar[str] = 'resource.k8s.io/v1'
...
class ResourceSlice(K8sResource):
    ...
    metadata: ObjectMeta = field(default_factory=ObjectMeta)
    api_path_: ClassVar[str] = 'apis/resource.k8s.io/v1/resourceslices'
