...
class ListMeta(LazyLoadModel):
    ...
    remainingItemCount: int_aliased | None = None
...
class OwnerReference(LazyLoadModel):
    ...
    name: str
    uid: str
    blockOwnerDeletion: bool_aliased | None = None
    controller: bool_aliased | None = None
...
class StatusDetails(LazyLoadModel):
    ...
    kind: str | None = None
    name: str | None = None
    retryAfterSeconds: int_aliased | None = None
    uid: str | None = None
...
@dataclass(kw_only=True, frozen=True)
class Condition(LazyLoadModel):
    lastTransitionTime: Time
    message: str
    reason: str
    status: str
    type: str
    observedGeneration: int_aliased | None = None
...
class DeleteOptions(LazyLoadModel):
    ...
    gracePeriodSeconds: int_aliased | None = None
    ignoreStoreReadErrorWithClusterBreakingPotential: bool_aliased | None = None
    kind: str = 'DeleteOptions'
    orphanDependents: bool_aliased | None = None
...
class ObjectMeta(LazyLoadModel):
    ...
    deletionGracePeriodSeconds: int_aliased | None = None
    ...
    generation: int_aliased | None = None
