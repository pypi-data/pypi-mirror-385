...
class FlowSchemaStatus(LazyLoadModel):
    conditions: List[FlowSchemaCondition] = field(
...
class PriorityLevelConfigurationStatus(LazyLoadModel):
    conditions: List[PriorityLevelConfigurationCondition] = field(
        default_factory=list,
        metadata={
            'x-kubernetes-patch-strategy': 'merge',
            'x-kubernetes-patch-merge-key': 'type',
...
class PriorityLevelConfiguration(K8sResource):
    apiVersion: str = 'flowcontrol.apiserver.k8s.io/v1'
    ...
    apiVersion_: ClassVar[str] = 'flowcontrol.apiserver.k8s.io/v1'
...
class FlowSchema(K8sResource):
    ...
    api_path_: ClassVar[str] = 'apis/flowcontrol.apiserver.k8s.io/v1/flowschemas'
