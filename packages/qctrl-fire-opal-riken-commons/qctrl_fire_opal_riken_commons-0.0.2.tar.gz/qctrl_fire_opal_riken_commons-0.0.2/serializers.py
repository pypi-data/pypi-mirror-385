...
def encode_sampler_pub_results(sampler_pub_results: list[SamplerPubResult]) -> str:
    """
    Encode a list of SamplerPub objects to a JSON string.
...
def decode_sampler_pub_results(sampler_pub_results_json: str) -> list[SamplerPubResult]:
    """
    Decode a list of SamplerPub objects from JSON string format.
