...
class IIIFCollectionEntry(BaseModel):
    """
    The IIIF Collection items
    """ # noqa: E501
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4096)]] = Field(default=None, description="The name of the IIIF collection.")
    id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="The identifier of the IIIF collection.")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the IIIF collection.")
    item_number: Optional[StrictInt] = Field(default=None, description="The item number of the IIIF collection.", alias="itemNumber")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "name", "id", "url", "itemNumber", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIIFCollectionEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIIFCollectionEntry from a dict"""
        if obj is None:
            return None
