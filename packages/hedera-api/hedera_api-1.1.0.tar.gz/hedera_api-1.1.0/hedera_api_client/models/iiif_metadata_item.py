...
class IIIFMetadataItem(BaseModel):
    """
    A IIIF Metadata Item.
    """ # noqa: E501
    label: Optional[IIIFMultiLanguageText] = None
    value: Optional[IIIFMultiLanguageText] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIIFMetadataItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIIFMetadataItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "value": IIIFMultiLanguageText.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
