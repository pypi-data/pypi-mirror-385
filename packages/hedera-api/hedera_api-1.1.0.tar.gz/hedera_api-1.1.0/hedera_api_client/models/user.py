...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "searchCriterias", "lastLoginTime", "lastLoginIpAddress", "applicationRole", "disabled", "email", "externalUid", "firstName", "lastName", "homeOrganization", "person", "enabled", "fullName", "authUserDto", "_links"]
