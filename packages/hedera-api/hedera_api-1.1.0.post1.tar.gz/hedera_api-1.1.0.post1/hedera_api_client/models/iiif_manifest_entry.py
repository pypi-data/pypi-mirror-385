...
class IIIFManifestEntry(BaseModel):
    """
    The IIIF Manifest items
    """ # noqa: E501
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(default=None, description="The name of the IIIF manifest.")
    id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="The identifier of the IIIF manifest.")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the IIIF manifest.")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "name", "id", "url", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIIFManifestEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIIFManifestEntry from a dict"""
        if obj is None:
            return None
