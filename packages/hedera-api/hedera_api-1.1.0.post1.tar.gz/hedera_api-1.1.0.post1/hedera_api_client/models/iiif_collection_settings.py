...
class IIIFCollectionSettings(BaseModel):
    """
    The IIIFCollection configuration
    """ # noqa: E501
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the IIIF collection.")
    description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4096)]] = Field(default=None, description="The description of the IIIF collection.")
    iiif_collection_sparql_query: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2147483646)]] = Field(default=None, description="SPARQL requests to generate IIIF collection.", alias="iiifCollectionSparqlQuery")
    project: Optional[Project] = None
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "name", "description", "iiifCollectionSparqlQuery", "project", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IIIFCollectionSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IIIFCollectionSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "iiifCollectionSparqlQuery": obj.get("iiifCollectionSparqlQuery"),
