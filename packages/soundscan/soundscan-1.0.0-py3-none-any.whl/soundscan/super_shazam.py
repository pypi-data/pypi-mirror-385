...
from .history_manager import SearchHistory


class EnhancedShazam:
    """Main application class"""

    def __init__(self):
        # ACRCloud configuration
        self.recognizer = ACRCloudRecognizer(
            access_key="7ae83bc88ad549e01688c90203ec5700",
            access_secret="Owi7pdGrPaR9zTdPpWT0LPwaaUQQyPKe4gYcyPFi",
