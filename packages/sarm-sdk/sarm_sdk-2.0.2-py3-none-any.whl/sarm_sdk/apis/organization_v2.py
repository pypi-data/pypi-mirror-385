...
class OrganizationAPI:
    ...
    def publish(
        ...
        将预审状态的组织架构数据发布为正式数据。支持批量发布和强制发布。

        Args:
            organize_repeat_ids: 部门重复性标识列表
            is_all: 是否全部发布
                - True: 发布所有符合条件的组织
                - False: 仅发布指定的组织
            is_force: 是否强制发布
        ...
        Example:
            ...
            >>> result = api.publish(
            ...     organize_repeat_ids=[
            ...         "ea1b068a2ab2c2c3c712da4f88c7aebcf77c509391a807141378b6645ad73e0c"
            ...     ],
            ...     is_all=False,
            ...     is_force=False
            ... )
        ...
        Note:
            - 发布操作是不可逆的，请谨慎操作
            - 建议在发布前先通过 get_list() 方法查询预审数据状态
            - 强制发布可能会覆盖现有的正式数据
        """
        request_data = {
            "organize_repeat_ids": organize_repeat_ids,
            "is_all": is_all,
            "is_force": is_force
        }

        response = self.client.post('/api/v2/temporary_organize/publish', data=request_data)
        return response
    ...
    def publish_users(
        self,
        organize_user_repeat_ids: List[str],
        is_all: bool,
        is_force: bool
    ) -> Dict[str, Any]:
        """
        ...
        将预审状态的组织人员数据发布为正式数据。支持批量发布和强制发布。

        Args:
            organize_user_repeat_ids: 组织人员重复性标识列表
            is_all: 是否全部发布
                - True: 发布所有符合条件的组织人员
                - False: 仅发布指定的组织人员
            is_force: 是否强制发布
        ...
        Example:
            >>> # 发布指定的组织人员
            >>> result = api.publish_users(
            ...     organize_user_repeat_ids=[
            ...         "1766a2c22db799782d90b3a08ce90e0f09ef4b65e2126d0c85751654d02a34b2"
            ...     ],
            ...     is_all=False,
            ...     is_force=False
            ... )
        ...
        Note:
            - 发布操作是不可逆的，请谨慎操作
            - 建议在发布前先通过 get_users() 方法查询预审人员数据状态
            - 强制发布可能会覆盖现有的正式数据
            - 发布组织人员前，请确保相关的组织架构已经发布
        """
        request_data = {
            "organize_user_repeat_ids": organize_user_repeat_ids,
            "is_all": is_all,
            "is_force": is_force
        }

        response = self.client.post('/api/v2/temporary_organize_user/publish', data=request_data)
        return response
