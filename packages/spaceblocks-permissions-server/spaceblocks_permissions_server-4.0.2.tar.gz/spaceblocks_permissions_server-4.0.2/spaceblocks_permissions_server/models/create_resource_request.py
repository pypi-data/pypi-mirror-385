...
class CreateResourceRequest(BaseModel):
    ...
    parent: Optional[CreateResourceParent] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "parent", "members", "isInheritanceDisabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parent": CreateResourceParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
