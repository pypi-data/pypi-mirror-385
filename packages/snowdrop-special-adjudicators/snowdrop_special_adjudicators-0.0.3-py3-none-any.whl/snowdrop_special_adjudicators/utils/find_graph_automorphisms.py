...
def generate_list_of_automorphisms(vertex_count, edge_list, max_automorphisms_to_return, verbose=False) -> list:
...
def get_automorphisms(graph_number, data_dir) -> list:
    ...
    if os.path.isfile(file_path):
        ...
        graph = graph_properties.graph_database[graph_number]

        list_of_automorphisms = generate_list_of_automorphisms(vertex_count=graph['num_nodes'],
