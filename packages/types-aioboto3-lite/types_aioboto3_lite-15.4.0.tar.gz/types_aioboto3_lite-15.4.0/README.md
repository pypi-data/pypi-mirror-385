...
- `types-aioboto3-lite[apptest]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[arc-region-switch]` - Type annotations for
...
- `types-aioboto3-lite[batch]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[bcm-dashboards]` - Type annotations for
...
- `types-aioboto3-lite[bcm-pricing-calculator]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[bcm-recommended-actions]` - Type annotations for
