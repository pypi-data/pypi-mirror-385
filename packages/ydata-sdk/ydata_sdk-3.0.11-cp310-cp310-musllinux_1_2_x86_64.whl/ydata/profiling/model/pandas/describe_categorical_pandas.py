...
from ydata.profiling.model.pandas.fuzzy_categories import get_fuzzy_categories
from ydata.profiling.model.summary_algorithms import describe_categorical_1d
...
def pandas_describe_categorical_1d(
    ...
    if config.vars.cat.dirty_categories:
        summary.update(get_fuzzy_categories(series,
                                            threshold=config.vars.cat.dirty_categories_threshold))
