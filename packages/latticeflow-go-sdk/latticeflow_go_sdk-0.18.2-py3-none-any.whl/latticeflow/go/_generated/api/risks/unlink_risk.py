...
from ...models.model import ControlRiskLinks
from ...models.model import Error
from ...models.model import Success
from ...types import Response


def _get_kwargs(risk_id: str, body: ControlRiskLinks) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": f"/risks/{risk_id}/unlink"}
...
def sync_detailed(
    risk_id: str, body: ControlRiskLinks, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, Success]]:
