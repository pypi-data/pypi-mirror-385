...
def _get_kwargs(body: Requirement) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": "/requirements"}
...
def sync_detailed(
    body: Requirement, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredRequirement]]:
