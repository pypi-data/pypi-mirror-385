...
from ...models.model import Frameworks
...
def _get_kwargs(key: Union[Unset, str] = UNSET) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/frameworks", "params": params}
...
) -> Union[Error, Frameworks]:
    if response.status_code == 200:
        response_200 = Frameworks.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, Frameworks]]:
    return Response(
