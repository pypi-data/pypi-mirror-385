...
from ...models.model import CreateChatCompletionRequest
from ...models.model import CreateChatCompletionResponse
from ...models.model import Error
from ...types import Response


def _get_kwargs(body: CreateChatCompletionRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/assistant/v1/chat/completions",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateChatCompletionResponse.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateChatCompletionResponse, Error]]:
    return Response(
...
def sync_detailed(
    body: CreateChatCompletionRequest, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[CreateChatCompletionResponse, Error]]:
