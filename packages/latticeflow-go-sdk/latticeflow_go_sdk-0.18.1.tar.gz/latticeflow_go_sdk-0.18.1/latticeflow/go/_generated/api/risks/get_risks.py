...
from ...models.model import Risks
...
def _get_kwargs(
    *, framework_id: Union[Unset, str] = UNSET, key: Union[Unset, str] = UNSET
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/risks", "params": params}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = Risks.model_validate(response.json())
