...
from ...models.body import ImportFrameworkBody
from ...models.model import Error
from ...models.model import StoredFramework
from ...types import Response


def _get_kwargs(body: ImportFrameworkBody) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": "/frameworks/import"}
...
def sync_detailed(
    body: ImportFrameworkBody, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredFramework]]:
