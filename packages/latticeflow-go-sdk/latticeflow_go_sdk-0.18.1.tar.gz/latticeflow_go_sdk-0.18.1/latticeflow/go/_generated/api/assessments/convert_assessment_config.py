...
from ...models.model import GuardrailsAssessmentConfig
from ...models.model import TechnicalRiskAssessmentConfig
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {"method": "post", "url": "/assessments/convert_config"}

    if isinstance(body, ExternalTechnicalRiskAssessmentConfig):
...
) -> Union[Error, Union["GuardrailsAssessmentConfig", "TechnicalRiskAssessmentConfig"]]:
        ...
        def _parse_response_200(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_assessment_config_type_0 = (
                    TechnicalRiskAssessmentConfig.model_validate(data)
                )

                return componentsschemas_assessment_config_type_0
            except:  # noqa: E722
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_assessment_config_type_1 = (
                GuardrailsAssessmentConfig.model_validate(data)
            )

            return componentsschemas_assessment_config_type_1
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error, Union['GuardrailsAssessmentConfig', 'TechnicalRiskAssessmentConfig']]]
    """
