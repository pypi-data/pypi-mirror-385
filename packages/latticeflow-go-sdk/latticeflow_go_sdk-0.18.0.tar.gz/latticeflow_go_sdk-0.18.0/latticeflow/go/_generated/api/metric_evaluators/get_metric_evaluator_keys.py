...
from ...models.model import MetricEvaluatorKeys
from ...types import Response


def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": "/metric-evaluator-keys"}
...
) -> Union[Error, MetricEvaluatorKeys]:
    if response.status_code == 200:
        response_200 = MetricEvaluatorKeys.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, MetricEvaluatorKeys]]:
    return Response(
