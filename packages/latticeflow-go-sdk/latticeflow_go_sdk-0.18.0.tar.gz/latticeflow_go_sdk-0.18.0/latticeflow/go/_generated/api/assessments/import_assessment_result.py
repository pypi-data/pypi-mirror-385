...
from ...models.body import ImportAssessmentResultBody
from ...models.model import Error
from ...models.model import Success
from ...types import Response


def _get_kwargs(assessment_id: str, body: ImportAssessmentResultBody) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/assessments/{assessment_id}/result",
    }
