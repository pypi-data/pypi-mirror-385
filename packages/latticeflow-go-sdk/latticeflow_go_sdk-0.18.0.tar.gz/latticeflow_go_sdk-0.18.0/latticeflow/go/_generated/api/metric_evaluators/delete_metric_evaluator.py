...
def _get_kwargs(metric_evaluator_id: str, delete_evaluations: bool) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    """
    kwargs = _get_kwargs(
        metric_evaluator_id=metric_evaluator_id, delete_evaluations=delete_evaluations
    )
