...
from ...models.model import ControlRequirementLinks
from ...models.model import Error
from ...models.model import Success
from ...types import Response


def _get_kwargs(control_id: str, body: ControlRequirementLinks) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": f"/controls/{control_id}/link"}
