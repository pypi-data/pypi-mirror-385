...
from ...models.model import MetricEvaluator
from ...models.model import StoredMetricEvaluator
from ...types import Response


def _get_kwargs(body: MetricEvaluator) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": "/metric-evaluators"}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = StoredMetricEvaluator.model_validate(response.json())
...
def sync_detailed(
    body: MetricEvaluator, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredMetricEvaluator]]:
