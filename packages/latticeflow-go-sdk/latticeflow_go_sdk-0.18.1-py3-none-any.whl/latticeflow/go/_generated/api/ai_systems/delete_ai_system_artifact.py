...
def _get_kwargs(ai_system_id: str, artifact_id: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/ai-systems/{ai_system_id}/artifacts/{artifact_id}",
    }
...
def sync_detailed(
    ai_system_id: str, artifact_id: str, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, Success]]:
    ...
    Returns:
        Response[Union[Error, Success]]
    """
    kwargs = _get_kwargs(ai_system_id=ai_system_id, artifact_id=artifact_id)
