...
from ...models.model import AISystem
from ...models.model import Error
from ...models.model import StoredAISystem
from ...types import Response


def _get_kwargs(ai_system_id: str, body: AISystem) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "put", "url": f"/ai-systems/{ai_system_id}"}
...
def sync_detailed(
    ai_system_id: str, body: AISystem, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredAISystem]]:
    """Update an AI System
