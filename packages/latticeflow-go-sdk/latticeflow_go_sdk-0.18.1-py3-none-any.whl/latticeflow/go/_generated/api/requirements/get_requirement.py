...
def _get_kwargs(requirement_id: str) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = StoredRequirement.model_validate(response.json())
...
def sync_detailed(
    requirement_id: str, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredRequirement]]:
    """Get a requirement
    ...
    Returns:
        Response[Union[Error, StoredRequirement]]
    """
    kwargs = _get_kwargs(requirement_id=requirement_id)
...
def sync(
    ...
    Returns:
        Union[Error, StoredRequirement]
    """
    return sync_detailed(requirement_id=requirement_id, client=client).parsed
...
async def asyncio(
    ...
    Returns:
        Union[Error, StoredRequirement]
    """
    return (await asyncio_detailed(requirement_id=requirement_id, client=client)).parsed
