...
def _get_kwargs(metric_evaluation_id: str, body: MetricEvaluation) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error, StoredMetricEvaluation]]
    """
    kwargs = _get_kwargs(metric_evaluation_id=metric_evaluation_id, body=body)
...
def sync(
    ...
    *,
    ...
    return sync_detailed(
        metric_evaluation_id=metric_evaluation_id, client=client, body=body
    ).parsed
