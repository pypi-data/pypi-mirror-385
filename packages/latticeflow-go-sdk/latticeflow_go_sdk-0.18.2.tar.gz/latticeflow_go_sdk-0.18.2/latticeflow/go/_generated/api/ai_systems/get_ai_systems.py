...
from ...models.model import AISystems
...
def _get_kwargs(key: Union[Unset, str] = UNSET) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/ai-systems", "params": params}
...
) -> Union[AISystems, Error]:
    if response.status_code == 200:
        response_200 = AISystems.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AISystems, Error]]:
    return Response(
