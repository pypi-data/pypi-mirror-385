...
from ...models.model import StoredAssessments
...
def _get_kwargs(
    *, key: Union[Unset, str] = UNSET, ai_system_id: Union[Unset, str] = UNSET
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/assessments", "params": params}
...
) -> Union[Error, StoredAssessments]:
    if response.status_code == 200:
        response_200 = StoredAssessments.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, StoredAssessments]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    ai_system_id: Union[Unset, str] = UNSET,
) -> Response[Union[Error, StoredAssessments]]:
    """Get all assessments.
    ...
    Returns:
        Response[Union[Error, StoredAssessments]]
    """
    kwargs = _get_kwargs(key=key, ai_system_id=ai_system_id)
...
def sync(
    *,
    ...
    Returns:
        Union[Error, StoredAssessments]
    """
    return sync_detailed(client=client, key=key, ai_system_id=ai_system_id).parsed
...
async def asyncio(
    *,
    ...
    """
    return (
        await asyncio_detailed(client=client, key=key, ai_system_id=ai_system_id)
    ).parsed
