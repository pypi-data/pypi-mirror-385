...
from ...models.body import CreateMetricEvaluationBody
from ...models.model import Error
from ...models.model import StoredMetricEvaluation
from ...types import Response


def _get_kwargs(body: CreateMetricEvaluationBody) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {"method": "post", "url": "/metric-evaluations"}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = StoredMetricEvaluation.model_validate(response.json())
...
def sync_detailed(
    body: CreateMetricEvaluationBody, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredMetricEvaluation]]:
