...
from ...models.model import Controls
...
def _get_kwargs(
    *, framework_id: Union[Unset, str] = UNSET, key: Union[Unset, str] = UNSET
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/controls", "params": params}
...
) -> Union[Controls, Error]:
    if response.status_code == 200:
        response_200 = Controls.model_validate(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Controls, Error]]
    """
    kwargs = _get_kwargs(framework_id=framework_id, key=key)
...
def sync(
    *,
    ...
    Returns:
        Union[Controls, Error]
    """
    return sync_detailed(client=client, framework_id=framework_id, key=key).parsed
...
async def asyncio(
    *,
    ...
    """
    return (
        await asyncio_detailed(client=client, framework_id=framework_id, key=key)
    ).parsed
