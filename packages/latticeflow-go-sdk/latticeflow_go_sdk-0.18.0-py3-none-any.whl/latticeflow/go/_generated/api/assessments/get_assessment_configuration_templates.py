...
from ...models.model import AssessmentConfigs
...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/assessments/configuration-templates",
    }
...
) -> Union[AssessmentConfigs, Error]:
    if response.status_code == 200:
        response_200 = AssessmentConfigs.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AssessmentConfigs, Error]]:
    return Response(
