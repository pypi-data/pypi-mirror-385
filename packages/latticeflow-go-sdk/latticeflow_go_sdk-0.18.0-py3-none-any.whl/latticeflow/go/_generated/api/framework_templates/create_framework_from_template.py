...
def _get_kwargs(template_key: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/templates/frameworks/{template_key}/instantiate",
    }
...
def sync_detailed(
    template_key: str, *, client: Union[AuthenticatedClient, Client]
) -> Response[Union[Error, StoredFramework]]:
    ...
    Returns:
        Response[Union[Error, StoredFramework]]
    """
    kwargs = _get_kwargs(template_key=template_key)
...
def sync(
    ...
    Returns:
        Union[Error, StoredFramework]
    """
    return sync_detailed(template_key=template_key, client=client).parsed
...
async def asyncio(
    ...
    Returns:
        Union[Error, StoredFramework]
    """
    return (await asyncio_detailed(template_key=template_key, client=client)).parsed
