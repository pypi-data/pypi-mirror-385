...
from ...models.model import FrameworkTemplates
from ...types import Response


def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": "/templates/frameworks"}
...
) -> Union[Error, FrameworkTemplates]:
    if response.status_code == 200:
        response_200 = FrameworkTemplates.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, FrameworkTemplates]]:
    return Response(
