...
def main():
    ...
    try:
        ...
        pb.color.rainbow_cycle(1, cycles=1, duration_per_cycle=10.0)
        time.sleep(1.0)
        
        print("2. Breathing Blue")
        pb.color.breathing_effect(1, (0, 0, 63), breaths=3, breath_duration=2.0)
        time.sleep(1.0)

        print("3. Color Wave")
        colors = [(63, 0, 0), (0, 63, 0), (0, 0, 63)]
        pb.color.color_wave(1, colors, wave_duration=6.0)
        time.sleep(1.0)
