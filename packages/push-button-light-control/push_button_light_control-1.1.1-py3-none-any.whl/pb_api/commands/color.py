...
class ColorCommand(BaseCommand):
    ...
    Uses DC values directly (0-63) without percentage conversion
    """
    ...
    def execute(self, device_id: int, color_values: List[int]) -> bool:
        ...
        Args:
            ...
            color_values: List of 12 DC values (0-63)
    ...
    def set_color_values(self, device_id: int, dc_values: List[int]) -> bool:
        """
        Set DC values for all LEDs (0-63 directly)
        """
        if len(dc_values) != 12:
        ...
        # Check for success - accept both single ACK and setting response
