...
https://pypi.org/project/push-button-light-control/#push_button_light_control-1.0.6.tar.gz

Extract push_button_light_control-1.0.6.tar.gz

cd push_button_light_control-1.0.6
