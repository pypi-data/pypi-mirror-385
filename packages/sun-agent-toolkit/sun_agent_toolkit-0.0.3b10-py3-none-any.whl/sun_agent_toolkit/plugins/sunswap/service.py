...
class SunSwapService:
    ...
    async def _poll_transaction_details(
        ...
        for attempt in range(max_attempts):
            ...
            if tx_info:
                ...
                # 从日志中提取实际兑换数量
                actual_amount_out = self._extract_swap_amount_from_logs(tx_info, to_token, to_symbol)
    ...
    async def _get_sunpump_actual_amount(
        ...
        tx_details = await self._poll_transaction_details(wallet_client, tx_hash, token_address, None)
