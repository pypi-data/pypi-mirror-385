...
package_description = (
    "A flexible Python factory for working with multiple Large Language Model (LLM) providers "
    "(OpenAI, Anthropic, Gemini, Llama) using a unified interface, with robust configuration and extensibility."
)
