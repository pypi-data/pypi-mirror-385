...
os.environ["DJANGO_SETTINGS_MODULE"] = "settings_postgres"
sys.path.append(os.path.abspath("../../../"))
sys.path.append(os.path.abspath("../test_denorm_project/"))
...
project = u"django-denorm-iplweb"
copyright = u"2009, Christian Schilling, 2021, Michał Pasternak"
