# Kadaikodi Sdk-python

A Python SDK kadaikodi for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from kadaikodi_sdk import BoilerSDK, BoilerSDKConfig
from kadaikodi_sdk.types.common import UserRegisterInput
...
```python
from kadaikodi_sdk import BoilerSDKConfig
...
pytest --cov=kadaikodi_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/kadaikodi-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/kadaikodi-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../kadaikodi-frontend) - Frontend kadaikodi
- [Boiler Backend](../kadaikodi-python-be-graphql) - Python GraphQL backend kadaikodi