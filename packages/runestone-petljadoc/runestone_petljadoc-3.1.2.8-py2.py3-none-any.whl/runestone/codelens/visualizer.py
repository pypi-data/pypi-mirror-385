...
def setup(app):
    ...
    app.add_css_file('pytutor.css')
    app.add_css_file('modal-basic.css')

    app.add_js_file('d3.v2.min.js')
    app.add_js_file('jquery.ba-bbq.min.js')
    app.add_js_file('jquery.jsPlumb-1.3.10-all-min.js')
    app.add_js_file('pytutor.js')
    app.add_js_file('codelens.js')
