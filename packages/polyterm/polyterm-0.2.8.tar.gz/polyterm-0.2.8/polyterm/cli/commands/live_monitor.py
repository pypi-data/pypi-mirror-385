...
class LiveMarketMonitor:
    ...
    def run_live_monitor(self):
        ...
        try:
            ...
            market_ids = [market.get("id") for market in markets_data if market.get("id")]
            market_titles = {market.get("id"): market.get("title", "Unknown") for market in markets_data}
            ...
            # Run async WebSocket monitoring
