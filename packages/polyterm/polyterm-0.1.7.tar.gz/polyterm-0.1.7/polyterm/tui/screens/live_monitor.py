...
def live_monitor_screen(console: RichConsole):
    ...
    try:
        ...
        if choice == "1":
            ...
            console.print("• politics") 
            console.print("• sports")
            console.print("• economics")
            console.print("• entertainment")
            console.print("• other")
            console.print()
            ...
            try:
                markets = gamma_client.get_markets(tag_id=None, closed=False, limit=5)
                category_markets = [m for m in markets if m.get('category', '').lower() == category.lower()]
