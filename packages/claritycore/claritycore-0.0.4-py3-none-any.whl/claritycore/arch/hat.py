# Implementation of HAT architecture from:
...
from claritycore.archs.arch_util import to_2tuple, trunc_normal_
from claritycore.archs.components import MLP, Upsample
