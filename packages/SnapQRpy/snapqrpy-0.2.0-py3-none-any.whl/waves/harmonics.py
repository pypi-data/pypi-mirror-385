...
@dataclass
class HarmonicsParameters:
    resolution: int = 1024
    precision: float = 1e-12
    max_iterations: int = 50000
    convergence_threshold: float = 1e-9
    enable_parallel: bool = True
    mode: HarmonicsMode = HarmonicsMode.BALANCED
    cache_size: int = 10000
    numerical_method: str = "runge_kutta_45"
    
class HarmonicsSimulator:
    def __init__(self, params: HarmonicsParameters = None):
        self.params = params or HarmonicsParameters()
