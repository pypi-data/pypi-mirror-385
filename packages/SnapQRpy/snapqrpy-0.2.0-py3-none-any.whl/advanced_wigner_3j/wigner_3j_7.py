...
class wigner_3jProcessor7:
    def __init__(self, dim=1353, depth=13):
        self.D = dim
        self.depth = depth
    ...
    def apply_nonlinear_map(self, x: np.ndarray, alpha=0.624851612187743) -> np.ndarray:
    ...
    def method_wigner_3j_7_0(self, x: np.ndarray, p1=0.0628, p2=0.0615) -> np.ndarray:
    ...
    def method_wigner_3j_7_1(self, x: np.ndarray, p1=0.1649, p2=0.2705) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_2(self, x: np.ndarray, p1=0.0773, p2=0.8425) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_3(self, x: np.ndarray, p1=0.2408, p2=0.5956) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_4(self, x: np.ndarray, p1=0.2945, p2=0.2504) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_5(self, x: np.ndarray, p1=0.6226, p2=0.9451) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_6(self, x: np.ndarray, p1=0.6667, p2=0.5791) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_7(self, x: np.ndarray, p1=0.5312, p2=0.0502) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_8(self, x: np.ndarray, p1=0.2822, p2=0.5580) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_9(self, x: np.ndarray, p1=0.9727, p2=0.6939) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_10(self, x: np.ndarray, p1=0.0733, p2=0.0905) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_11(self, x: np.ndarray, p1=0.9525, p2=0.1893) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_12(self, x: np.ndarray, p1=0.7721, p2=0.2953) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_13(self, x: np.ndarray, p1=0.3755, p2=0.6567) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_14(self, x: np.ndarray, p1=0.3033, p2=0.8815) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_15(self, x: np.ndarray, p1=0.9357, p2=0.5856) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_16(self, x: np.ndarray, p1=0.9034, p2=0.1779) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_17(self, x: np.ndarray, p1=0.7309, p2=0.7563) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_18(self, x: np.ndarray, p1=0.9660, p2=0.6710) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_19(self, x: np.ndarray, p1=0.2977, p2=0.3824) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_20(self, x: np.ndarray, p1=0.6801, p2=0.0012) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_21(self, x: np.ndarray, p1=0.8210, p2=0.6647) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_22(self, x: np.ndarray, p1=0.7807, p2=0.7249) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_23(self, x: np.ndarray, p1=0.9918, p2=0.9840) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_24(self, x: np.ndarray, p1=0.5650, p2=0.0153) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_25(self, x: np.ndarray, p1=0.6187, p2=0.3139) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_26(self, x: np.ndarray, p1=0.0079, p2=0.1607) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_wigner_3j_7_27(self, x: np.ndarray, p1=0.2853, p2=0.9497) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
