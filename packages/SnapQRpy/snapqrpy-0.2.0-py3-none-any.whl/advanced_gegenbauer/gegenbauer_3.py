...
class gegenbauerProcessor3:
    def __init__(self, dim=451, depth=4):
        self.D = dim
        self.depth = depth
    ...
    def apply_nonlinear_map(self, x: np.ndarray, alpha=0.9341369405117159) -> np.ndarray:
    ...
    def method_gegenbauer_3_0(self, x: np.ndarray, p1=0.5322, p2=0.7554) -> np.ndarray:
    ...
    def method_gegenbauer_3_1(self, x: np.ndarray, p1=0.9312, p2=0.5954) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_2(self, x: np.ndarray, p1=0.3932, p2=0.7599) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_3(self, x: np.ndarray, p1=0.4344, p2=0.2620) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_4(self, x: np.ndarray, p1=0.1701, p2=0.3876) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_5(self, x: np.ndarray, p1=0.6108, p2=0.9430) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_6(self, x: np.ndarray, p1=0.9360, p2=0.3080) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_7(self, x: np.ndarray, p1=0.3186, p2=0.5764) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_8(self, x: np.ndarray, p1=0.2773, p2=0.4432) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_9(self, x: np.ndarray, p1=0.1851, p2=0.9169) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_10(self, x: np.ndarray, p1=0.8352, p2=0.2792) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_11(self, x: np.ndarray, p1=0.8434, p2=0.2165) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_12(self, x: np.ndarray, p1=0.9924, p2=0.3992) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_13(self, x: np.ndarray, p1=0.3591, p2=0.4087) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_14(self, x: np.ndarray, p1=0.1051, p2=0.6488) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_15(self, x: np.ndarray, p1=0.5194, p2=0.2276) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_16(self, x: np.ndarray, p1=0.0797, p2=0.3638) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_17(self, x: np.ndarray, p1=0.5449, p2=0.4234) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_18(self, x: np.ndarray, p1=0.1552, p2=0.9800) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_19(self, x: np.ndarray, p1=0.0937, p2=0.6412) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_20(self, x: np.ndarray, p1=0.9458, p2=0.8094) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_21(self, x: np.ndarray, p1=0.0719, p2=0.0217) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_22(self, x: np.ndarray, p1=0.2232, p2=0.2100) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_23(self, x: np.ndarray, p1=0.7150, p2=0.5764) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_24(self, x: np.ndarray, p1=0.9380, p2=0.5228) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_25(self, x: np.ndarray, p1=0.3978, p2=0.3368) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_26(self, x: np.ndarray, p1=0.9920, p2=0.8506) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_27(self, x: np.ndarray, p1=0.0745, p2=0.6407) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_gegenbauer_3_28(self, x: np.ndarray, p1=0.6236, p2=0.4032) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
        w = np.abs(z) * np.exp(1j * (np.angle(z) + 0.425))
        result = np.fft.ifft(w, axis=0)
    ...
    def method_gegenbauer_3_29(self, x: np.ndarray, p1=0.4067, p2=0.1801) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
