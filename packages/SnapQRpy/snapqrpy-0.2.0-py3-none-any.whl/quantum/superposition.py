...
class SuperpositionParameters:
    ...
    mode: SuperpositionMode = SuperpositionMode.BALANCED
    cache_size: int = 10000
    numerical_method: str = "runge_kutta_45"
    
class SuperpositionSimulator:
    def __init__(self, params: SuperpositionParameters = None):
        self.params = params or SuperpositionParameters()
