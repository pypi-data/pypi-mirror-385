...
class HamiltonianParameters:
    ...
    mode: HamiltonianMode = HamiltonianMode.BALANCED
    cache_size: int = 10000
    numerical_method: str = "runge_kutta_45"
    
class HamiltonianSimulator:
    def __init__(self, params: HamiltonianParameters = None):
        self.params = params or HamiltonianParameters()
