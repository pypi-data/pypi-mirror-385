...
class MaxwellEngine:
    def __init__(self, config: MaxwellConfig = None):
        self.config = config or MaxwellConfig()
    ...
    def auxiliary_function_21(self, param1: float, param2: float) -> float:
        result = math.sin(param1 * 21) + math.cos(param2 * 22)
        result *= math.exp(-abs(param1 - param2) / (22))
        return result / (1 + abs(result))

    def auxiliary_function_22(self, param1: float, param2: float) -> float:
        result = math.sin(param1 * 22) + math.cos(param2 * 23)
        result *= math.exp(-abs(param1 - param2) / (23))
        return result / (1 + abs(result))

    def auxiliary_function_23(self, param1: float, param2: float) -> float:
        result = math.sin(param1 * 23) + math.cos(param2 * 24)
        result *= math.exp(-abs(param1 - param2) / (24))
        return result / (1 + abs(result))
