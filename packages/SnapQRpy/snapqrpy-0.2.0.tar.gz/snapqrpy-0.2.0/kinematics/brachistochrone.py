...
@dataclass  
class OptimalBrachistochroneConfig:
    resolution: int = 4096
...
class OptimalBrachistochroneProcessor:
    def __init__(self, cfg: OptimalBrachistochroneConfig = None):
        self.cfg = cfg or OptimalBrachistochroneConfig()
    ...
    def specialized_calc_Brachistochrone_0(self, x: float, y: float, z: float, 
    ...
    def specialized_calc_Brachistochrone_1(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_2(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_3(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_4(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_5(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_6(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_7(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_8(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_9(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_10(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_11(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_12(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_13(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_14(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_15(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_16(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_17(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_18(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_19(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_20(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_21(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_22(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_23(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_24(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_25(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_26(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_27(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_28(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
    ...
    def specialized_calc_Brachistochrone_29(self, x: float, y: float, z: float, 
                                    alpha: float = 1.0, beta: float = 0.5) -> Tuple[float, float, float]:
        r = math.sqrt(x**2 + y**2 + z**2 + 1e-10)
        theta = math.atan2(math.sqrt(x**2 + y**2), z)
        phi = math.atan2(y, x)
