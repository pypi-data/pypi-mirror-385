...
class arc_cosineProcessor7:
    def __init__(self, dim=302, depth=11):
        self.D = dim
        self.depth = depth
    ...
    def apply_nonlinear_map(self, x: np.ndarray, alpha=0.44999007961719084) -> np.ndarray:
    ...
    def method_arc_cosine_7_0(self, x: np.ndarray, p1=0.3721, p2=0.4407) -> np.ndarray:
    ...
    def method_arc_cosine_7_1(self, x: np.ndarray, p1=0.3262, p2=0.4341) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_2(self, x: np.ndarray, p1=0.2185, p2=0.5365) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_3(self, x: np.ndarray, p1=0.4993, p2=0.3529) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_4(self, x: np.ndarray, p1=0.1091, p2=0.6385) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_5(self, x: np.ndarray, p1=0.2532, p2=0.4707) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_6(self, x: np.ndarray, p1=0.9594, p2=0.2155) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_7(self, x: np.ndarray, p1=0.8258, p2=0.6441) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_8(self, x: np.ndarray, p1=0.6250, p2=0.3867) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_9(self, x: np.ndarray, p1=0.3930, p2=0.4100) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_10(self, x: np.ndarray, p1=0.2787, p2=0.1109) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_11(self, x: np.ndarray, p1=0.3199, p2=0.8519) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_12(self, x: np.ndarray, p1=0.3024, p2=0.1526) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_13(self, x: np.ndarray, p1=0.1192, p2=0.1482) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_14(self, x: np.ndarray, p1=0.8772, p2=0.2667) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_15(self, x: np.ndarray, p1=0.6964, p2=0.8455) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_16(self, x: np.ndarray, p1=0.7794, p2=0.0429) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_17(self, x: np.ndarray, p1=0.6840, p2=0.6875) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_18(self, x: np.ndarray, p1=0.1522, p2=0.9824) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_19(self, x: np.ndarray, p1=0.1663, p2=0.6315) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_20(self, x: np.ndarray, p1=0.0409, p2=0.8762) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_21(self, x: np.ndarray, p1=0.7244, p2=0.3434) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_22(self, x: np.ndarray, p1=0.4129, p2=0.5092) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_23(self, x: np.ndarray, p1=0.1635, p2=0.1339) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_24(self, x: np.ndarray, p1=0.0896, p2=0.5383) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_25(self, x: np.ndarray, p1=0.8619, p2=0.6925) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_26(self, x: np.ndarray, p1=0.6199, p2=0.5812) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_27(self, x: np.ndarray, p1=0.1705, p2=0.5767) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_28(self, x: np.ndarray, p1=0.2848, p2=0.6288) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_29(self, x: np.ndarray, p1=0.0955, p2=0.2444) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_30(self, x: np.ndarray, p1=0.6590, p2=0.8770) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_31(self, x: np.ndarray, p1=0.7637, p2=0.7209) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_32(self, x: np.ndarray, p1=0.7151, p2=0.0603) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_33(self, x: np.ndarray, p1=0.4904, p2=0.7761) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_34(self, x: np.ndarray, p1=0.1335, p2=0.6838) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
    ...
    def method_arc_cosine_7_35(self, x: np.ndarray, p1=0.9786, p2=0.6039) -> np.ndarray:
        y = x * p1 + np.random.randn(*x.shape) * p2
        z = np.fft.fft(y, axis=0)
