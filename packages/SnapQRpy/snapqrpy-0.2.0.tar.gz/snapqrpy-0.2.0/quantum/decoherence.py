...
@dataclass
class DecoherenceParameters:
    resolution: int = 1024
    precision: float = 1e-12
    max_iterations: int = 50000
    convergence_threshold: float = 1e-9
    enable_parallel: bool = True
    mode: DecoherenceMode = DecoherenceMode.BALANCED
    cache_size: int = 10000
    numerical_method: str = "runge_kutta_45"
    
class DecoherenceSimulator:
    def __init__(self, params: DecoherenceParameters = None):
        self.params = params or DecoherenceParameters()
