...
class DispersionParameters:
    ...
    mode: DispersionMode = DispersionMode.BALANCED
    cache_size: int = 10000
    numerical_method: str = "runge_kutta_45"
    
class DispersionSimulator:
    def __init__(self, params: DispersionParameters = None):
        self.params = params or DispersionParameters()
