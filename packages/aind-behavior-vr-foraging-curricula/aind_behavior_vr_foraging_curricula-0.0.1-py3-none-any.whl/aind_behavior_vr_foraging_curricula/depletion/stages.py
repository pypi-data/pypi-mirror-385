                ...
                environment_statistics=task_logic.EnvironmentStatistics(
                    patches=[
                        task_logic.Patch(
                            ...
                            state_index=0,
                            odor_specification=task_logic.OdorSpecification(index=0, concentration=1),
                            reward_specification=helpers.CountUntilDepleted(
                                available_water=40, amount_drop=5, max_p=0.9, stop_duration=0.0
                            ),
                            patch_virtual_sites_generator=helpers.make_virtualsites(),
                        )
                    ]
                        ...
                        environment_statistics=task_logic.EnvironmentStatistics(
                            ...
                            patches=[
                                helpers.make_graduated_patch(
                                    label="PatchB", state_index=0, odor_index=1, max_reward_probability=0.9
                                ),
                                helpers.make_graduated_patch(
                                    label="PatchC", state_index=1, odor_index=2, max_reward_probability=0.6
                                ),
                            ],
                        ),
                        end_conditions=[],
        ...
        task_parameters=AindVrForagingTaskParameters(
            ...
            environment=task_logic.BlockStructure(
                blocks=[
                    task_logic.Block(
                        environment_statistics=task_logic.EnvironmentStatistics(
                            first_state_occupancy=[0.1, 0.45, 0.45],
                            transition_matrix=[[0.1, 0.45, 0.45], [0.1, 0.45, 0.45], [0.1, 0.45, 0.45]],
                            patches=[
                                helpers.make_graduated_patch(
                                    label="odor_0", state_index=0, odor_index=0, max_reward_probability=0.0
                                ),
                                helpers.make_graduated_patch(
                                    label="odor_90", state_index=1, odor_index=1, max_reward_probability=0.9
                                ),
                                helpers.make_graduated_patch(
                                    label="odor_60", state_index=2, odor_index=2, max_reward_probability=0.6
                                ),
                            ],
                        ),
                        end_conditions=[],
