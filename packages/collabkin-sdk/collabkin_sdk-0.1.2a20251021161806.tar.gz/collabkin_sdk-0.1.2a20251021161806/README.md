# Collabkin Sdk-python

A Python SDK collabkin for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from collabkin_sdk import BoilerSDK, BoilerSDKConfig
from collabkin_sdk.types.common import UserRegisterInput
...
```python
from collabkin_sdk import BoilerSDKConfig
...
pytest --cov=collabkin_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/collabkin-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/collabkin-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../collabkin-frontend) - Frontend collabkin
- [Boiler Backend](../collabkin-python-be-graphql) - Python GraphQL backend collabkin