...
stream_tint =  {0.917, 1.000, 0.282, 1.000}-- #e9ff47ff
splash_tint =  {1.000, 0.992, 0.512, 1.000} -- #fffc82ff
...
biter_spawner_tint = {0.92, 0.54, 0, 0.5}
spitter_spawner_tint = {0.99, 0.09, 0.09, 1}

-- B I T E R S --

small_biter_scale = 0.5
small_biter_tint1 = {0.60, 0.58, 0.51, 1}
small_biter_tint2 = {0.62, 0.55, 0.2, 0.7}

medium_biter_scale = 0.7
medium_biter_tint1 = {0.49, 0.46, 0.51, 1}
medium_biter_tint2 = {0.6, 0.36, 0.36, 0.7}

big_biter_scale = 1.0
big_biter_tint1 = {0.37, 0.40, 0.72, 1}
big_biter_tint2 = {0.15, 0.55, 0.5, 0.7}

behemoth_biter_scale = 1.2
behemoth_biter_tint1 = {0.2, 0.25, 0.2, 1}
behemoth_biter_tint2 = {0.45, 0.82, 0.1, 0.7}

-- S P I T T E R S --

scale_spitter_small    = 0.5
tint_1_spitter_small    = {0.8, 0.45, 0, 1}
tint_2_spitter_small    = {0.55, 0.6, 0.4, 0.8}

scale_spitter_medium   = 0.7
tint_1_spitter_medium   = {0.7, 0.2, 0.3, 1}
tint_2_spitter_medium   = {0.6, 0.5, 0.5, 0.8}

scale_spitter_big      = 1.0
tint_1_spitter_big      = {0.1, 0.4, 0.6, 1}
tint_2_spitter_big      = {0.45, 0.45, 0.45, 0.8}

scale_spitter_behemoth = 1.2
tint_1_spitter_behemoth = {0.3, 0.2, 0.06, 1}
tint_2_spitter_behemoth = {0.45, 0.7, 0.12, 0.75}
...
tint_worm_small      = {0.7, 1, 0.3, 0.5}
tint_worm_medium     = {0.9, 0.15, 0.3, 1}
tint_worm_big        = {0.34, 0.68, 0.90, 0.8}
tint_worm_behemoth   = {0.3, 1, 0, 0.8}
