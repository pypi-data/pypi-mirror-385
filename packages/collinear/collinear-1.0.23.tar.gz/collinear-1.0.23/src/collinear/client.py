...
class Client:
    ...
    def redteam(
        ...
        *,
        ...
        The attack plan is loaded automatically on the server. No need to
        provide behaviors manually.

        Args:
            max_turns: Maximum conversation turns for each attack (default: 10)
        ...
        Note:
            ...
            Behaviors are loaded automatically from the server-side dataset.
