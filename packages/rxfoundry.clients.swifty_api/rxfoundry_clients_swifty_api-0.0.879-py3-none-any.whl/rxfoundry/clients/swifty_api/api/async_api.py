...
class AsyncApi:
    ...
    @validate_call
    def create_async_prescription_change_request_response(
        self,
        ...
        _param = self._create_async_prescription_change_request_response_serialize(
    ...
    @validate_call
    def create_async_prescription_change_request_response_with_http_info(
        self,
        prescription_change_request_response: PrescriptionChangeRequestResponse,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_async_prescription_change_request_response_without_preload_content(
        self,
        prescription_change_request_response: PrescriptionChangeRequestResponse,
        _request_timeout: Union[
            None,
    ...
    def _create_async_prescription_change_request_response_serialize(
        self,
    ...
    def get_async_prescription(
        ...
        _param = self._get_async_prescription_serialize(
    ...
    @validate_call
    def get_async_prescription_with_http_info(
        self,
        message_id: StrictStr,
        deep: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_async_prescription_without_preload_content(
        self,
        message_id: StrictStr,
        deep: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _get_async_prescription_serialize(
        self,
        message_id,
        deep,
        _request_auth,
    ...
    def get_async_prescriptions(
        ...
        _param = self._get_async_prescriptions_serialize(
    ...
    @validate_call
    def get_async_prescriptions_with_http_info(
        self,
        patient_uuid: Optional[StrictStr] = None,
        pharmacy_uuid: Optional[StrictStr] = None,
        prescriber_uuid: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_async_prescriptions_without_preload_content(
        self,
        patient_uuid: Optional[StrictStr] = None,
        pharmacy_uuid: Optional[StrictStr] = None,
        prescriber_uuid: Optional[StrictStr] = None,
    ...
    def _get_async_prescriptions_serialize(
        self,
        patient_uuid,
        pharmacy_uuid,
        prescriber_uuid,
    ...
    def get_patient_activity_0(
        ...
        _param = self._get_patient_activity_0_serialize(
            message_id=message_id,
            deep=deep,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_patient_activity_0_with_http_info(
        self,
        message_id: StrictStr,
        deep: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_patient_activity_0_without_preload_content(
        self,
        message_id: StrictStr,
        deep: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _get_patient_activity_0_serialize(
        self,
        message_id,
        deep,
        _request_auth,
