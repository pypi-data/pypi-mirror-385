...
class PrescriptionData(BaseModel):
    ...
    number_of_refills: Optional[StrictInt] = Field(default=None, description="The number of refills for the prescription.  This is the total fills - 1.")
    quantity_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total quantity prescribed for the prescription.  It should be equal to Days_Supply * (number_of_refills + 1)")
    days_supply: Optional[StrictInt] = Field(default=None, description="The number of days a fill will last when taken as prescribed.")
    ...
    sig_text: Optional[StrictStr] = Field(default=None, description="The instructions on how to take the prescription.")
    __properties: ClassVar[List[str]] = ["external_rx_number", "external_system_slug", "patient_ref", "prescriber_ref", "medication_ref", "number_of_refills", "quantity_value", "days_supply", "written_date", "substitutions_code", "sig_text"]
