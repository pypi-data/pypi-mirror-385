...
class OmhubNetworkAnchorClient(object):
    ...
    def get_network_anchor(self, network_anchor_id, subscription_service_name, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.161.1/multicloud/get_network_anchor.py.html>`__ to see an example of how to use get_network_anchor API.
        """
    ...
    def list_network_anchors(self, subscription_id, subscription_service_name, external_location, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.161.1/multicloud/list_network_anchors.py.html>`__ to see an example of how to use list_network_anchors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
