...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'c', 'bfmstar', 'gfu_old', '_lin_solver_cls', 'time', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'gfa_old', 'c', 'bfmstar', 'gfu_old', 'gfv_old', '_lin_solver_cls', 'time', '_lin_solver_args')
