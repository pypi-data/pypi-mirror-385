...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('plotrates', 'plt', 'pre', 'callback_sol', 'clear_output', 'ax', 'residuals', 'ress', 'mat', 'fig', 'callback', 'display', 'tol', 'atol', 'its', 'maxiter', 'printrates', 'iterations', '_final_residual', 'sol')
