...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', 'c', '_lin_solver_args', 'bfmstar', 'time', 'gfu_old')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', 'c', 'gfa_old', '_lin_solver_args', 'bfmstar', 'gfv_old', 'time', 'gfu_old')
