...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('restart', 'innerproduct', 'iterations', 'norm')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('callback_sol', 'ax', 'printrates', 'maxiter', 'tol', 'mat', 'sol', 'its', 'plotrates', 'callback', 'fig', '_final_residual', 'display', 'pre', 'ress', 'residuals', 'iterations', 'plt', 'clear_output', 'atol')
