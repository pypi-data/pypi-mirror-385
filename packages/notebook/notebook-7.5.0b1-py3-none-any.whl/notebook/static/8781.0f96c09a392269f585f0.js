...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59460);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(20949),
    __webpack_require__(94854),
    __webpack_require__(97567),
    __webpack_require__(68118),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(75215),
  __webpack_require__(80304),
  __webpack_require__(51639),
  __webpack_require__(86945),
  __webpack_require__(45966),
  __webpack_require__(23085),
  __webpack_require__(10621),
  
      (__webpack_require__(7287)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(1892)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(57370),
  __webpack_require__(145),
  
      (__webpack_require__(83458)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(65991)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(88005),
  
      (__webpack_require__(32857)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(77662)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(49363)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(617)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(79551)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(71772),
  __webpack_require__(68916),
  __webpack_require__(79400),
  __webpack_require__(34131),
  
      (__webpack_require__(78573)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(21428),
  __webpack_require__(33239),
  __webpack_require__(75705),
  
      (__webpack_require__(96810)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(80148),
  __webpack_require__(51395),
  __webpack_require__(72156),
  __webpack_require__(15522),
  __webpack_require__(95922),
  __webpack_require__(71954),
  __webpack_require__(17844),
  __webpack_require__(28926),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(11987),
  
      (__webpack_require__(69967)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(55268),
  ...
  __webpack_require__(92425),
      ...
      (__webpack_require__(36576)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(80831),
  __webpack_require__(73111),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(23429)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(27038)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(93115).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(60973).IServiceManager);
...
var setAttributesWithoutAttributes = __webpack_require__(88737);
...
var htmlviewer_extension_style = __webpack_require__(93617);
...
//# sourceMappingURL=8781.0f96c09a392269f585f0.js.map?v=0f96c09a392269f585f0