...
def parse_time_block_data(time_block_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if calculated_date_raw:
        if isinstance(calculated_date_raw, str):
            calculated_date = _parse_date(calculated_date_raw)
        elif hasattr(calculated_date_raw, 'date'):
            calculated_date = calculated_date_raw.date()
        elif hasattr(calculated_date_raw, 'isoformat'):
    ...
    is_deleted = calculated_data.get("Is_Deleted", False)
