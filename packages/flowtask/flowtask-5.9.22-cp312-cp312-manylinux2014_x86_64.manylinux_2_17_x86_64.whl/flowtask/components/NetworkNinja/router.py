            ...
            for item in data:
                ...
                if data_type == 'client':
                    ...
                    if item.previous_form_id:
                        try:
                            self._logger.debug(
                                f"Processing form update: form_id={item.form_id} updates previous_form_id={item.previous_form_id}"
                            )
                            # swapped:
                            ...
                            self._logger.debug(
                                f"Successfully updated form: form_id={item.form_id} replaced previous_form_id={item.previous_form_id}"
                            )
                        except Exception as e:
                            self._logger.error(
