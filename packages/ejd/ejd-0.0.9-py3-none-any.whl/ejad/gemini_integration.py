...
def _get_configured_model(api_key: Optional[str] = "AIzaSyD-M2KBiuXhNB-0XkpU_V2-Mxh2KKM42zY"):
    """
...
def analyze_and_fix_code(source_code: str, rule_set_content: str, 
                        source_path: str, api_key: Optional[str] = "AIzaSyD-M2KBiuXhNB-0XkpU_V2-Mxh2KKM42zY") -> Dict[str, str]:
    """
...
def test_connection(api_key: Optional[str] = "AIzaSyD-M2KBiuXhNB-0XkpU_V2-Mxh2KKM42zY") -> bool:
