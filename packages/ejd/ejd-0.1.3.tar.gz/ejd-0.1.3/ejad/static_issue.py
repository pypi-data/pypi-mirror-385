        ...
        if result["status"] == "success":
            ...
            if result.get('fixed_code') and result['fixed_code'] != source_code:
                ...
                if create_fixed_file == 'y':
                    ...
                    print("\n❌ Fixed file will not be created.")
                ...
                if apply_answer == 'y':
                    try:
                        ...
                        print(f"\n✅ Original file updated: {source_path}")
                        ...
                        print(f"\n❌ Error applying fixed file to original: {e}")
                else:
                    if create_fixed_file == 'y':
                        print(f"\n✅ Original file left unchanged: {source_path}")
                        print(f"You can review the fixed file at: {fixed_file_path}")
                    else:
                        print(f"\n✅ No changes made. Original file unchanged: {source_path}")
