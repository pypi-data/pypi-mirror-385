...
print("[OK] Running updated Gemini Integration v1.6")
...
def _get_configured_model(api_key: Optional[str] = None):
    ...
    api_key = api_key or "AIzaSyBrFwIc8818l-0-jH-8ymkzdrKhtgqyixY"
...
def analyze_and_fix_code(source_code: str, rule_set_content: str, 
    ...
    try:
        print(f"Sending code to Gemini Flash 2.5 for analysis: {source_path}")
