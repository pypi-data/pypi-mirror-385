...
export const validateKernel = (kernel) => {
...
export const validateS3Url = (s3Path) => {
...
export const validateMaxRetryAttempts = (maxRetryAttemptsString) => {
...
export const validateMaxRunTimeInSeconds = (maxRuntTimeInSecondsString) => {
...
export const validateSubnetOptions = (subnetOptions) => {
    if (subnetOptions) {
...
export const validateInitialSubnets = (initialSubnetValues) => {
...
export const validateSecurityGroups = (securityGroups, subnets) => {
...
export const validateSubnets = (subnets, securityGroups) => {
    if (subnets.length === 0) {
        if (securityGroups.length === 0) {
            return ['', ''];
        }
