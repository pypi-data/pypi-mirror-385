...
class CanvasWorkspace(WorkspaceManager):
    ...
    def _apply_canvas_defaults(self):
        ...
        self._default_scroll_policy = policies_map.get(default_scroll_policy, Qt.ScrollBarPolicy.ScrollBarAsNeeded)
    ...
    def new_tab(self):
        ...
        scroll_area.setWidgetResizable(True)  # Allows content to resize within the scroll area
        ...
        scroll_area.horizontalScrollBar().setValue(scroll_area.horizontalScrollBar().maximum() // 2)
    ...
    def _create_content_widget(self, tab_number=1):
        ...
        if self._layout_template and self._widget_factories:
            ...
            return self._build_layout_from_template(self._layout_template, self._widget_factories)
