...
class TabNumberView(BaseView):
    ...
    def __init__(self, tab_number=1):
        ...
        self.main_label.setObjectName("ingotTabNumberLabel")  # Add object name for styling
        ...
        instruction_label.setObjectName("ingotInstructionLabel")  # Add object name for styling
        ...
        lower_content.setObjectName("ingotLowerContentLabel")  # Add object name for styling
