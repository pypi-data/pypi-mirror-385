...
class ImageZoomWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        scope_pen = QPen(QColor(0, 255, 0, 200), 1 / self._zoom_level, Qt.PenStyle.DotLine)
    ...
    def get_color_at_position(self, pos):
        ...
        if (img_x <= pos.x() <= img_x + img_width and 
            img_y <= pos.y() <= img_y + img_height):
            ...
            return QColor(100 + (orig_x % 155), 100 + (orig_y % 155), 50 + ((orig_x + orig_y) % 105))
