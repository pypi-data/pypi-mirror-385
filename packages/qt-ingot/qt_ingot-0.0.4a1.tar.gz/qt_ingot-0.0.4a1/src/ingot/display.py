from PyQt6.QtWidgets import QFrame, QGridLayout, QWidget, QStatusBar, QHBoxLayout, QLabel
...
class StatusBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.zoom_label.setStyleSheet("font-size: 12px; color: white;")
        
        # Coordinates indicator
        self.coords_label = QLabel("Pos: (0, 0) | Center: (0, 0)")
        self.coords_label.setObjectName("ingotCoordsLabel")
        self.coords_label.setStyleSheet("font-size: 12px; color: white;")
        
        # Color visualization box
        self.color_visualization = QWidget()
        self.color_visualization.setFixedSize(20, 20)
        self.color_visualization.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid gray;")
        ...
        self.color_label.setStyleSheet("font-size: 12px; color: white;")
    ...
    def update_color(self, color_str: str):
        ...
        try:
            ...
            # Update the color visualization box
            self.color_visualization.setStyleSheet(f"background-color: rgba({r}, {g}, {b}, {a}); border: 1px solid gray;")
