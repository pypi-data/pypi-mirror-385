...
class Language(BaseModel):
    ...
    iso6392: Optional[StrictStr] = Field(default=None, description="The ISO 639-2 code of the language")
    sort_value: Optional[StrictInt] = Field(default=None, description="Property allowing to sort languages in lists", alias="sortValue")
    labels: Optional[List[Label]] = None
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "code", "iso6392", "sortValue", "labels", "_links"]
