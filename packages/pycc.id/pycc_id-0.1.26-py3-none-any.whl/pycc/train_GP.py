...
def train_GP(df, equations, params=None):
    ...
    subtree_mutation_prob = float(params.get('subtree_mutation_prob', 0.05)) # NEW: Powerful mutation
    parsimony_coefficient = float(params.get('parsimony_coefficient', 0.001)) # NEW: Penalty for complexity
    ...
    for gen in range(n_generations):
        ...
        for ind in population:
            ...
            # **FIX**: Add parsimony pressure to fitness
        ...
        while len(new_population) < population_size:
            ...
            # **FIX**: Apply improved mutation operators
            for fname in child_trees:
