...
def train_GP(df, equations, params=None):
    ...
    gene_mutation_prob = float(params.get('gene_mutation_prob', 0.1)) # NEW: Per-gene mutation
    ...
    for gen in range(n_generations):
        ...
        while len(new_population) < population_size:
            ...
            if random.random() < crossover_rate:
                ...
                # **FIX**: Perform crossover for ALL function trees
            ...
            # **FIX**: Apply mutation to each gene (tree) independently
            for fname in child_trees:
