...
class CustomV1Config:
    ...
    # Name weights (should give ~0.90 for exact name match alone)
    FULLNAME_WEIGHT = 0.70
    SURNAME_WEIGHT = 0.10
    FIRSTNAME_WEIGHT = 0.10
    
    # DOB weights (bonus when present: 0.10 total)
    DOB_YEAR_WEIGHT = 0.07
    DOB_MONTH_WEIGHT = 0.02
    DOB_DAY_WEIGHT = 0.01
    
    # Gender/Nationality bonus (0.10 total)
