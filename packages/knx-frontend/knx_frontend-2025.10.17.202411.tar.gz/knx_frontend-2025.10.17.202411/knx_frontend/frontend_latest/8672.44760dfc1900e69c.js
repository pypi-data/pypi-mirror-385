/*! For license information please see 8672.44760dfc1900e69c.js.LICENSE.txt */
export const __webpack_id__="8672";export const __webpack_ids__=["8672"];export const __webpack_modules__={86467:function(r,e,a){a.a(r,(async function(r,i){try{a.r(e),a.d(e,{HaBackgroundSelector:()=>m});var s=a(69868),t=a(84922),n=a(11991),o=a(73120),l=a(7119),d=(a(23749),a(56082)),c=r([l]);l=(c.then?(await c)():c)[0];class m extends t.WF{updated(r){super.updated(r),r.has("value")&&(this.yamlBackground=!!this.value&&!this.value.startsWith(d.fO))}render(){return t.qy`
      <div>
        ${this.yamlBackground?t.qy`
              <div class="value">
                <img
                  src=${this.value}
                  alt=${this.hass.localize("ui.components.picture-upload.current_image_alt")}
                />
              </div>
              <ha-alert alert-type="info">
                ${this.hass.localize("ui.components.selectors.background.yaml_info")}
    ...
    `}_pictureChanged(r){const e=r.target.value;(0,o.r)(this,"value-changed",{value:e??void 0})}_clearValue(){(0,o.r)(this,"value-changed",{value:void 0})}constructor(...r){super(...r),this.disabled=!1,this.required=!0,this.yamlBackground=!1}}m.styles=t.AH`
    :host {
      display: block;
      position: relative;
    }
...
//# sourceMappingURL=8672.44760dfc1900e69c.js.map