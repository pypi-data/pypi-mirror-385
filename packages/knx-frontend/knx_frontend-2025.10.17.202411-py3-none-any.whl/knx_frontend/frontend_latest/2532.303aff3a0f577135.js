export const __webpack_id__="2532";export const __webpack_ids__=["2532"];export const __webpack_modules__={85263:function(t,e,o){o.r(e),o.d(e,{HaSelectorAttribute:()=>u});var i=o(69868),a=o(84922),s=o(11991),r=o(73120),d=o(26846);o(26731);class l extends a.WF{shouldUpdate(t){return!(!t.has("_opened")&&this._opened)}updated(t){if(t.has("_opened")&&this._opened||t.has("entityId")||t.has("attribute")){const t=(this.entityId?(0,d.e)(this.entityId):[]).map((t=>{const e=this.hass.states[t];if(!e)return[];return Object.keys(e.attributes).filter((t=>!this.hideAttributes?.includes(t))).map((t=>({value:t,label:this.hass.formatEntityAttributeName(e,t)})))})),e=[],o=new Set;for(const i of t)for(const t of i)o.has(t.value)||(o.add(t.value),e.push(t));this._comboBox.filteredItems=e}}render(){return this.hass?a.qy`
      <ha-combo-box
        .hass=${this.hass}
        .value=${this.value}
...
//# sourceMappingURL=2532.303aff3a0f577135.js.map