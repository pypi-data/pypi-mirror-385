...
#from wuttjamaican.db.util import naming_convention
...
# TODO: should use naming convention, but first must "hard-code"
# existing constraint names, and/or should rename them?
