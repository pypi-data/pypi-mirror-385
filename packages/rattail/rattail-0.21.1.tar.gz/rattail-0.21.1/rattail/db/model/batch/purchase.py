...
class PurchaseBatchRow(BatchRowMixin, PurchaseItemBase, Base):
    ...
    STATUS_ON_PO_NOT_INVOICE            = 13
    STATUS_ON_INVOICE_NOT_PO            = 14
    STATUS_COST_INCREASE                = 15
    STATUS_DID_NOT_RECEIVE              = 16
    STATUS_NOT_SHIPPED                  = 17
    ...
    STATUS = {
        ...
        STATUS_ON_PO_NOT_INVOICE        : "on PO but not on invoice",
        STATUS_ON_INVOICE_NOT_PO        : "on invoice but not on PO",
        STATUS_COST_INCREASE            : "cost increase",
        STATUS_DID_NOT_RECEIVE          : "did not receive",
        STATUS_NOT_SHIPPED              : "vendor did not ship",
    }
