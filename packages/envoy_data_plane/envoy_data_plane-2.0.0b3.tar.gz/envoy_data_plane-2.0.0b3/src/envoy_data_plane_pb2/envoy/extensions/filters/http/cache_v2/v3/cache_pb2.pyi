...
class CacheV2Config(_message.Message):
    __slots__ = ("typed_config", "disabled", "allowed_vary_headers", "key_creator_params", "max_body_bytes", "ignore_request_cache_control_header", "override_upstream_cluster")
    ...
    OVERRIDE_UPSTREAM_CLUSTER_FIELD_NUMBER: _ClassVar[int]
    ...
    key_creator_params: CacheV2Config.KeyCreatorParams
    max_body_bytes: int
    ignore_request_cache_control_header: bool
    override_upstream_cluster: str
    def __init__(self, typed_config: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., disabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., allowed_vary_headers: _Optional[_Iterable[_Union[_string_pb2.StringMatcher, _Mapping]]] = ..., key_creator_params: _Optional[_Union[CacheV2Config.KeyCreatorParams, _Mapping]] = ..., max_body_bytes: _Optional[int] = ..., ignore_request_cache_control_header: bool = ..., override_upstream_cluster: _Optional[str] = ...) -> None: ...
