...
wizard_tabs = [
    sg.Tab(_t("wizard_gui.wizard_start"), wizard_layout_1, key="-TAB1-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.backup_source"), wizard_layout_2, key="-TAB2-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.backup_location"), wizard_layout_3, key="-TAB3-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.backup_options"), wizard_layout_4, key="-TAB4-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.retention"), wizard_layout_5, key="-TAB5-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.end_user_experience"), wizard_layout_6, key="-TAB6-", border_width=0, element_justification='c'),
    sg.Tab(_t("wizard_gui.summary"), wizard_layout_7, key="-TAB7-", border_width=0, element_justification='c'),
]
...
wizard_layout = [
    ...
    [sg.TabGroup(
        layout=[wizard_tabs],
        key='-TABGROUP-',
        selected_background_color=BG_COLOR_LDR,
        selected_title_color=TXT_COLOR_LDR,
        border_width=0,
        size=(800, 400)
    )],
    ...
    while True:
        ...
        if event == "-NEXT-":
            if current_tab < NUMBER_OF_TABS:
                ...
                wizard[f"-TAB{current_tab}-"].select()
