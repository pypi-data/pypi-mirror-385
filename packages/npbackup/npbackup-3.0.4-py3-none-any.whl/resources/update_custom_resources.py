...
def update_custom_icons():
    ...
    custom_resources = {
        ...
        # WIZARD
        "BACKEND_LOCAL": "wizard/hdd.png",
        "BACKEND_REST": "wizard/rest.png",
        "BACKEND_S3": "wizard/s3.png",
        "BACKEND_GOOGLE": "wizard/google.png",
        "BACKEND_AZURE": "wizard/azure.png",
        "BACKEND_SFTP": "wizard/sftp.png",
        "BACKEND_WASABI": "wizard/wasabi.png",
        "BACKEND_B2": "wizard/b2.png",

        "ADD_FOLDER": "wizard/add_folder.png",
        "ADD_FILE": "wizard/add_file.png",
        "ADD_PROPERTY": "wizard/add_property.png",
        "REMOVE_PROPERTY": "wizard/remove_property.png",
        "WINDOWS_SYSTEM": "wizard/windows_system.png",
        "KVM": "wizard/kvm.png",
        "HYPERV": "wizard/hyperv.png",
    }
