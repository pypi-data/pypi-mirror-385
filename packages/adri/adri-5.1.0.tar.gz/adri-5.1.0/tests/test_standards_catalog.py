...
in the catalog. When a new standard is added to adri/standards/{domains,frameworks,templates}/,
...
def discover_standard_names():
    ...
    This function discovers all standards in adri/standards/ and returns their
...
class TestStandardsResolution:
    ...
    When a new standard is added to adri/standards/{domains,frameworks,templates}/,
