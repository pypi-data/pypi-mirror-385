...
def shepard_plot(
    ...
    points, stress, dissimilarity_matrix, scaled_mds_result, mds_result = mds_function(samples, metric)
    return shepard_plot_from_mds(dissimilarity_matrix, scaled_mds_result, mds_result, title, font_path, font_size, fig_width, fig_height)