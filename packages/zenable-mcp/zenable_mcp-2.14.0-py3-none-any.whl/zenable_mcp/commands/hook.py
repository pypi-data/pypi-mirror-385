    ...
    async def check_files():
        try:
            async with ZenableMCPClient() as client:
                ...
                # Get the markdown text content from MCP server
                ...
                # Check if we have any findings (issues) in the markdown response
                has_findings = client.has_findings(result_text)
