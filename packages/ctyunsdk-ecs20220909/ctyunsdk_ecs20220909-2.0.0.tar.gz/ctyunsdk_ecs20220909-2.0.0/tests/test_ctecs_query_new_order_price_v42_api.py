...
from apis.ctecs_query_new_order_price_v42_api import CtecsQueryNewOrderPriceV42Request, \
    CtecsQueryNewOrderPriceV42DisksRequest


class TestCtecsQueryNewOrderPriceV42Api(unittest.TestCase):
    def setUp(self):
    ...
    def test_request_validation(self):
        ...
        with self.assertRaises(TypeError):
            # 缺少必填参数
            CtecsQueryNewOrderPriceV42Request()
