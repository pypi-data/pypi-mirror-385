...
from apis.ctecs_query_instance_statistics_v41_api import CtecsQueryInstanceStatisticsV41Api, CtecsQueryInstanceStatisticsV41Request, CtecsQueryInstanceStatisticsV41Response, CtecsQueryInstanceStatisticsV41ReturnObjResponse, CtecsQueryInstanceStatisticsV41ReturnObjInstanceStatisticsResponse


class TestCtecsQueryInstanceStatisticsV41Api(unittest.TestCase):
    def setUp(self):
    ...
    def test_ctecsQueryInstanceStatisticsV41Api(self):
        # Construct request
        ...
        try:
            api = CtecsQueryInstanceStatisticsV41Api()
    ...
    def test_api_instance(self):
        ...
        self.assertIsNotNone(self.apis.ctecsqueryinstancestatisticsv41api)
