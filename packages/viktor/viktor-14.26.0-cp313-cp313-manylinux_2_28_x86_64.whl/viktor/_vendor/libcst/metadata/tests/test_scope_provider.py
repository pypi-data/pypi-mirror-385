...
from viktor._vendor.libcst import ensure_type
from viktor._vendor.libcst._parser.entrypoints import is_native
from viktor._vendor.libcst.metadata import MetadataWrapper
...
class ScopeProviderTest(UnitTest):
    ...
    def test_parse_string_annotations(
        ...
        with mock.patch("viktor._vendor.libcst.parse_module") as parse_mock:
