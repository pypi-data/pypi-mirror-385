...
from viktor._vendor.libcst._parser.types.config import BaseWhitespaceParserConfig
from viktor._vendor.libcst._parser.types.whitespace_state import WhitespaceState as State
