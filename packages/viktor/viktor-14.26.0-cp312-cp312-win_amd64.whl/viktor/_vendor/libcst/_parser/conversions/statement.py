...
from viktor._vendor.libcst._nodes.statement import (
    AnnAssign,
    AsName,
    Assert,
    Assign,
...
from viktor._vendor.libcst._nodes.whitespace import EmptyLine, SimpleWhitespace
...
from viktor._vendor.libcst._parser.whitespace_parser import (
    parse_empty_lines,
