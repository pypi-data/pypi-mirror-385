...
from viktor._vendor.libcst._nodes.internal import CodegenState
from viktor._vendor.libcst._removal_sentinel import RemovalSentinel
from viktor._vendor.libcst._type_enforce import is_value_of_type
from viktor._vendor.libcst._types import CSTNodeT
from viktor._vendor.libcst._visitors import CSTTransformer, CSTVisitor, CSTVisitorT
...
class CSTNode(ABC):
    ...
    def deep_equals(self, other: "CSTNode") -> bool:
        ...
        """
        from viktor._vendor.libcst._nodes.deep_equals import deep_equals as deep_equals_impl
