...
from viktor._vendor.libcst._batched_visitor import BatchableCSTVisitor
from viktor._vendor.libcst._metadata_dependent import (
    _T as _MetadataT,
    _UNDEFINED_DEFAULT,
    LazyValue,
    MetadataDependent,
)
from viktor._vendor.libcst._visitors import CSTVisitor

if TYPE_CHECKING:
    from viktor._vendor.libcst._nodes.base import CSTNode
    from viktor._vendor.libcst._nodes.module import _ModuleSelfT as _ModuleT, Module
