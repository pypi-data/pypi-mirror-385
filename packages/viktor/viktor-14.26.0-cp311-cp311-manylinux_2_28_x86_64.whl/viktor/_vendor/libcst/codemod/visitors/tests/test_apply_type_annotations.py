...
from viktor._vendor.libcst.codemod import Codemod, CodemodContext, CodemodTest
from viktor._vendor.libcst.codemod.visitors._apply_type_annotations import (
    AnnotationCounts,
