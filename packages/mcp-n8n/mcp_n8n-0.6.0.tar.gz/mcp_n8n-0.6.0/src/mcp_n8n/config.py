...
class GatewayConfig(BaseSettings):  # type: ignore[misc]
    ...
    anthropic_api_key: str | None = Field(
        ...
        validation_alias=AliasChoices("MCP_N8N_ANTHROPIC_API_KEY", "ANTHROPIC_API_KEY"),
    )
    coda_api_key: str | None = Field(
        default=None,
        description="Coda API key for Coda MCP",
        validation_alias=AliasChoices("MCP_N8N_CODA_API_KEY", "CODA_API_KEY"),
    )
    coda_folder_id: str | None = Field(
        default=None,
        description="Default Coda folder ID for write operations",
        validation_alias=AliasChoices("MCP_N8N_CODA_FOLDER_ID", "CODA_FOLDER_ID"),
    )
    ...
    n8n_event_webhook_url: str | None = Field(
        ...
        validation_alias=AliasChoices(
            "MCP_N8N_N8N_EVENT_WEBHOOK_URL", "N8N_EVENT_WEBHOOK_URL"
        ),
    )
