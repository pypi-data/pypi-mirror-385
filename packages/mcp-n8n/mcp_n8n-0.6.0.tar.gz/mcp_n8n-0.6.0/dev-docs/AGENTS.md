...
**See also:** [dev-docs/RELEASE.md](RELEASE.md) for detailed process.
...
│   ├── ARCHITECTURE.md          # P5 pattern with diagrams
│   ├── DEVELOPMENT.md           # Developer deep dive (justfile ref)
│   ├── TESTING.md               # Testing guide (BDD/TDD workflows)
│   └── RELEASE.md               # Release process & rollback
├── docs/                     # Documentation
...
**Root Documentation:**
- **[README.md](../README.md)** - Human-readable overview, quick start, high-level features
- **[CONTRIBUTING.md](../CONTRIBUTING.md)** - Human contributor guide (code style, PR process)
- **[TROUBLESHOOTING.md](../TROUBLESHOOTING.md)** - Problem-solution guide (common issues)

**Developer Documentation (dev-docs/):**
- **[AGENTS.md](AGENTS.md)** - Machine-readable instructions for AI agents (this file)
- **[ARCHITECTURE.md](ARCHITECTURE.md)** - P5 pattern with component diagrams
- **[DEVELOPMENT.md](DEVELOPMENT.md)** - Developer deep dive (justfile reference, debugging)
- **[TESTING.md](TESTING.md)** - Testing strategy (BDD/TDD workflows, test pyramid)
- **[RELEASE.md](RELEASE.md)** - Release process & rollback procedures
...
See [DEVELOPMENT_LIFECYCLE.md](DEVELOPMENT_LIFECYCLE.md) for details.
...
- **Development Lifecycle:** [DEVELOPMENT_LIFECYCLE.md](DEVELOPMENT_LIFECYCLE.md)
