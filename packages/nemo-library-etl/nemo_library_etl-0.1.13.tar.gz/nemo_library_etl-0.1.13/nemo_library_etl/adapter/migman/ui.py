            ...
            def render_extract():
                ...
                with content_container:
                    ...
                    with ui.card().classes("mt-4"):
                        ...
                        ui.label("Select which data source adapter to use for extraction.").classes(
                            "text-sm mb-4"
                        )
                    ...
                    with ui.card().classes("mt-4") as adapters_card:
                        ...
                        if not extract_active:
                            ...
                            ui.label("Extract must be active to configure the data source adapter.").classes(
