...
class Parser:
    ...
    def network_commands(self):
        ...
        if cmd.value in ["RUN_AS_ADMIN","SHOW_INTERFACE_ADDRESSES","SHOW_INTERFACE_STATUS","SHOW_NETWORK_IO","SHOW_NETWORK_IO_PER_INTERFACE","SHOW_ACTIVE_CONNECTIONS","SHOW_GATEWAY",'ENABLE_FIREWALL','DISABLE_FIREWALL','LIST_FIREWALL_RULES']:
            self.move()
