...
class OrientedBoundingBox:
    ...
    @property
    def axis_0(self) -> Vec3f:
        DLL.ZkOrientedBoundingBox_getAxis.restype = Vec3f
        return DLL.ZkOrientedBoundingBox_getAxis(self._handle, 0)

    @property
    def axis_1(self) -> Vec3f:
        DLL.ZkOrientedBoundingBox_getAxis.restype = Vec3f
        return DLL.ZkOrientedBoundingBox_getAxis(self._handle, 1)

    @property
    def axis_2(self) -> Vec3f:
        DLL.ZkOrientedBoundingBox_getAxis.restype = Vec3f
        return DLL.ZkOrientedBoundingBox_getAxis(self._handle, 2)
