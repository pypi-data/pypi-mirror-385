...
class MavenHandler:
    ...
    def _select_name_from_manifest_or_file(self, manifest: JavaManifest | None) -> str:
    ...
    def _extract_name_from_apache_maven_bundle_plugin(self, manifest: JavaManifest | None) -> str:
    ...
    def _select_version_from_manifest_or_file(self, manifest: JavaManifest | None) -> str:
