...
class LatencyMetric:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.histogram_per_code and not isinstance(self.histogram_per_code, Unset) and not isinstance(self.histogram_per_code, dict):
        ...
        if self.stats_per_code and not isinstance(self.stats_per_code, Unset) and not isinstance(self.stats_per_code, dict):
