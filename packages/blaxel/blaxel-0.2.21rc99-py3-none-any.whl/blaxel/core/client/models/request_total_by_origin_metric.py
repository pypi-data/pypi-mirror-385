...
class RequestTotalByOriginMetric:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.request_total_by_origin_and_code and not isinstance(self.request_total_by_origin_and_code, Unset) and not isinstance(self.request_total_by_origin_and_code, dict):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_request_total_by_origin_and_code,  Unset):
            ...
            request_total_by_origin_and_code = RequestTotalByOriginMetricRequestTotalByOriginAndCode.from_dict(_request_total_by_origin_and_code)
