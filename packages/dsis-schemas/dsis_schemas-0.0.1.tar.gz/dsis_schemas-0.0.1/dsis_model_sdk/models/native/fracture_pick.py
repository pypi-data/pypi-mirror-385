...
Generated on: 2025-10-09T21:15:04.703113
"""
...
class FracturePick(BaseModel):
    ...
    pick_depth: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    dip_dir_offset: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=1e-09)
