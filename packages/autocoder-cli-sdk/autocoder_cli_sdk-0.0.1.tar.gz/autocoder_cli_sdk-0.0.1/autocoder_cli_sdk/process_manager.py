...
# 全局进程管理器实例
_sync_process_manager = ProcessManager()
_async_process_manager = AsyncProcessManager()


def get_sync_process_manager() -> ProcessManager:
    """获取同步进程管理器实例"""
    return _sync_process_manager


def get_async_process_manager() -> AsyncProcessManager:
    """获取异步进程管理器实例"""
    return _async_process_manager
