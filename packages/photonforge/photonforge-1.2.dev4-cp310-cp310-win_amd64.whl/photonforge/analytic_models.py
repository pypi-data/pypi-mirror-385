...
class TerminationModel(Model):
    ...
    def black_box_component(
        self,
        port_spec: Optional[Union[str, PortSpec]] = None,
...
class TwoPortModel(Model):
    ...
    def __init__(
        ...
        r0: _ComplexCoeff = 0,
        r1: _ComplexCoeff = 0,
        ports: Optional[pft.annotate(Sequence[str], minItems=2, maxItems=2)] = None,
        *,
        propagation_length: pft.annotate(float, units="μm") = 0.0,
        n_eff: _ComplexCoeff = 0.0,
        n_group: Optional[_FloatCoeff] = None,
        reference_frequency: Optional[pft.Frequency] = None,
    ) -> None:
        super().__init__(
...
class PowerSplitterModel(Model):
    ...
    def __init__(
        ...
        r0: _ComplexCoeff = 0,
        r1: _ComplexCoeff = 0,
        ports: Optional[pft.annotate(Sequence[str], minItems=3, maxItems=3)] = None,
    ) -> None:
        super().__init__(
            t=_ensure_correct_shape(t),
...
class PolarizationSplitterRotatorModel(Model):
    ...
    def black_box_component(
        self,
        port_spec: Optional[Union[str, PortSpec]] = None,
        output_port_spec: Optional[Union[str, PortSpec]] = None,
        technology: Optional[Technology] = None,
        name: Optional[str] = None,
    ) -> Component:
        """Create a black-box component using this model for testing.
...
class DirectionalCouplerModel(Model):
    ...
    def __init__(
        self,
        t: Optional[_ComplexCoeff] = None,
        c: _ComplexCoeff = -1j * 2**-0.5,
        i: _ComplexCoeff = 0,
        r: _ComplexCoeff = 0,
        ports: Optional[pft.annotate(Sequence[str], minItems=4, maxItems=4)] = None,
        *,
        propagation_length: pft.annotate(float, units="μm") = 0.0,
        n_eff: _ComplexCoeff = 0.0,
        n_group: Optional[_FloatCoeff] = None,
...
class WaveguideModel(Model):
    ...
    def __init__(
        self,
        n_complex: Optional[Union[_ComplexCoeff, PortSpec, Literal["cross-section"]]] = None,
        length: Optional[pft.Coordinate] = None,
...
class AnalyticWaveguideModel(Model):
    ...
    .. math::
       ...
       S_{12} &= S_{21} = 10^{-\frac{L}{20}} e^{j (\beta l + \phi_{eo})}
    ...
    Args:
        ...
        length: Length :math:`l` of the waveguide. If not provided, the
          length is measured by :func:`route_length` or ports distance.
    ...
    def __init__(
        self,
        *,
        n_eff: Union[complex, Sequence[complex]],
        length: Optional[pft.Coordinate] = None,
        propagation_loss: Union[pft.PropagationLoss, Sequence[pft.PropagationLoss]] = 0.0,
        extra_loss: Union[pft.Loss, Sequence[pft.Loss]] = 0.0,
        n_group: Union[float, Sequence[float], None] = None,
        dispersion: Union[pft.Dispersion, Sequence[pft.Dispersion]] = 0.0,
        dispersion_slope: Union[pft.DispersionSlope, Sequence[pft.DispersionSlope]] = 0.0,
        reference_frequency: Optional[pft.Frequency] = None,
        dn_dT: pft.annotate(Union[complex, Sequence[complex]], label="dn/dT", units="1/K") = 0.0,
        dL_dT: pft.annotate(Union[float, Sequence[float]], label="dL/dT", units="dB/μm/K") = 0.0,
        temperature: pft.Temperature = 293.0,
        reference_temperature: pft.Temperature = 293.0,
        voltage: pft.Voltage = 0.0,
        v_piL: Optional[pft.annotate(float, label="VπL", units="V·μm")] = None,
    ):
        super().__init__(
            length=length,
            n_eff=_ensure_correct_shape(n_eff),
    ...
    def start(
        ...
        temperature: Optional[pft.Temperature] = None,
        voltage: Optional[pft.Voltage] = None,
        **kwargs,
    ) -> ModelResult:
        """Start computing the S matrix response from a component.
...
class AnalyticDirectionalCouplerModel(Model):
    ...
    def __init__(
        ...
        *,
        ...
        propagation_length: Optional[pft.annotate(_FloatCoeff, units="μm")] = None,
...
class AnalyticMZIModel(Model):
    ...
    def __init__(
        self,
        *,
        n_eff1: Union[complex, Sequence[complex]],
        n_eff2: Optional[Union[complex, Sequence[complex]]] = None,
        length1: pft.Coordinate,
        length2: Optional[pft.Coordinate] = None,
        tau1: Optional[_ComplexCoeff] = None,
        tau2: Optional[_ComplexCoeff] = None,
        kappa1: _ComplexCoeff = -1j * 2**-0.5,
        kappa2: _ComplexCoeff = -1j * 2**-0.5,
        propagation_loss1: Union[pft.PropagationLoss, Sequence[pft.PropagationLoss]] = 0.0,
        propagation_loss2: Union[pft.PropagationLoss, Sequence[pft.PropagationLoss]] = 0.0,
        extra_loss1: Union[pft.Loss, Sequence[pft.Loss]] = 0.0,
        extra_loss2: Union[pft.Loss, Sequence[pft.Loss]] = 0.0,
        n_group1: Union[float, Sequence[float], None] = None,
        n_group2: Union[float, Sequence[float], None] = None,
        dispersion1: Union[pft.Dispersion, Sequence[pft.Dispersion]] = 0.0,
        dispersion2: Union[pft.Dispersion, Sequence[pft.Dispersion]] = 0.0,
        dispersion_slope1: Union[pft.DispersionSlope, Sequence[pft.DispersionSlope]] = 0.0,
        dispersion_slope2: Union[pft.DispersionSlope, Sequence[pft.DispersionSlope]] = 0.0,
        reference_frequency: Optional[pft.Frequency] = None,
        dn1_dT: pft.annotate(Union[complex, Sequence[complex]], label="dn1/dT", units="1/K") = 0.0,
        dn2_dT: pft.annotate(Union[complex, Sequence[complex]], label="dn2/dT", units="1/K") = 0.0,
        dL1_dT: pft.annotate(Union[float, Sequence[float]], label="dL1/dT", units="dB/μm/K") = 0.0,
        dL2_dT: pft.annotate(Union[float, Sequence[float]], label="dL2/dT", units="dB/μm/K") = 0.0,
        temperature1: pft.Temperature = 293.0,
        temperature2: pft.Temperature = 293.0,
        reference_temperature: pft.Temperature = 293.0,
        voltage1: pft.Voltage = 0.0,
        voltage2: pft.Voltage = 0.0,
        v_piL1: Optional[pft.annotate(float, label="VπL1", units="V·μm")] = None,
        v_piL2: Optional[pft.annotate(float, label="VπL2", units="V·μm")] = None,
    ...
    def start(
        ...
        component: Component,
        frequencies: Sequence[pft.Frequency],
        temperature1: Optional[pft.Temperature] = None,
        voltage1: Optional[pft.Voltage] = None,
        temperature2: Optional[pft.Temperature] = None,
        voltage2: Optional[pft.Voltage] = None,
        **kwargs,
    ) -> ModelResult:
        """Start computing the S matrix response from a component.
