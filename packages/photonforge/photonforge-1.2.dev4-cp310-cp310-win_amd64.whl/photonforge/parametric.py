...
_OptOffsets = _pft.annotate(
    _typ.Union[_pft.Coordinate, _pft.annotate(_Sequence[_pft.Coordinate], minItems=2, maxItems=2)],
    optional=True,
)
...
_OptFractions = _pft.annotate(
    _typ.Union[_pft.Fraction, _pft.annotate(_typ.Sequence[_pft.Fraction], minItems=2, maxItems=2)],
    optional=True,
)

_OptIntTurns = _pft.annotate(int, minimum=2, optional=True)

_OptJoin = _pft.annotate(_typ.Union[_typ.Literal["round"], float], optional=True)
...
_OptVariableOffset = _pft.annotate(
    _typ.Union[float, _pft.expression(1, 1)], units="μm", optional=True
)

_PortSpec_x2 = _pft.annotate(_Sequence[_pft.PortSpecOrName], minItems=2, maxItems=2)
_PortSpecPair = _typ.Union[_pft.PortSpecOrName, _PortSpec_x2]

_Port = _typ.Union[_ext.Port, _pft.PortReference]
_Terminal = _typ.Union[_ext.Terminal, _pft.TerminalReference]
...
def straight(
    *,
    port_spec: _typ.Optional[_pft.PortSpecOrName] = None,
    length: _typ.Optional[_pft.PositiveDimension] = None,
    bulge_width: _typ.Optional[_OptCoord] = None,
    bulge_taper_length: _typ.Optional[_OptDimension] = None,
    bulge_margin: _typ.Optional[_OptDimension] = None,
    active_model: _typ.Optional[_OptModel] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
    waveguide_model_kwargs: _typ.Optional[_opt_kwargs_for(_WaveguideModel)] = None,
) -> _pf.Component:
...
def transition(
    *,
    port_spec1: _typ.Optional[_pft.annotate(_pft.PortSpecOrName, label="Port Spec 1")] = None,
    port_spec2: _typ.Optional[_pft.annotate(_pft.PortSpecOrName, label="Port Spec 2")] = None,
    length: _typ.Optional[_pft.PositiveDimension] = None,
    constant_length: _typ.Optional[_OptDimension] = None,
    profile: _typ.Optional[_OptVariableFraction] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
) -> _pf.Component:
...
def bend(
    *,
    port_spec: _typ.Optional[_pft.PortSpecOrName] = None,
    radius: _typ.Optional[_pft.PositiveDimension] = None,
    angle: _typ.Optional[_OptAngle] = None,
    euler_fraction: _typ.Optional[_OptFraction] = None,
    port_bends: _typ.Optional[_OptBool] = None,
    active_model: _typ.Optional[_OptModel] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
...
def s_bend(
    *,
    port_spec: _typ.Optional[_pft.PortSpecOrName] = None,
    length: _typ.Optional[_OptPositiveDimension] = None,
    offset: _typ.Optional[_pft.Coordinate] = None,
    euler_fraction: _typ.Optional[_OptFraction] = None,
    active_model: _typ.Optional[_OptModel] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
...
def crossing(
    *,
    port_spec: _typ.Optional[_PortSpecPair] = None,
    arm_length: _typ.Optional[_pft.PositiveDimension] = None,
    added_width: _typ.Optional[_OptVariableOffset] = None,
    extra_length: _typ.Optional[_OptDimension] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
) -> _pf.Component:
...
def ring_coupler(
    *,
    port_spec: _typ.Optional[_PortSpecPair] = None,
    coupling_distance: _typ.Optional[_pft.Coordinate] = None,
    radius: _typ.Optional[_pft.PositiveDimension] = None,
    bus_length: _typ.Optional[_OptDimension] = None,
    euler_fraction: _typ.Optional[_OptFraction] = None,
    coupling_length: _typ.Optional[_OptDimension] = None,
    port_bends: _typ.Optional[_OptBool] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
...
def s_bend_ring_coupler(
    *,
    ...
    coupling_distance: _typ.Optional[_pft.Coordinate] = None,
    radius: _typ.Optional[_pft.PositiveDimension] = None,
    s_bend_length: _typ.Optional[_OptPositiveDimension] = None,
    s_bend_offset: _typ.Optional[_pft.Coordinate] = None,
    euler_fraction: _typ.Optional[_OptFraction] = None,
    coupling_length: _typ.Optional[_OptDimension] = None,
    port_bends: _typ.Optional[_OptBool] = None,
    technology: _typ.Optional[_OptTechnology] = None,
...
def rectangular_spiral(
    *,
    ...
    size: _typ.Optional[_OptDimension2D] = None,
    full_length: _OptPositiveDimension = None,
    align_ports: _typ.Optional[_OptAxis] = None,
    active_model: _typ.Optional[_OptModel] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
    straight_kwargs: _typ.Optional[_opt_kwargs_for(straight)] = None,
    bend_kwargs: _typ.Optional[_opt_kwargs_for(bend)] = None,
    tidy3d_model_kwargs: _typ.Optional[_opt_kwargs_for(_Tidy3DModel)] = None,
    circuit_model_kwargs: _typ.Optional[_opt_kwargs_for(_CircuitModel)] = None,
) -> _pf.Component:
    """Rectangular spiral.
...
def route(
    *,
    ...
    straight_kwargs: _typ.Optional[_opt_kwargs_for(straight)] = None,
    bend_kwargs: _typ.Optional[_opt_kwargs_for(bend)] = None,
    s_bend_kwargs: _typ.Optional[_opt_kwargs_for(s_bend)] = None,
    circuit_model_kwargs: _typ.Optional[_opt_kwargs_for(_CircuitModel)] = None,
) -> _pf.Component:
...
def route_manhattan(
    *,
    terminal1: _typ.Optional[_Terminal] = None,
    terminal2: _typ.Optional[_Terminal] = None,
    direction1: _typ.Optional[_OptAxis] = None,
    direction2: _typ.Optional[_OptAxis] = None,
    layer: _typ.Optional[_OptLayer] = None,
    width: _typ.Optional[_OptPositiveDimension] = None,
    overlap_fraction: _typ.Optional[_OptFractions] = None,
    join_limit: _typ.Optional[_OptJoin] = None,
    waypoints: _typ.Optional[_OptCoords] = None,
    technology: _typ.Optional[_OptTechnology] = None,
    name: _typ.Optional[_OptStr] = None,
):
