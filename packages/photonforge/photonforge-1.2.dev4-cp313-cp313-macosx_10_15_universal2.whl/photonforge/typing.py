...
class _Metadata:
    ...
    def __init__(
        self,
        brand: _typ.Optional[str] = None,
        description: _typ.Optional[str] = None,
        exclusiveMaximum: _typ.Optional[_typ.Union[float, int]] = None,
        exclusiveMinimum: _typ.Optional[_typ.Union[float, int]] = None,
        kwargs_for: _typ.Optional[str] = None,
        label: _typ.Optional[str] = None,
        maxItems: _typ.Optional[int] = None,
        maxLength: _typ.Optional[int] = None,
        maximum: _typ.Optional[_typ.Union[float, int]] = None,
        minItems: _typ.Optional[int] = None,
        minLength: _typ.Optional[int] = None,
...
def expression(num_variables, min_expressions):
    ...
    """
    return annotate(
        _typ.Union[str, _ext.Expression],
        brand="Expression",
...
Frequency = annotate(float, exclusiveMinimum=0, units="Hz")  #:
...
Layer = annotate(_typ.Union[str, tuple[int, int]], brand="PhotonForgeLayer")  #:

PortSpecOrName = annotate(_typ.Union[str, _ext.PortSpec], brand="PhotonForgePortSpecOrName")  #:

PortReference = annotate(
    _typ.Union[tuple[_ext.Reference, str], tuple[_ext.Reference, str, int]],
