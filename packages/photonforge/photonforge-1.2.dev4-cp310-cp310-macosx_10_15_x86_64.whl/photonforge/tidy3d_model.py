...
_PerElementMap = pft.annotate(
    Sequence[Sequence[str, str], Sequence[str, str], Union[complex, pft.array(complex, 2)]],
...
_ImplicitMap = pft.annotate(Sequence[Union[str, int]], brand="PhotonForgePortSymmetryImplicit")

_PortSymmetryType = Union[Sequence[_ExplictMap], Sequence[_ImplicitMap], Sequence[_PerElementMap]]

_SymmetryType = pft.annotate(Sequence[int], brand="Tidy3dSymmetry")
_SubpixelType = Union[tidy3d.SubpixelSpec, bool]
_BoundsType = pft.annotate(Sequence[Sequence[Optional[float]]], brand="PhotonForgeOptionalBounds")
...
class Tidy3DModel(Model):
    ...
    def __init__(
        ...
        shutoff: Optional[pft.PositiveFloat] = None,
        subpixel: Optional[_SubpixelType] = None,
        courant: Optional[pft.Fraction] = None,
        port_symmetries: _PortSymmetryType = (),
        bounds: _BoundsType = ((None, None, None), (None, None, None)),
        source_gap: Optional[pft.NonNegativeFloat] = None,
