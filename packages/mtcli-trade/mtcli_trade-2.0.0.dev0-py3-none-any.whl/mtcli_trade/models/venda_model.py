"""
Camada Model responsável pela lógica de ordens de venda no MetaTrader 5.
"""
...
def preparar_ordem_venda(
    ...
    """
    Prepara uma ordem de venda (market ou limit) para envio.
    ...
    log.debug(f"Ordem de venda preparada: {ordem}")
    return ordem, limit


def enviar_ordem_venda(ordem: dict, limit: bool):
    """
    Envia uma ordem de venda válida para o MetaTrader 5.
    ...
    try:
        ...
        log.debug(f"Resultado do envio da ordem de venda: {resultado}")
        return resultado
    except Exception as e:
        log.exception(f"Erro ao enviar ordem de venda: {e}")
