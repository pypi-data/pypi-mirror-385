...
from tango._tango import StdStringVector, AttributeInfo, EventSubMode
...
from tango.utils import obj_2_property, property_2_obj
...
def __DeviceProxy__get_property(self, propname, value=None) -> dict[str, list[str]]:
    """
    ...
    return property_2_obj(self, propname, value)
