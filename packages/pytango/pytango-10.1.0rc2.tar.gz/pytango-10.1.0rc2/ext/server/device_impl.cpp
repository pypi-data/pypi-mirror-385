    ...
    py::class_<Tango::DeviceImpl,
        ...
        .def(
            ...
            [](Tango::DeviceImpl &self, const std::string &att_name) {
                static_cast<DeviceImplTrampoline &>(self).is_attribute_polled_public(att_name);
            },
            py::call_guard<py::gil_scoped_release>(),
            R"doc(
        ...
        .def(
            ...
            [](Tango::DeviceImpl &self, const std::string &cmd_name) {
                static_cast<DeviceImplTrampoline &>(self).is_command_polled_public(cmd_name);
            },
            py::call_guard<py::gil_scoped_release>(),
            R"doc(
        ...
        .def(
            ...
            [](Tango::DeviceImpl &self, const std::string &att_name) {
                static_cast<DeviceImplTrampoline &>(self).get_attribute_poll_period_public(att_name);
            },
            R"doc(
        ...
        .def(
            ...
            [](Tango::DeviceImpl &self, const std::string &cmd_name) {
                static_cast<DeviceImplTrampoline &>(self).get_command_poll_period_public(cmd_name);
            },
            R"doc(
