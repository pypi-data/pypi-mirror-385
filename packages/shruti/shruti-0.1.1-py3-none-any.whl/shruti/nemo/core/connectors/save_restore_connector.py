...
from shruti.nemo.core import classes as nemo_classes  # to avoid circular import do not import ModelPT directly
...
from shruti.nemo.utils.model_utils import inject_model_parallel_rank
