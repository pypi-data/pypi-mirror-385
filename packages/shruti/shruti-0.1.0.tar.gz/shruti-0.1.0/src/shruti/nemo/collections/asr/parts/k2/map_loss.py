...
from shruti.nemo.collections.asr.parts.k2.loss_mixins import CtcK2Mixin
from shruti.nemo.collections.asr.parts.k2.ml_loss import MLLoss
...
class CtcMmiLoss(MAPLoss, CtcK2Mixin):
    ...
    def update_graph(self, graph: 'k2.Fsa'):
        ...
        from shruti.nemo.collections.asr.parts.k2.graph_compilers import MmiGraphCompiler as compiler
