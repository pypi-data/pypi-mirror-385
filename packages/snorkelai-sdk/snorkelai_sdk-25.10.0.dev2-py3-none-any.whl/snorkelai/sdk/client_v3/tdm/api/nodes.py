...
@overload
def get_setting_nodes__node_uid__settings__setting__get(
    node_uid: int, setting: str, raw: Literal[True]
) -> requests.Response: ...


@overload
def get_setting_nodes__node_uid__settings__setting__get(
    node_uid: int, setting: str, raw: Literal[False] = False
) -> Any: ...


def get_setting_nodes__node_uid__settings__setting__get(
    node_uid: int, setting: str, raw: bool = False
) -> Any | requests.Response:
    # Get the context
    ctx = SnorkelSDKContext.get_global()

    _kwargs: Dict[str, Any] = {
        "endpoint": f"/nodes/{node_uid}/settings/{setting}",
    }
...
def put_setting_nodes__node_uid__settings__setting__put(
    node_uid: int,
    setting: str,
    *,
    body: SettingValue,
