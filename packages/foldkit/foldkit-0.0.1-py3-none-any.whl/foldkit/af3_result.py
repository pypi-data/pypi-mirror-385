...
class AF3Result:
    ...
    def _build_from_af3_output(
        ...
        self.plddt: Optional[np.ndarray] = None
        self.pae: Optional[np.ndarray] = None
        self.contact_probs: Optional[np.ndarray] = None

        self.global_ptm: Optional[float] = None
        self.global_iptm: Optional[float] = None
        self.chain_pair_iptm: Optional[np.ndarray] = None
        self.chain_ptm: Optional[np.ndarray] = None
