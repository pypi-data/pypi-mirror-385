...
class RecursiveHelpGroup(click.Group):
    ...
    def format_help(self, ctx, formatter):
        console = Console()
        console.print("\n[bold blue]🌊 testpulcli: A CLI for managing Bittensor subnet pool operations.")
        print("Usage: testpulcli [global options/commands] [sub commands] [options]\n")
        root_tree = Tree("🌊 [bold cyan]testpulcli[/bold cyan]")
        seen = set()
