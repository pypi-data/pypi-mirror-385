...
class TransferSuccessfulToolUserEditable(UncheckedBaseModel):
    messages: typing.Optional[typing.List[TransferSuccessfulToolUserEditableMessagesItem]] = pydantic.Field(
        default=None
    )
    """
...
update_forward_refs(TransferSuccessfulToolUserEditable)
