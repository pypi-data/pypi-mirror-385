...
class ServerMessageResponseHandoffDestinationRequest(UncheckedBaseModel):
    destination: "HandoffDestinationAssistant" = pydantic.Field()
    """
...
update_forward_refs(ServerMessageResponseHandoffDestinationRequest)
