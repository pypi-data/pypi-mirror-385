...
class ServerMessageSessionCreated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageSessionCreatedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ServerMessageSessionCreated)
