...
class ClientMessageChatDeleted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageChatDeletedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ClientMessageChatDeleted)
