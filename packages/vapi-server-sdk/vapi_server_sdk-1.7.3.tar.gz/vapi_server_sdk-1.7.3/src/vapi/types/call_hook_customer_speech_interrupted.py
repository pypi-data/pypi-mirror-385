...
class CallHookCustomerSpeechInterrupted(UncheckedBaseModel):
    on: typing.Literal["customer.speech.interrupted"] = pydantic.Field(default="customer.speech.interrupted")
    """
    This is the event that triggers this hook
    """

    do: typing.List["CallHookCustomerSpeechInterruptedDoItem"] = pydantic.Field()
    """
...
from .call_hook_customer_speech_interrupted_do_item import CallHookCustomerSpeechInterruptedDoItem  # noqa: E402, F401, I001

update_forward_refs(CallHookCustomerSpeechInterrupted)
