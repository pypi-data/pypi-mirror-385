...
class CallHookCallEnding(UncheckedBaseModel):
    ...
    do: typing.List["ToolCallHookAction"] = pydantic.Field()
    """
    This is the set of actions to perform when the hook triggers
    """

    filters: typing.Optional[typing.List[CallHookFilter]] = pydantic.Field(default=None)
    """
...
update_forward_refs(CallHookCallEnding)
