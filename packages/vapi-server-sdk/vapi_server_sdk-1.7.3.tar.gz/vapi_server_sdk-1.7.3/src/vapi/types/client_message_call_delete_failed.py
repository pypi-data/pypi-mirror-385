...
class ClientMessageCallDeleteFailed(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageCallDeleteFailedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ClientMessageCallDeleteFailed)
