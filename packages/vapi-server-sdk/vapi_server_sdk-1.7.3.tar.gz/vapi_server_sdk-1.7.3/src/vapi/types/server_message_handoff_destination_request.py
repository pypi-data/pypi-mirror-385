...
class ServerMessageHandoffDestinationRequest(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageHandoffDestinationRequestPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ServerMessageHandoffDestinationRequest)
