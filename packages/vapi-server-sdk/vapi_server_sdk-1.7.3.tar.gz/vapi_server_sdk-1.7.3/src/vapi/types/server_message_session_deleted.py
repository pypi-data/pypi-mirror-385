...
class ServerMessageSessionDeleted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageSessionDeletedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ServerMessageSessionDeleted)
