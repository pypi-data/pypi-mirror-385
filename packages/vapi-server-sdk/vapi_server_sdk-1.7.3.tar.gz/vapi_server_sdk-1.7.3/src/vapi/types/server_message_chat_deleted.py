...
class ServerMessageChatDeleted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageChatDeletedPhoneNumber], FieldMetadata(alias="phoneNumber")
    ] = pydantic.Field(default=None)
    """
    This is the phone number that the message is associated with.
    """

    type: typing.Literal["chat.deleted"] = pydantic.Field(default="chat.deleted")
    """
...
update_forward_refs(ServerMessageChatDeleted)
