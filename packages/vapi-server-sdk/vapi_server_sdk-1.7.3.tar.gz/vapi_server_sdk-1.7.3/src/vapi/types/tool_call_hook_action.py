...
class ToolCallHookAction(UncheckedBaseModel):
    type: typing.Literal["tool"] = pydantic.Field(default="tool")
    """
    This is the type of action - must be "tool"
    """

    tool: typing.Optional["ToolCallHookActionTool"] = pydantic.Field(default=None)
    """
...
from .tool_call_hook_action_tool import ToolCallHookActionTool  # noqa: E402, F401, I001

update_forward_refs(ToolCallHookAction)
