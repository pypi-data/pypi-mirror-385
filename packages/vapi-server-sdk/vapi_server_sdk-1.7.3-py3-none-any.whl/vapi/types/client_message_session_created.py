...
class ClientMessageSessionCreated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageSessionCreatedPhoneNumber], FieldMetadata(alias="phoneNumber")
    ...
    session: Session = pydantic.Field()
    """
...
update_forward_refs(ClientMessageSessionCreated)
