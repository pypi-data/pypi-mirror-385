...
class CallHookAssistantSpeechInterrupted(UncheckedBaseModel):
    on: typing.Literal["assistant.speech.interrupted"] = pydantic.Field(default="assistant.speech.interrupted")
    """
    This is the event that triggers this hook
    """

    do: typing.List["CallHookAssistantSpeechInterruptedDoItem"] = pydantic.Field()
    """
...
from .call_hook_assistant_speech_interrupted_do_item import CallHookAssistantSpeechInterruptedDoItem  # noqa: E402, F401, I001

update_forward_refs(CallHookAssistantSpeechInterrupted)
