...
class ClientMessageSessionUpdated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageSessionUpdatedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ClientMessageSessionUpdated)
