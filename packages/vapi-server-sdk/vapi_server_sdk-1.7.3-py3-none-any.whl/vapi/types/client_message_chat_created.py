...
class ClientMessageChatCreated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageChatCreatedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ClientMessageChatCreated)
