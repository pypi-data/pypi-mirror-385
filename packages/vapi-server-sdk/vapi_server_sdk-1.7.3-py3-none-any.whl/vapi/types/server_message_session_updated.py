...
class ServerMessageSessionUpdated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageSessionUpdatedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ServerMessageSessionUpdated)
