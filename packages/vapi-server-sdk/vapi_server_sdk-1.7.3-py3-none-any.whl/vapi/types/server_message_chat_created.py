...
class ServerMessageChatCreated(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageChatCreatedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ServerMessageChatCreated)
