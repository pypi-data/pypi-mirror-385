...
class TransferCancelToolUserEditable(UncheckedBaseModel):
    messages: typing.Optional[typing.List[TransferCancelToolUserEditableMessagesItem]] = pydantic.Field(default=None)
    """
...
update_forward_refs(TransferCancelToolUserEditable)
