...
class ClientMessageSessionDeleted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageSessionDeletedPhoneNumber], FieldMetadata(alias="phoneNumber")
...
update_forward_refs(ClientMessageSessionDeleted)
