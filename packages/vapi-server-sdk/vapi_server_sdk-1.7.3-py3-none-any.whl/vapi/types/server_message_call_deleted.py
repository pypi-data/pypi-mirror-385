...
class ServerMessageCallDeleted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageCallDeletedPhoneNumber], FieldMetadata(alias="phoneNumber")
    ] = pydantic.Field(default=None)
    """
    This is the phone number that the message is associated with.
    """

    type: typing.Literal["call.deleted"] = pydantic.Field(default="call.deleted")
    """
...
update_forward_refs(ServerMessageCallDeleted)
