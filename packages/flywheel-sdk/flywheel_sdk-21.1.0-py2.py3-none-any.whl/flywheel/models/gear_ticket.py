...
from flywheel.models.gear_document_input import GearDocumentInput  # noqa: F401,E501
from flywheel.models.origin import Origin  # noqa: F401,E501

class GearTicket(object):

    swagger_types = {
        'id': 'str',
        'origin': 'Origin',
        'geardoc': 'GearDocumentInput',
        'timestamp': 'datetime'
    }
    ...
    def __init__(self, id=None, origin=None, geardoc=None, timestamp=None):  # noqa: E501
        """GearTicket - a model defined in Swagger"""
        super(GearTicket, self).__init__()
    ...
    def geardoc(self):
        ...
        """
        return self._geardoc

    @geardoc.setter
    def geardoc(self, geardoc):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GearTicket):
            return False
