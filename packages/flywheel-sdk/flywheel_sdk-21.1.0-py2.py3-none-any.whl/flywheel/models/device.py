...
class Device(object):
    ...
    def __init__(self, id=None, last_seen=None, label=None, type=None, storage_config=None, disabled=None, version=None, name=None, interval=None, errors=None, info=None):  # noqa: E501
