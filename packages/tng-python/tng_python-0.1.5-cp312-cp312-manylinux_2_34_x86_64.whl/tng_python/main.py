...
def generate(
    ...
    try:
        ...
        try:
            ...
            if not methods:
                print(
                    f"[{TngTheme.Colors.WARNING}]{TngTheme.Icons.ERROR} No public methods found in {file_path.name}[/{TngTheme.Colors.WARNING}]")
                raise typer.Exit(1)
...
# Removed legacy OptionsUI commands; all interactive views handled by Go UI
