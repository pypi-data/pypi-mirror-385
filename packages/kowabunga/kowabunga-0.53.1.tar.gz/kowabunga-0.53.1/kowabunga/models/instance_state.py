...
class InstanceState(BaseModel):
    ...
    """ # noqa: E501
    state: StrictStr = Field(description="The virtual machine instance state.")
    reason: StrictStr = Field(description="The virtual machine instance reason of the state.")
