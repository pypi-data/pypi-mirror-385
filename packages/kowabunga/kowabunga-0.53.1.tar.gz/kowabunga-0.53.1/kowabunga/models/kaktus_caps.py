...
class KaktusCaps(BaseModel):
    """
    A Kaktus computing node capability.
    """ # noqa: E501
    cpu: KaktusCPU
    memory: StrictInt = Field(description="The Kaktus computing node memory size (bytes).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cpu": KaktusCPU.from_dict(obj["cpu"]) if obj.get("cpu") is not None else None,
