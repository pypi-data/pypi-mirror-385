...
class DiskContainerManager:
    ...
    def run(
        ...
        # Create mount configuration using client's env and region
        # These are automatically parsed from the base_url
        mount = ArchilMount(
...
class Disk(BaseModel):
    ...
    connected_clients: List[ConnectedClientResponse]
