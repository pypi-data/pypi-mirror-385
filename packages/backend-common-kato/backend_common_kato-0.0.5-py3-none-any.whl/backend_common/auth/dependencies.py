...
def get_security():
    """Get HTTPBearer security instance with lazy import."""
...
async def validate_api_key(api_key_header: Optional[str] = None) -> bool:
    """
    Authentication and API key validation for FastAPI applications.
...
async def get_current_user(credentials = None) -> UserModel:
    """
