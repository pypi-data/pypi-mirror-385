"""
Logging configuration for kcleaner.
"""
...
def setup_logging(
    ...
    # Root logger
    logger = logging.getLogger("kcleaner")
...
class LoggingContext:
    ...
    def __enter__(self):
        self.original_level = logging.getLogger("kcleaner").level
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self.file_handler:
            logging.getLogger("kcleaner").removeHandler(self.file_handler)
