# Intelwatchtower Sdk-python

A Python SDK intelwatchtower for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from intelwatchtower_sdk import BoilerSDK, BoilerSDKConfig
from intelwatchtower_sdk.types.common import UserRegisterInput
...
```python
from intelwatchtower_sdk import BoilerSDKConfig
...
pytest --cov=intelwatchtower_sdk --cov-report=html
```
...
# Run with coverage
pytest --cov=intelwatchtower_sdk
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/intelwatchtower-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/intelwatchtower-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../intelwatchtower-frontend) - Frontend intelwatchtower
- [Boiler Backend](../intelwatchtower-python-be-graphql) - Python GraphQL backend intelwatchtower