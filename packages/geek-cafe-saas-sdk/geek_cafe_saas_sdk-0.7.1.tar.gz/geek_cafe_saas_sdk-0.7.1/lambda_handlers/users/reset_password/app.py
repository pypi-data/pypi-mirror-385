...
def lambda_handler(event: Dict[str, Any], context: Any, 
    ...
    try:
        ...
        # Initialize services
        user_svc = injected_user_service or user_service_pool.get()
        cognito = injected_cognito_utility or CognitoUtility()
        
        # Get target user from DynamoDB
        user_result = user_svc.get_by_id(
            resource_id=target_user_id,
            tenant_id=tenant_id,
            user_id=user_id  # Admin performing action
        )
