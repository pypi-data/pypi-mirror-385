...
class ClientAPI:
    ...
    def head_timeseries_source(database, period, source,
                              endpoint=None, token=None, user=None):
        """
        Send a HEAD request to retrieve metadata about a timeseries source container.
        
        This method checks if a timeseries container exists for the specified database, period, and source,
        and returns metadata including available tags within the container.
        
        Parameters:
            database (str): The name of the database.
            period (str): The period identifier for the timeseries.
            source (str): The source identifier for the timeseries container.
            endpoint (str, optional): Custom API endpoint URL. Defaults to environment variable 'SHAREDDATA_ENDPOINT' if not provided.
            token (str, optional): Authentication token. Defaults to environment variable 'SHAREDDATA_TOKEN' if not provided.
            user (str, optional): User identifier. Defaults to 'master' if not provided.
        
        Returns:
            dict: JSON response containing container metadata and list of available tags.
