...
import { ModelFactoryService } from './view.js'; // QAIRT Netron: Import model factory to use when opening a file
...
browser.Host = class {
    ...
    constructor() {
        ...
        // QAIRT Netron: Bypass browser environment setup
        // this._environment = {
    ...
    async require(id) {
        return import(/* @vite-ignore */`${id}.js`); // QAIRT Netron: Suppress Vite dynamic import warning
    }
    ...
    // QAIRT Netron: Add minimal method for opening a file
    async openModel(file) {
        const context = new browser.BrowserFileContext(this, file, [file]);
        await context.open();
        const modelFactoryService = new ModelFactoryService(this);
        return await modelFactoryService.open(context);
    }
    // QAIRT Netron END
