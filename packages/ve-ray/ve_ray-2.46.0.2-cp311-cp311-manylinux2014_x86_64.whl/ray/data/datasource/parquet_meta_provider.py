...
class _ParquetFileFragmentMetaData:
    ...
    def __init__(self, fragment_metadata: "pyarrow.parquet.FileMetaData", row_group_ids: List[int]):
        ...
        self.num_row_groups = len(row_group_ids)
