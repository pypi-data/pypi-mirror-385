...
def plan_read_op(
    ...
    if data_context.checkpoint_manager and data_context.checkpoint_manager.is_enabled:
        transform_fns.append(ApplyCkptSkipToReadBlocks(
            data_context.checkpoint_manager))
