...
from typing import TYPE_CHECKING, Any, Dict, List, Optional, Union, Iterable, Iterator
...
class JSONDatasource(FileBasedDatasource):
    ...
    def __init__(
        ...
        **file_based_datasource_kwargs,
        ...
        if arrow_json_args is None:
            arrow_json_args = {}
        file_split_chunk_size = arrow_json_args.pop("file_split_chunk_size", self._DEFAULT_FILE_SPLIT_CHUNK_SIZE)
    ...
    def _read_chunk_stream(self,
        ...
        try:
            ...
            logger.error(f"Error reading chunk {chunk_id} from {path}: {e}")
            raise e