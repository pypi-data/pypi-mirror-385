...
class InMemoryMetricsStore:
    ...
    def window_average_by_keys(
        self, window_start_timestamp_s: float, do_compact: bool = True
    ) -> Dict[Hashable, Optional[float]]:
        return {key: self.window_average(key, window_start_timestamp_s, do_compact) for key in self.data.keys()}
