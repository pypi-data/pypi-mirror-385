    ...
    def write_datasink(
        ...
        *,
        ...
        try:
            ...
            fs = datasink.filesystem if hasattr(datasink, "filesystem") else None
            data_path = datasink.path if hasattr(datasink, "path") else None
            manager = create_checkpoint_manager(checkpoint_config, data_path, fs)
            if manager:
