...
class _FileDatasink(Datasink[None]):
    ...
    def write(
        ...
        # Checkpoint the block if a checkpoint worker is provided.
        if DataContext.get_current().checkpoint_manager is not None:
            DataContext.get_current().checkpoint_manager.record_data_block(block)
