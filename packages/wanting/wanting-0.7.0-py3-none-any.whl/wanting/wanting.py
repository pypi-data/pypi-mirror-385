...
def wanting_values[T](model: pydantic.BaseModel | pydantic.RootModel[T]) -> WantingValues:
    ...
    """
    if isinstance(model, pydantic.RootModel):
        return wanting_values(model.root) if isinstance(model.root, pydantic.BaseModel) else {}
