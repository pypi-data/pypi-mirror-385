...
def submit_review(review_json: str) -> str:
    ...
    try:
        ...
        print(f"🛠️ submit_review: ✅ Review validated! Found {change_count} issue(s).")
        ...
        print(f"🛠️ submit_review: ❌ JSON parsing failed")
        ...
        print(f"🛠️ submit_review: ❌ Unexpected error")
