...
def parse_args():
    parser = argparse.ArgumentParser(description="MMDetection video demo with GPU acceleration")
...
def main():
    ...
    with torch.no_grad():
        for frame_resize, frame_origin in zip(mmcv.track_iter_progress(video_resize), video_origin):
