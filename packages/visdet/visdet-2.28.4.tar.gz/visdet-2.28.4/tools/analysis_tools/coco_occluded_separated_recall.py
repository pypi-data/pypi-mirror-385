...
def main():
    ...
    assert isinstance(results[0], tuple), "The results must be predicted by instance segmentation model."
    dataset = OccludedSeparatedCocoDataset(ann_file=args.ann, pipeline=[], test_mode=True)
