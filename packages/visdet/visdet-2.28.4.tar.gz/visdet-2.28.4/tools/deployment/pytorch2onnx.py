...
def pytorch2onnx(
    ...
    if do_simplify:
        ...
        assert digit_version(onnxsim.__version__) >= digit_version(min_required_version), (
    ...
    if verify:
        ...
        for onnx_res, pytorch_res in compare_pairs:
            for o_res, p_res in zip(onnx_res, pytorch_res):
                np.testing.assert_allclose(o_res, p_res, rtol=1e-03, atol=1e-05, err_msg=err_msg)
