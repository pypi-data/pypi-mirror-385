...
class TestFCNMaskHead(TestCase):
    ...
    def test_get_seg_masks(self, device):
        ...
        num_classes = 6
        mask_head = FCNMaskHead(num_convs=1, in_channels=1, conv_out_channels=1, num_classes=num_classes)
        ...
        result.labels = torch.randint(num_classes, (num_samples,), dtype=torch.long).to(device)
