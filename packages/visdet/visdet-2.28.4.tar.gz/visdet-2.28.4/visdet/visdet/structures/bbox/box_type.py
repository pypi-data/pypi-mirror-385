...
def register_box(name: str, box_type: type | None = None, force: bool = False) -> type | Callable:
    ...
    Examples:
        >>> from visdet.structures.bbox import register_box
...
def register_box_converter(
    ...
    Examples:
        >>> from visdet.structures.bbox import register_box_converter
        >>> # as a decorator
...
def get_box_type(box_type: str | type) -> tuple[str, type]:
