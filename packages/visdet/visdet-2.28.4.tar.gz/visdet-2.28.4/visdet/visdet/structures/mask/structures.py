...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from visdet.data_elements.mask.structures import *  # NOQA
    ...
    def translate(
        ...
        Example:
            >>> from visdet.data_elements.mask.structures import BitmapMasks
    ...
    def random(cls, num_masks=3, height=32, width=32, dtype=np.uint8, rng=None):
        ...
        """
        from visdet.utils.util_random import ensure_rng
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls, num_masks=3, height=32, width=32, n_verts=5, dtype=np.float32, rng=None):
        ...
        Example:
            >>> from visdet.data_elements.mask.structures import PolygonMasks
