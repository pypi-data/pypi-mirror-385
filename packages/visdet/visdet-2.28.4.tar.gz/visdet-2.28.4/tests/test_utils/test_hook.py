...
def test_yolox_lrupdater_hook(multi_optimziers):
    ...
    if multi_optimziers:
        ...
        calls = [
            call("train", {"learning_rate": 8.000000000000001e-06, "momentum": 0.95}, 1),
            call("train", {"learning_rate": 0.00039200000000000004, "momentum": 0.95}, 7),
            call("train", {"learning_rate": 0.0008000000000000001, "momentum": 0.95}, 10),
        ]
