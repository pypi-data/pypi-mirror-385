...
@pytest.mark.parametrize("loss_class", [IoULoss, BoundedIoULoss, GIoULoss, DIoULoss, CIoULoss])
...
def test_loss_with_ignore_index(use_sigmoid, reduction, avg_non_ignore):
    ...
    target[ignored_indices] = 255
    loss_with_forward_ignore = loss_class(pred, target, ignore_index=255, reduction_override=reduction)
