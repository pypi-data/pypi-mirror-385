...
def _create_objects365_json(json_name):
    images = [
        {"file_name": "fake1.jpg", "height": 800, "width": 800, "id": 0},
        {"file_name": "fake2.jpg", "height": 800, "width": 800, "id": 1},
        {
...
@pytest.mark.parametrize("datasets", [Objects365V1Dataset, Objects365V2Dataset])
...
def test_load_objects365v1_annotations():
    ...
    dataset = Objects365V1Dataset(ann_file=fake_json_file, classes=("bus", "car"), pipeline=[])
...
def test_load_objects365v2_annotations():
    ...
    dataset = Objects365V2Dataset(ann_file=fake_json_file, classes=("bus", "car"), pipeline=[])
