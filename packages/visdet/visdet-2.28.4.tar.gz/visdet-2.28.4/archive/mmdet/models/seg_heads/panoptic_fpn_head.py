...
class PanopticFPNHead(BaseSemanticHead):
    ...
    def _set_things_to_void(self, gt_semantic_seg):
        ...
        new_gt_seg = torch.where(bg_mask, gt_semantic_seg - self.num_things_classes, new_gt_seg)
        new_gt_seg = torch.where(fg_mask, fg_mask.int() * self.num_stuff_classes, new_gt_seg)
        return new_gt_seg
