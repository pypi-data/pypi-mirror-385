    ...
    def aug_test(self, imgs, img_metas, rescale=True):
        ...
        for ind, flip_ind in zip(img_inds[0::2], img_inds[1::2]):
            ...
            center_heatmap_preds[0] = (
                center_heatmap_preds[0][0:1] + flip_tensor(center_heatmap_preds[0][1:2], flip_direction)
            ) / 2
        ...
        bbox_results = [
            bbox2result(det_bboxes, det_labels, self.bbox_head.num_classes) for det_bboxes, det_labels in bbox_list
        ]
        return bbox_results
