...
class PointRendRoIHead(StandardRoIHead):
    ...
    def _mask_point_forward_test(self, x, rois, label_pred, mask_pred, img_metas):
        ...
        for subdivision_step in range(self.test_cfg.subdivision_steps):
            ...
            if (
                self.test_cfg.subdivision_num_points >= self.test_cfg.scale_factor**2 * mask_height * mask_width
        ...
        if det_bboxes.shape[0] == 0:
            ...
            for x, img_meta in zip(feats, img_metas):
                ...
                mask_results["mask_pred"] = self._mask_point_forward_test(
                    x, mask_rois, det_labels, mask_results["mask_pred"], img_meta
                )
    ...
    def _mask_point_onnx_export(self, x, rois, label_pred, mask_pred):
        ...
        for subdivision_step in range(self.test_cfg.subdivision_steps):
            ...
            if is_trt_backend:
                ...
                inds_1d = (
                    inds_dim0.reshape(-1) * mask_shape[1] * mask_shape[2]
                    + inds_dim1.reshape(-1) * mask_shape[2]
