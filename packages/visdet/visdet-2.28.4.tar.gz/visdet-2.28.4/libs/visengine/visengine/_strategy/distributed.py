...
from visengine.dist import init_dist, is_distributed, master_only
from visengine.registry import MODEL_WRAPPERS, STRATEGIES
from visengine.model import convert_sync_batchnorm, is_model_wrapper
    ...
    def convert_model(self, model: nn.Module) -> nn.Module:
        ...
        if self.sync_bn is not None:
            try:
                ...
                self.logger.error(f'cfg.sync_bn should be "torch" or "mmcv", but got {self.sync_bn}')
                raise e
