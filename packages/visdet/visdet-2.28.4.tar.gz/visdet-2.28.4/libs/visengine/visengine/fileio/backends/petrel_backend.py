...
import visengine
from visengine.utils import has_method
...
class PetrelBackend(BaseStorageBackend):
    ...
    def _map_path(self, filepath: str | Path) -> str:
    ...
    def _replace_prefix(self, filepath: str | Path) -> str:
        filepath = str(filepath)
    ...
    def isdir(self, filepath: str | Path) -> bool:
        ...
        if not has_method(self._client, "isdir"):
            raise NotImplementedError(
                "Current version of Petrel Python SDK has not supported the `isdir` method, please use a higher version or dev branch instead."
            )
    ...
    def isfile(self, filepath: str | Path) -> bool:
        ...
        if not has_method(self._client, "contains"):
            raise NotImplementedError(
                "Current version of Petrel Python SDK has not supported the `contains` method, please use a higher version or dev branch instead."
            )
    ...
    def remove(self, filepath: str | Path) -> None:
        ...
        if not has_method(self._client, "delete"):
            raise NotImplementedError(
                "Current version of Petrel Python SDK has not supported the `delete` method, please use a higher version or dev branch instead."
            )
    ...
    def list_dir_or_file(
        ...
        if not has_method(self._client, "list"):
            raise NotImplementedError(
                "Current version of Petrel Python SDK has not supported the `list` method, please use a higher version or dev branch instead."
            )
