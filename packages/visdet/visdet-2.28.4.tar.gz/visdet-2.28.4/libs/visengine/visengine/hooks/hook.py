...
from visengine.utils import is_method_overridden
...
class Hook:
    ...
    def before_val_iter(self, runner, batch_idx: int, data_batch: DATA_BATCH = None) -> None:
        ...
        Args:
            ...
            data_batch (dict, optional): Data from dataloader.
                Defaults to None.
        """
        self._before_iter(runner, batch_idx=batch_idx, data_batch=data_batch, mode="val")
    ...
    def _before_iter(self, runner, batch_idx: int, data_batch: DATA_BATCH = None, mode: str = "train") -> None:
        """All subclasses should override this method, if they need any
