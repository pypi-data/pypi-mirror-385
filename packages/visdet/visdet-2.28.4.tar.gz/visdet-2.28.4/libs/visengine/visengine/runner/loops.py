...
from visengine.logging import HistoryBuffer, print_log
from visengine.registry import LOOPS
...
class EpochBasedTrainLoop(BaseLoop):
    ...
    def __init__(
        ...
        val_begin: int = 1,
        val_interval: int = 1,
        dynamic_intervals: list[tuple[int, int]] | None = None,
    ) -> None:
        ...
        if hasattr(self.dataloader.dataset, "metainfo"):
            ...
            print_log(
                f"Dataset {self.dataloader.dataset.__class__.__name__} has no metainfo. ``dataset_meta`` in visualizer will be None.",
                logger="current",
...
class IterBasedTrainLoop(BaseLoop):
    ...
    def __init__(
        ...
        assert self._max_iters == max_iters, f"`max_iters` should be a integer number, but get {max_iters}"
...
class ValLoop(BaseLoop):
    ...
    def __init__(
        ...
        self.fp16 = fp16
        self.val_loss: dict[str, HistoryBuffer] = {}
...
class TestLoop(BaseLoop):
    ...
    def __init__(
        ...
        self.fp16 = fp16
        self.test_loss: dict[str, HistoryBuffer] = {}
