...
from visengine.dist import broadcast_object_list, collect_results, is_main_process
from visengine.fileio import dump
from visengine.logging import print_log
from visengine.registry import METRICS
...
class BaseMetric(metaclass=ABCMeta):
    ...
    def __init__(
        ...
        self._dataset_meta: None | dict = None
        ...
        if self.prefix is None:
            print_log(
                f"The prefix is not set in metric class {self.__class__.__name__}.",
                logger="current",
