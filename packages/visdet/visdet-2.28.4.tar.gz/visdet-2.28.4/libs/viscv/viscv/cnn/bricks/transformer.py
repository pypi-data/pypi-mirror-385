...
from visengine.model import BaseModule, ModuleList, Sequential
from visengine.registry import MODELS
from visengine.utils import deprecated_api_warning, to_2tuple

from viscv.cnn.bricks.activation import build_activation_layer
from viscv.cnn.bricks.conv import build_conv_layer
from viscv.cnn.bricks.norm import build_norm_layer
from viscv.cnn.bricks.wrappers import Linear
        ...
        **kwargs contains some specific arguments of attentions.
        ...
        if attn_masks is None:
            ...
            assert len(attn_masks) == self.num_attn, (
                f"The length of attn_masks {len(attn_masks)} must be equal to the number of attention in operation_order {self.num_attn}"
            )
