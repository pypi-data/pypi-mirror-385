...
class BrowserCore(MCPMixin):
    ...
    def __init__(self):
        ...
        self._user_agent: Optional[str] = None  # None = use Playwright default (avoids bot detection)
    ...
    async def _create_browser_context(self):
        ...
        # Default: No custom user_agent (use Playwright's default to avoid bot detection)
        # Can be overridden via browser_configure tool for specific testing needs
        ...
        try:
            ...
            return {
                ...
                "configuration": {
                    ...
                    "user_agent": self._user_agent or "Default (Chrome-like)"
                }
            }
        except Exception as e:
