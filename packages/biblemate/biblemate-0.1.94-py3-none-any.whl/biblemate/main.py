...
- `Esc`: close input suggestion menu"""
                    ...
                    display_info(console, Markdown(info), title="configuration")
                    ...
                    if ai_mode:
                        if ai_mode == "agent":
                            ...
                            config.agent_mode = None
                        write_user_config()
                        display_info(console, Markdown(f"`{ai_mode.capitalize()}` Mode Enabled"), title="configuration")
                elif user_request == ".agent":
                    config.agent_mode = True
                    write_user_config()
                    display_info(console, Markdown(f"`Agent` Mode Enabled"), title="configuration")
                elif user_request == ".partner":
                    config.agent_mode = False
                    write_user_config()
                    display_info(console, Markdown(f"`Partner` Mode Enabled"), title="configuration")
                elif user_request == ".chat":
                    config.agent_mode = None
                    write_user_config()
                    display_info(console, Markdown(f"`Chat` Mode Enabled"), title="configuration")
                    ...
                    if select:
                        ...
                        write_user_config()
                        display_info(console, Markdown(f"Default bible set to `{config.default_bible}`"), title="configuration")
                    ...
                    if select:
                        ...
                        write_user_config()
                        display_info(console, Markdown(f"Default commentary set to `{config.default_commentary}`"), title="configuration")
                    ...
                    if select:
                        ...
                        write_user_config()
                        display_info(console, Markdown(f"Default encyclopedia set to `{config.default_encyclopedia}`"), title="configuration")
                    ...
                    if select:
                        ...
                        write_user_config()
                        display_info(console, Markdown(f"Default lexicon set to `{config.default_lexicon}`"), title="configuration")
