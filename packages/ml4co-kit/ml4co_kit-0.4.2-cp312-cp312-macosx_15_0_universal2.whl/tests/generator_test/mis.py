...
from ml4co_kit import MISGenerator, GRAPH_TYPE
...
class MISGenTester(GenTesterBase):
    def __init__(self):
        super(MISGenTester, self).__init__(
            test_gen_class=MISGenerator,
            test_args_list=[
