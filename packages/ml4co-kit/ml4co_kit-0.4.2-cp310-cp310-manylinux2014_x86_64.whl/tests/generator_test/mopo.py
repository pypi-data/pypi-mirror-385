...
from ml4co_kit import MOPOGenerator, PO_TYPE
from tests.generator_test.base import GenTesterBase


class MOPOGenTester(GenTesterBase):
    def __init__(self):
        super(MOPOGenTester, self).__init__(
            test_gen_class=MOPOGenerator,
            test_args_list=[
                # GBM
                {
