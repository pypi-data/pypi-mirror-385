...
from ml4co_kit import MinVarPOGenerator, PO_TYPE
from tests.generator_test.base import GenTesterBase


class MinVarPOGenTester(GenTesterBase):
    def __init__(self):
        super(MinVarPOGenTester, self).__init__(
            test_gen_class=MinVarPOGenerator,
            test_args_list=[
                # GBM
                {
