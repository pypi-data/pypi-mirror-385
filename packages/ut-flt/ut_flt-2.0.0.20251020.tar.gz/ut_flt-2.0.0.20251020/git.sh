...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ut_flt/.git/

# Add Remote Repository: Link your local repository to the GitHub repository you created:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ut_flt
git remote add ut_flt https://github.com/bs291048/ut_flt.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ut_flt'
