"""Basic model tests converted from unittest to pytest with fakeredis."""
...
class TestModelBasic:
    """Basic tests for the Model class using fakeredis."""

    def test_example(self, model):
        """Test creating a department and employees structure."""
        # Create a department
        group1 = model.init({})
        group1["type"] = "dept"
