"""Fix identification agent runner."""
...
from ..summary_models import FixResult
from ..summary_prompts import FIX_FULL_PROMPT


class FixAgentRunner(GitHubIssueRunner):
    """Runner to identify resolution steps for support cases."""
    ...
    def __init__(self):
        ...
        agent = Agent(
            name=f"fix-agent-{unique_id}",
            model=OpenAIResponsesModel("gpt-5-mini"),
            output_type=FixResult,
            instructions=FIX_FULL_PROMPT,
        ...
        super().__init__("fix-agent", agent)
