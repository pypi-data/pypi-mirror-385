...
def keygen(
    ...
    """Generate Ed25519 keypair for signing receipts."""
    try:
        from .tools.signing import generate_keypair

        # Create directory if it doesn't exist
        private_key.parent.mkdir(parents=True, exist_ok=True)

        generate_keypair(private_key, public_key)
        console.print(f"[green]✅ Generated keypair:[/green]")
...
def main() -> None:
    ...
    try:
        from vigil_client.cli.platform_app import platform_app
        # Add client commands to main app
        app.add_typer(platform_app, name="client")
