...
def capture_vigil_info() -> Dict[str, Any]:
    ...
    """
    vigil_info = {
        "version": "0.2.1",  # This should be imported from vigil.__version__
        "config_dir": None,
        "workspace_root": None
    }
...
def save_environment_snapshot(output_path: Path, environment_data: Optional[Dict[str, Any]] = None) -> None:
