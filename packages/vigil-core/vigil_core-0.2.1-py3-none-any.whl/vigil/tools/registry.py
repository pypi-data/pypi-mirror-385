...
class LocalRegistry:
    ...
    def find_artifacts(self, artifact_type: Optional[ArtifactType] = None,
...
def register_from_receipt(receipt_path: Path, registry: Optional[LocalRegistry] = None) -> List[ArtifactMetadata]:
