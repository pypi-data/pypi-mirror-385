...
class NachrichtFamAllgemein0200001:
    ...
    fachdaten: Optional["NachrichtFamAllgemein0200001.Fachdaten"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class Fachdaten:
        ...
        familienname: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        heiratsdatum: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
            },
        )
        auswahl_heiratsort: Optional[
            "NachrichtFamAllgemein0200001.Fachdaten.AuswahlHeiratsort"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        heiratsregister: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        familienart: Optional[
            "NachrichtFamAllgemein0200001.Fachdaten.Familienart"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        auswahl_zustelldatum: Optional[
            "NachrichtFamAllgemein0200001.Fachdaten.AuswahlZustelldatum"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        trennungszeitpunkt: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
        ...
        rechtswahl_scheidungsrecht: Optional[CodeGdsStaatenTyp3] = field(
            default=None,
            metadata={
        ...
        scheidungsdatum: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
            },
        )
        rechtskraft_entscheidung: Optional[XmlDate] = field(
            default=None,
            metadata={
        ...
        class AuswahlHeiratsort:
            heiratsort_standesamt: Optional[str] = field(
                default=None,
                metadata={
            ...
            heiratsort_kein_standesamt: Optional[str] = field(
                default=None,
                metadata={
        ...
        @dataclass
        class Familienart:
            familienart: Optional[CodeFamFamilienart] = field(
                default=None,
                metadata={
                    "type": "Element",
                },
            )
            ehezeit: Optional[TypeGdsXdomeaZeitraumType] = field(
                default=None,
                metadata={
                    "type": "Element",
                },
        ...
        class AuswahlZustelldatum:
            zustelldatum_scheidungsantrag: Optional[XmlDate] = field(
                default=None,
                metadata={
            ...
            zustelldatum_trennungsantrag: Optional[XmlDate] = field(
                default=None,
                metadata={
