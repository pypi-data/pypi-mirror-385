...
class CodeGdsBrisListOfRegistersTyp3(Code):
    ...
    Nähere Details sind im Kapitel "Codelisten vom Code-Typ 3"
    beschrieben. Neben dem Code im Element 'code' ist zusätzlich im
    zwingend nachfolgenden Element 'name' die Bezeichnung der
    ausländischen Registerbehörde anzugeben. Dabei werden die Einträge
    der Spalte 'Original-language-name-of-register' genutzt.
    """
