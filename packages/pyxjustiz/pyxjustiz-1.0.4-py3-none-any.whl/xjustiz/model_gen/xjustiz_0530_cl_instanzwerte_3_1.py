...
@dataclass
class CodeStrafSachgebietsschluesselTyp3(Code):
    ...
    class Meta:
        name = "Code.STRAF.Sachgebietsschluessel.Typ3"
    ...
    list_uri: str = field(
        init=False,
        default="urn:xoev-de:xjustiz:codeliste:straf.sachgebietsschluessel",
        metadata={
            "name": "listURI",
            "type": "Attribute",
        },
