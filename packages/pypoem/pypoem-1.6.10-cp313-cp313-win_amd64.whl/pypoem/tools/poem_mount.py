...
def main():
    ...
    if to_path:
        ...
        to_node = to_root_node

    if to_node.is_polar_node():
        if from_node.is_polar_node():
            to_node.attach_polar_node(from_node)
        elif from_node.is_polar_set:
            to_node.attach_polar_set(from_node)
        else:
    ...
    pypoem.to_netcdf(to_root_node, to_root_node.name(), to_file)
