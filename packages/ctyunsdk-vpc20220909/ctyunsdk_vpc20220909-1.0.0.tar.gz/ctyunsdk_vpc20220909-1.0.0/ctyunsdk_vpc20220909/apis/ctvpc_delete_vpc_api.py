...
class CtvpcDeleteVpcApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcDeleteVpcRequest) -> CtvpcDeleteVpcResponse:
        url = endpoint + "/v4/vpc/delete"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcDeleteVpcResponse.from_dict(response.json())
