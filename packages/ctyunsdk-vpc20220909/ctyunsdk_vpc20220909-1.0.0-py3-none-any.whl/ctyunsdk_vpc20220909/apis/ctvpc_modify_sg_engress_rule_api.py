...
@dataclass_json
@dataclass
class CtvpcModifySgEngressRuleRequest:
    regionID: str  # 区域id
...
@dataclass_json
@dataclass
class CtvpcModifySgEngressRuleResponse:
...
class CtvpcModifySgEngressRuleApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcModifySgEngressRuleRequest) -> CtvpcModifySgEngressRuleResponse:
        url = endpoint + "/v4/vpc/modify-security-group-egress"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcModifySgEngressRuleResponse.from_dict(response.json())
