...
@dataclass_json
@dataclass
class CtvpcUpdateSubnetIPv6StatusRequest:
    regionID: str  # 资源池 ID
...
@dataclass_json
@dataclass
class CtvpcUpdateSubnetIPv6StatusResponse:
...
class CtvpcUpdateSubnetIPv6StatusApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcUpdateSubnetIPv6StatusRequest) -> CtvpcUpdateSubnetIPv6StatusResponse:
        url = endpoint + "/v4/vpc/update-subnet-ipv6-status"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcUpdateSubnetIPv6StatusResponse.from_dict(response.json())
