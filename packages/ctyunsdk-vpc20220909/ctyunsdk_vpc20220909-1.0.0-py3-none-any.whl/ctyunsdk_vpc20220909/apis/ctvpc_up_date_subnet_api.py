...
@dataclass_json
@dataclass
class CtvpcUpDateSubnetRequest:
    regionID: str  # 资源池 ID
...
@dataclass_json
@dataclass
class CtvpcUpDateSubnetResponse:
...
class CtvpcUpDateSubnetApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcUpDateSubnetRequest) -> CtvpcUpDateSubnetResponse:
        url = endpoint + "/v4/vpc/update-subnet"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcUpDateSubnetResponse.from_dict(response.json())
