...
@dataclass_json
@dataclass
class CtvpcNewRouteRulesListRequest:
    regionID: str  # 区域id
...
@dataclass_json
@dataclass
class CtvpcNewRouteRulesListReturnObjRouteRulesResponse:
...
@dataclass_json
@dataclass
class CtvpcNewRouteRulesListReturnObjResponse:
    """返回结果"""
    routeRules: Optional[List[Optional[CtvpcNewRouteRulesListReturnObjRouteRulesResponse]]]  # 路由规则
...
@dataclass_json
@dataclass
class CtvpcNewRouteRulesListResponse:
    statusCode: Any  # 返回状态码（800为成功，900为失败）
    message: Optional[str]  # statusCode为900时的错误信息; statusCode为800时为success, 英文
    description: Optional[str]  # statusCode为900时的错误信息; statusCode为800时为成功, 中文
    errorCode: Optional[str]  # statusCode为900时为业务细分错误码，三段式：product.module.code; statusCode为800时为SUCCESS
    returnObj: Optional[CtvpcNewRouteRulesListReturnObjResponse]  # 返回结果



# 查询路由表规则列表
class CtvpcNewRouteRulesListApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcNewRouteRulesListRequest) -> CtvpcNewRouteRulesListResponse:
        url = endpoint + "/v4/vpc/route-table/new-list-rules"
        ...
        try:
            ...
            return CtvpcNewRouteRulesListResponse.from_dict(response.json())
