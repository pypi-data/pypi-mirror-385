...
@dataclass_json
@dataclass
class CtvpcVpcListPortReturnObjResponse:
...
@dataclass_json
@dataclass
class CtvpcVpcListPortResponse:
    statusCode: Any  # 返回状态码（800为成功，900为失败）
    message: Optional[str]  # statusCode为900时的错误信息; statusCode为800时为success, 英文
    description: Optional[str]  # statusCode为900时的错误信息; statusCode为800时为成功, 中文
    errorCode: Optional[str]  # statusCode为900时为业务细分错误码，三段式：product.module.code; statusCode为800时为SUCCESS
    returnObj: Optional[List[Optional[CtvpcVpcListPortReturnObjResponse]]]  # 接口业务数据
...
class CtvpcVpcListPortApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcVpcListPortRequest) -> CtvpcVpcListPortResponse:
        url = endpoint + "/v4/ports/list"
        ...
        try:
            ...
            return CtvpcVpcListPortResponse.from_dict(response.json())
