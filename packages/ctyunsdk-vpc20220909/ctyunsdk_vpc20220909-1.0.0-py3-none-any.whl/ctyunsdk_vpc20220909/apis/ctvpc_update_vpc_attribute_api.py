...
@dataclass_json
@dataclass
class CtvpcUpdateVpcAttributeRequest:
...
@dataclass_json
@dataclass
class CtvpcUpdateVpcAttributeResponse:
...
# 修改专有网络VPC的属性：名称、描述。
class CtvpcUpdateVpcAttributeApi:
    ...
    @staticmethod
    def do(credential: Credential, client: CtyunClient, endpoint: str, request: CtvpcUpdateVpcAttributeRequest) -> CtvpcUpdateVpcAttributeResponse:
        url = endpoint + "/v4/vpc/update"
        params = {}
        try:
            header_params = {}
            ...
            return CtvpcUpdateVpcAttributeResponse.from_dict(response.json())
