...
<body>
    <div class="container">
        <header>
            <h1>[MLTrackFlow] {self.tracker.experiment_name}</h1>
        ...
        <div class="content">
            <!-- Özet İstatistikler -->
            <div class="section">
                <h2>[STATS] Özet İstatistikler</h2>
            ...
            <!-- Denemeler Tablosu -->
            <div class="section">
                <h2>[RUNS] Tüm Denemeler</h2>
                {self._generate_runs_table(df)}
            </div>
            
            <!-- En İyi Sonuçlar -->
            <div class="section">
                <h2>[BEST] En İyi Sonuçlar</h2>
        ...
        <div class="footer">
            ...
            <p>[PATH] Kayıt Yolu: {self.tracker.experiment_path}</p>
        </div>
    </div>
</body>
</html>
    ...
    def _generate_best_results(self, df) -> str:
        ...
        for metric in metric_cols:
            ...
            <div style="padding: 20px; background: #f8f9fa; border-left: 4px solid #667eea; border-radius: 5px;">
                ...
                <p style="color: #666;">[BEST] En iyi: {best_run}</p>
            </div>
            '''
