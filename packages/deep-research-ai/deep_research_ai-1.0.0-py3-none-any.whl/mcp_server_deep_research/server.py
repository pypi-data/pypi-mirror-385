...
- Always cite: Author/Organization, "Title," URL
...
Format: Author/Organization. "Title." Publication/Website. URL. (Access date if relevant)
...
✓ Cite ALL sources properly (author, title, URL)
