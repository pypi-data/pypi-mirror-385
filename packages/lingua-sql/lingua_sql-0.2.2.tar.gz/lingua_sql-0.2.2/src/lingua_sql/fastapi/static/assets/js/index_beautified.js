...
function or(r,
e){
return r===e?!0:(Vt||(Vt=document.createElement("a")),
Vt.href=e,
r===Vt.href)
}
function _r(r){
...
if(typeof o=="object"){
const i=[],
s=Math.max(e.dirty.length,
o.length);
for(let l=0;
l<s;
l+=1)i[l]=e.dirty[l]|o[l];
return i
}
return e.dirty|o
}
...
e,
n){
n==null?r.removeAttribute(e):r.getAttribute(e)!==n&&r.setAttribute(e,
n)
}
function wr(r){
let e;
...
p(...n){
e=n,
e.forEach(t=>r.push(t))
}
,
r(){
e.forEach(n=>r.splice(r.indexOf(n),
1))
}
...
function xr(){
if(!Dt)throw new 错误("Function called outside component initialization");
return Dt
}
function sr(r){
xr().$$.on_mount.push(r)
...
e){
const n=r.$$;
n.fragment!==null&&(Lr(n.after_update),
ot(n.on_destroy),
...
return a.ctx&&o(a.ctx[g],
a.ctx[g]=D)&&(!a.skip_bound&&a.bound[g]&&a.bound[g](D),
d&&Tr(r,
g)),
k
}
...
$set(e){
this.$$set&&!_r(e)&&(this.$$.skip_bound=!0,
this.$$set(e),
this.$$.skip_bound=!1)
}
...
p(c,
a){
a&1&&o!==(o=c[6]<c[0]?"inline":"hidden")&&v(e,
"class",
o),
c[6]<c[0]?l||(l=Sn(),
l.c(),
...
D.innerHTML=`<div class="py-2.5 px-7"><p class="inline-flex items-center gap-x-2 text-xs text-green-600"><span class="block w-1.5 h-1.5 rounded-full bg-green-600"></span>
            已连接</p></div> <div class="p-4 border-t border-gray-200 dark:border-gray-700"><a class="flex justify-between items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="#replace">退出登录
...
v(t,
"class",
"flex items-center justify-between py-4 pr-4 pl-7"),
v(c,
"class",
...
v(n,
"class",
"hs-accordion-group w-full h-full flex flex-col"),
v(n,
...
;
return r.$$set=c=>{
"getTrainingData"in c&&n(0,
t=c.getTrainingData),
"newQuestionPage"in c&&n(1,
o=c.newQuestionPage),
"loadQuestionPage"in c&&n(2,
i=c.loadQuestionPage),
"questionHistory"in c&&n(3,
s=c.questionHistory)
}
,
[t,
...
;
/*! For license information please see preline.js.LICENSE.txt */(function(r,
e){
(function(n,
t){
r.exports=t()
...
function g(L,
m){
return g=Object.setPrototypeOf||function(h,
p){
return h.__proto__=p,
h
}
,
g(L,
...
if(m!==void 0)throw new Type错误("Derived constructors may only return object or undefined");
return function(h){
if(h===void 0)throw new Reference错误("this hasn't been initialised - super() hasn't been called");
return h
}
(L)
}
...
(function(T,
u){
if(typeof u!="function"&&u!==null)throw new Type错误("Super expression must either be null or a function");
...
return function(T,
u){
if(!(T instanceof u))throw new Type错误("Cannot call a class as a function")
}
(this,
P),
A.call(this,
...
f.style.height=0,
setTimeout(function(){
f.style.height="".concat(f.scrollHeight,
"px")
}
),
this.afterTransition(f,
function(){
T.classList.contains("active")&&(f.style.height="",
u._fireEvent("open",
T),
u._dispatch("open.hs.accordion",
T,
T))
}
)
...
this.afterTransition(f,
function(){
T.classList.contains("active")||(f.style.display="",
u._fireEvent("hide",
T),
u._dispatch("hide.hs.accordion",
T,
T))
}
),
...
function k(m,
h){
return k=Object.setPrototypeOf||function(p,
_){
...
if(h!==void 0)throw new Type错误("Derived constructors may only return object or undefined");
return function(p){
if(p===void 0)throw new Reference错误("this hasn't been initialised - super() hasn't been called");
return p
}
(m)
}
...
(function(u,
f){
if(typeof f!="function"&&f!==null)throw new Type错误("Super expression must either be null or a function");
...
return function(u,
f){
if(!(u instanceof f))throw new Type错误("Cannot call a class as a function")
}
(this,
T),
P.call(this,
...
S);
var j=Object.prototype.toString.call(C).slice(8,
-1);
return j==="Object"&&C.constructor&&(j=C.constructor.name),
j==="Map"||j==="Set"?Array.from(C):j==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(j)?d(C,
S):void 0
}

}
(f)||function(){
throw new Type错误(`Invalid attempt to spread non-iterable instance.
...
"px"),
this.afterTransition(u,
function(){
u.classList.contains("open")&&(u.style.height="",
f._fireEvent("open",
u),
f._dispatch("open.hs.collapse",
u,
u))
}
)
...
this.afterTransition(u,
function(){
u.classList.contains("open")||(u.classList.add("hidden"),
u.style.height=null,
f._fireEvent("hide",
u),
f._dispatch("hide.hs.collapse",
u,
u),
u.querySelectorAll(".hs-mega-menu-content.block").forEach(function(O){
...
T);
var u=Object.prototype.toString.call(P).slice(8,
-1);
return u==="Object"&&P.constructor&&(u=P.constructor.name),
u==="Map"||u==="Set"?Array.from(P):u==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(u)?D(P,
T):void 0
}
...
function m(A,
P){
return m=Object.setPrototypeOf||function(T,
u){
return T.__proto__=u,
T
}
,
m(A,
...
if(P!==void 0)throw new Type错误("Derived constructors may only return object or undefined");
return function(T){
if(T===void 0)throw new Reference错误("this hasn't been initialised - super() hasn't been called");
return T
}
(A)
}
...
(function(S,
j){
if(typeof j!="function"&&j!==null)throw new Type错误("Super expression must either be null or a function");
...
return function(j,
R){
if(!(j instanceof R))throw new Type错误("Cannot call a class as a function")
}
(this,
C),
(S=O.call(this,
".hs-dropdown")).positions={
top:"top",
"top-left":"top-start",
"top-right":"top-end",
bottom:"bottom",
...
R.state.elements.popper.style.transform=B==="adaptive"?R.state.styles.popper.transform:null,
...
if(q&&q.classList.contains("open")||S._closeOthers(q),
B){
...
var R=j.target,
q=R.closest(S.selector);
if(R.closest(".hs-dropdown-menu"),
q){
var B=(window.getComputedStyle(q).getPropertyValue("--trigger")||"click").replace(" ",
"");
if(B!=="hover")return;
q&&q.classList.contains("open")||S._closeOthers(q),
B!=="hover"||q.classList.contains("open")||/iPad|iPhone|iPod/.test(navigator.platform)||navigator.maxTouchPoints&&navigator.maxTouchPoints>2&&/MacIntel/.test(navigator.platform)||navigator.maxTouchPoints&&navigator.maxTouchPoints>2&&/MacIntel/.test(navigator.platform)||S._hover(R)
}
...
R=document.querySelectorAll("".concat(this.selector,
".open"));
...
document.addEventListener("mousemove",
function q(B){
B.target.closest(j.selector)&&B.target.closest(j.selector)!==R.parentElement.closest(j.selector)||(j.close(R),
...
B=function(){
S.classList.contains("open")||(q.classList.remove("block"),
...
;
R||this.afterTransition(S.querySelector("[data-hs-dropdown-transition]")||q,
function(){
B()
}
),
...
S),
this._dispatch("close.hs.dropdown",
S,
S);
...
""),
B=((window.getComputedStyle(S).getPropertyValue("--adaptive")||"adaptive").replace(" ",
""),
parseInt((window.getComputedStyle(S).getPropertyValue("--offset")||"10").replace(" ",
"")));
if(q!=="static"){
S._popper&&S._popper.destroy();
var N=(0,
...
S),
this._dispatch("open.hs.dropdown",
S,
S)
}
...
if(j)return S.keyCode===27?(S.preventDefault(),
this._esc(j)):S.keyCode===40?(S.preventDefault(),
this._down(j)):S.keyCode===38?(S.preventDefault(),
this._up(j)):S.keyCode===36?(S.preventDefault(),
this._start(j)):S.keyCode===35?(S.preventDefault(),
this._end(j)):void this._byChar(j,
S.key)
}
...
B=function(){
return q.findIndex(function(ie,
re){
...
,
N=B();
N===-1&&(this._history.clearHistory(),
N=B()),
N!==-1&&(q[N].focus(),
this._history.addHistory(N))
}
...
return function(f,
O){
if(!(f instanceof O))throw new Type错误("Cannot call a class as a function")
}
(this,
T),
(u=P.call(this,
"[data-hs-overlay]")).openNextOverlay=!1,
u
}
return h=T,
(p=[{
...
if(u){
var O=document.querySelector(".hs-overlay.open"),
C=this.getClassProperty(u,
"--body-scroll",
"false")!=="true";
if(O)return this.openNextOverlay=!0,
...
this._autoHide(u),
u.classList.remove("hidden"),
u.setAttribute("aria-overlay",
"true"),
u.setAttribute("tabindex",
"-1"),
setTimeout(function(){
u.classList.contains("hidden")||(u.classList.add("open"),
f._fireEvent("open",
u),
f._dispatch("open.hs.overlay",
u,
u),
f._focusInput(u))
}
...
value:function(u){
var f=this,
O=parseInt(this.getClassProperty(u,
"--auto-hide",
"0"));
...
key:"_checkTimer",
value:function(u){
u.autoHide&&(clearTimeout(u.autoHide),
delete u.autoHide)
}
...
value:function(u){
this.getClassProperty(u,
"--overlay-backdrop",
"true")!=="static"&&this.close(u)
}
...
if(!re){
if(Array.isArray(N)||(re=function(me,
it){
if(me){
if(typeof me=="string")return d(me,
it);
var ze=Object.prototype.toString.call(me).slice(8,
-1);
return ze==="Object"&&me.constructor&&(ze=me.constructor.name),
ze==="Map"||ze==="Set"?Array.from(me):ze==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(ze)?d(me,
it):void 0
}
...
throw new Type错误(`Invalid attempt to iterate non-iterable instance.
In order to be iterable,
 non-array objects must have a [Symbol.iterator]() method.`)
}
var De,
...
var B=this.getClassProperty(u,
"--overlay-backdrop",
"true")!=="static";
this.getClassProperty(u,
"--overlay-backdrop",
"true")==="false"||(C&&((S=document.querySelector(C).cloneNode(!0)).classList.remove("hidden"),
j=S.classList,
S.classList=""),
B&&S.addEventListener("click",
function(){
return O.close(u)
}
,
...
u&&(this.openNextOverlay&&(u.style.transitionDuration="".concat(1.8*parseFloat(window.getComputedStyle(u).transitionDuration.replace(/[^\d.-]/g,
"")),
"s")),
...
P),
(T=A.call(this,
"[data-hs-scrollspy] ")).activeSection=null,
T
}
return m=P,
(h=[{
...
j.getAttribute("id")&&S.addEventListener("scroll",
function(R){
return T._update({
$scrollspyEl:u,
...
T.links),
C=T.$sectionEl,
S=parseInt(this.getClassProperty(f,
"--scrollspy-offset",
"0")),
j=this.getClassProperty(C,
"--scrollspy-offset")||S,
...
S=parseInt(this.getClassProperty(u,
"--scrollspy-offset",
"0")),
j=this.getClassProperty(C,
"--scrollspy-offset")||S,
...
u),
this._dispatch("scroll.hs.scrollspy",
u,
u),
...
_){
if(p){
if(typeof p=="string")return g(p,
_);
var A=Object.prototype.toString.call(p).slice(8,
-1);
return A==="Object"&&p.constructor&&(A=p.constructor.name),
A==="Map"||A==="Set"?Array.from(p):A==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)?g(p,
_):void 0
}
...
function x(h,
p){
return x=Object.setPrototypeOf||function(_,
A){
return _.__proto__=A,
_
}
,
x(h,
...
if(p!==void 0)throw new Type错误("Derived constructors may only return object or undefined");
return function(_){
if(_===void 0)throw new Reference错误("this hasn't been initialised - super() hasn't been called");
return _
}
(h)
}
...
(function(f,
O){
if(typeof O!="function"&&O!==null)throw new Type错误("Super expression must either be null or a function");
...
return(C?f.keyCode===38:f.keyCode===37)?(f.preventDefault(),
this._left(O)):(C?f.keyCode===40:f.keyCode===39)?(f.preventDefault(),
this._right(O)):f.keyCode===36?(f.preventDefault(),
this._start(O)):f.keyCode===35?(f.preventDefault(),
this._end(O)):void 0
}
...
function(O){
var C=O.target.closest(f.selector);
C&&f.getClassProperty(C,
"--trigger")==="focus"&&f._focus(C),
C&&f.getClassProperty(C,
"--trigger")==="click"&&f._click(C)
}
),
document.addEventListener("mousemove",
function(O){
var C=O.target.closest(f.selector);
C&&f.getClassProperty(C,
"--trigger")!=="focus"&&f.getClassProperty(C,
"--trigger")!=="click"&&f._hover(C)
}
)
}
...
function R(q){
q.relatedTarget.closest(O.selector)&&q.relatedTarget.closest(O.selector)==f||(O.hide(f),
...
value:function(f){
var O=this;
f.querySelector(".hs-tooltip-content").classList.remove("hidden"),
setTimeout(function(){
f.classList.add("show"),
O._fireEvent("show",
f),
O._dispatch("show.hs.tooltip",
f,
f)
}
)
...
f),
this._dispatch("hide.hs.tooltip",
f,
f),
...
(function(m,
h){
if(!(m instanceof h))throw new Type错误("Cannot call a class as a function")
}
)(this,
g),
this.$collection=[],
...
null).getPropertyValue("transition")!=="all 0s ease 0s"?D.addEventListener("transitionend",
function m(){
L(),
D.removeEventListener("transitionend",
m,
!0)
}
,
...
$=b.offsetWidth,
H=b.offsetHeight;
return Math.abs(y.width-$)<=1&&($=y.width),
...
return["html",
"body",
"#document"].indexOf(p(b))>=0?b.ownerDocument.body:g(b)&&T(b)?b:C(O(b))
}
function S(b,
y){
var $;
...
var V=P(Q);
if(V.transform!=="none"||V.perspective!=="none"||V.contain==="paint"||["transform",
"perspective"].indexOf(V.willChange)!==-1||z&&V.willChange==="filter"||z&&V.filter&&V.filter!=="none")return Q;
Q=Q.parentNode
}
return null
}
...
lt="viewport",
me="popper",
it=Ae.reduce(function(b,
y){
return b.concat([y+"-"+De,
y+"-"+Ve])
}
,
[]),
ze=[].concat(Ae,
[Ye]).reduce(function(b,
y){
return b.concat([y,
y+"-"+De,
y+"-"+Ve])
...
$.add(Q.name),
[].concat(Q.requires||[],
Q.requiresIfExists||[]).forEach(function(V){
if(!$.has(V)){
var W=y.get(V);
W&&z(W)
}
...
((ve=[].concat(H,
ee.options.modifiers),
fe=ve.reduce(function(ce,
ue){
var de=ce[ue.name];
return ce[ue.name]=de?Object.assign({
...
switch(V){
case De:y[te]=y[te]-($[ne]/2-H[ne]/2);
break;
case Ve:y[te]=y[te]+($[ne]/2-H[ne]/2)
}
...
de="clientHeight",
ge="clientWidth";
ue===a($)&&P(ue=_($)).position!=="static"&&W==="absolute"&&(de="scrollHeight",
ge="scrollWidth"),
ue=ue,
(z===B||(z===re||z===ie)&&Q===Ve)&&(ye=N,
pe-=(ee&&ce.visualViewport?ce.visualViewport.height:ue[de])-H.height,
pe*=K?1:-1),
z!==re&&(z!==B&&z!==N||Q!==Ve)||(fe=ie,
ae-=(ee&&ce.visualViewport?ce.visualViewport.width:ue[ge])-H.width,
ae*=K?1:-1)
}
var be,
Me=Object.assign({
...
be[fe]=Ce?"0":"",
be.transform=(ce.devicePixelRatio||1)<=1?"translate("+ae+"px,
 "+pe+"px)":"translate3d("+ae+"px,
 "+pe+"px,
 0)",
be)):Object.assign({
...
;
function Rt(b){
return b.replace(/left|right|bottom|top/g,
function(y){
return gt[y]
}
)
...
return Q&&(V=Q.width,
W=Q.height,
/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(K=Q.offsetLeft,
te=Q.offsetTop)),
{
width:V,
height:W,
...
te=-Q.scrollLeft+A($),
ne=-Q.scrollTop;
return P(V||z).direction==="rtl"&&(te+=x(z.clientWidth,
V?V.clientWidth:0)-W),
{
width:W,
height:K,
...
ae=$.padding,
he=ae===void 0?0:ae,
pe=dn(typeof he!="number"?he:pn(he,
Ae)),
...
var ut=S(O(ke)),
Fe=["absolute",
"fixed"].indexOf(P(ke).position)>=0&&g(ke)?q(ke):ke;
...
[Ke]),
Ie=We[0],
qe=We.reduce(function(ke,
ut){
var Fe=fn(Re,
ut);
return ke.top=x(Fe.top,
ke.top),
ke.right=D(Fe.right,
ke.right),
ke.bottom=D(Fe.bottom,
ke.bottom),
ke.left=x(Fe.left,
ke.left),
ke
...
fn(Re,
Ie));
return qe.width=qe.right-qe.left,
...
te=[].concat(y.scrollParents.reference,
...
W&&K.addEventListener("resize",
$.update,
Pe),
function(){
Q&&te.forEach(function(ne){
ne.removeEventListener("scroll",
$.update,
Pe)
}
),
W&&K.removeEventListener("resize",
$.update,
Pe)
}
...
;
y.modifiersData.popperOffsets!=null&&(y.styles.popper=Object.assign({
...
y.modifiersData.arrow!=null&&(y.styles.arrow=Object.assign({
...
,
Q=y.elements[$];
g(Q)&&p(Q)&&(Object.assign(Q.style,
H),
Object.keys(z).forEach(function(V){
var W=z[V];
W===!1?Q.removeAttribute(V):Q.setAttribute(V,
W===!0?"":W)
}
))
}
...
;
return Object.assign(y.elements.popper.style,
$.popper),
y.styles=$,
y.elements.arrow&&Object.assign(y.elements.arrow.style,
$.arrow),
function(){
...
,
V=Object.keys(y.styles.hasOwnProperty(H)?y.styles[H]:$[H]).reduce(function(W,
K){
return W[K]="",
W
}
...
Q=z===void 0?[0,
0]:z,
V=ze.reduce(function(ne,
ee){
return ne[ee]=function(Ee,
ae,
he){
var pe=Be(Ee),
le=[re,
B].indexOf(pe)>=0?-1:1,
Ce=typeof he=="function"?he(Object.assign({
...
K=W.x,
te=W.y;
y.modifiersData.popperOffsets!=null&&(y.modifiersData.popperOffsets.x+=K,
...
(le):[Rt(le)]),
fe=[le].concat(ve).reduce(function(Ge,
Xe){
return Ge.concat(Be(Xe)===Ye?function(vt,
ft){
ft===void 0&&(ft={
...
return Object.keys(xt).sort(function(rt,
ht){
return xt[rt]-xt[ht]
}
)
...
var ft=ue.get(vt);
if(ft)return ft.slice(0,
Ge).every(function(et){
return et
}
)
}
...
Fe>0&&ut(Fe)!=="break";
Fe--);
y.placement!==ge&&(y.modifiersData[H]._skip=!0,
y.placement=ge,
y.reset=!0)
}
...
ge=y.rects.popper,
be=typeof pe=="function"?pe(Object.assign({
...
K=Le(W),
te=[re,
ie].indexOf(W)>=0?"height":"width";
if(Q&&V){
var ne=function(ge,
be){
return dn(typeof(ge=typeof ge=="function"?ge(Object.assign({
...
H!=null&&(typeof H!="string"||(H=y.elements.popper.querySelector(H)))&&un(y.elements.popper,
H)&&(y.elements.arrow=H)
}
,
requires:["popperOffsets"],
...
,
o.o=(s,
l)=>Object.prototype.hasOwnProperty.call(s,
l),
o.r=s=>{
typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(s,
Symbol.toStringTag,
{
value:"Module"
}
...
c(){
e=E("div"),
e.innerHTML='<h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">欢迎使用 <span class="nav-title">Lingua_SQL.AI</span></h1> <p class="mt-3 text-gray-600 dark:text-gray-400">你的AI驱动的SQL查询助手</p>',
v(e,
"class",
...
t=E("div"),
o=E("span"),
o.innerHTML='<span class="text-sm font-medium text-white leading-none">You</span>',
i=Z(),
s=E("div"),
J(l.$$.fragment),
c=Z(),
...
v(t,
"class",
"max-w-2xl flex gap-x-2 sm:gap-x-4"),
v(n,
"class",
"max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto"),
v(e,
"class",
"py-2 sm:py-4")
}
...
c&&c.c(),
or(n.src,
t="/static/Lingua_sql.png")||v(n,
"src",
t),
v(n,
"class",
"flex-shrink-0 w-[2.375rem] h-[2.375rem] "),
v(n,
"alt",
"agent logo"),
v(i,
"class",
"space-y-3 overflow-x-auto overflow-y-hidden"),
v(e,
"class",
...
p(k,
[x]){
x&1&&g!==(g="/api/v0/download_csv?id="+k[0])&&v(s,
"href",
g)
}
,
...
15)+Math.random().toString(36).substring(2,
15);
return sr(()=>{
Plotly.newPlot(document.getElementById(i),
o,
{
responsive:!0
}
...
v(s,
"class",
"text-sm text-yellow-800 font-semibold"),
v(c,
"class",
...
p(t,
o){
o&4&&e!==(e=JSON.stringify(t[15])+"")&&Ue(n,
e)
}
,
d(t){
...
p(o,
i){
o[12].type==="question_cache"?t?(t.p(o,
i),
i&4&&M(t,
1)):(t=Gn(o),
t.c(),
...
p(u,
[f]){
if(u[1]&&u[1].type=="question_list"&&!u[7]?L?(L.p(u,
f),
f&130&&M(L,
1)):(L=Bn(u),
L.c(),
...
return r.$$set=L=>{
"suggestedQuestions"in L&&n(1,
t=L.suggestedQuestions),
"messageLog"in L&&n(2,
o=L.messageLog),
"newQuestion"in L&&n(3,
i=L.newQuestion),
"rerunSql"in L&&n(4,
s=L.rerunSql),
"clearMessages"in L&&n(5,
l=L.clearMessages),
"onUpdateSql"in L&&n(6,
c=L.onUpdateSql),
"question_asked"in L&&n(7,
a=L.question_asked),
"marked_correct"in L&&n(0,
d=L.marked_correct),
"thinking"in L&&n(8,
g=L.thinking)
}
...
n){
const t=r.slice();
return t[10]=e[n].name,
t[11]=e[n].description,
t[12]=e[n].example,
t
}
function Wn(r){
...
v(t,
"aria-describedby",
"hs-radio-delete-description"),
v(n,
"class",
"flex items-center h-5 mt-1"),
v(s,
"class",
"block text-sm font-semibold text-gray-800 dark:text-gray-300"),
v(c,
"id",
"hs-radio-ddl-description"),
v(c,
"class",
"block text-sm text-gray-600 dark:text-gray-500"),
v(i,
"for",
"hs-radio-"+r[10]),
v(i,
...
o=E("div"),
i=E("h2"),
i.textContent="Add 训练数据",
s=Z(),
l=E("button"),
l.innerHTML='<span class="sr-only">Close</span> <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"></path></svg>',
c=Z(),
a=E("span"),
a.textContent="训练数据 Type",
d=Z(),
g=E("div");
for(let R=0;
R<S.length;
...
v(D,
"for",
"hs-feedback-post-comment-textarea-1"),
v(D,
"class",
"block mt-2 mb-2 text-sm font-medium dark:text-white"),
v(_,
"id",
"hs-feedback-post-comment-textarea-1"),
v(_,
...
v(_,
"placeholder",
A=((j=r[3].find(r[8]))==null?void 0:j.example)??"No example available"),
v(p,
"class",
"mt-1"),
v(x,
"class",
"mt-2 border-t dark:border-gray-700"),
v(u,
"class",
...
R&1&&Ue(m,
r[0]),
R&1&&A!==(A=((q=r[3].find(r[8]))==null?void 0:q.example)??"No example available")&&v(_,
"placeholder",
A),
R&4&&bt(_,
r[2])
...
example:"CREATE TABLE table_name (column_1 datatype,
 column_2 datatype,
 column_3 datatype);
"
}
...
"onTrain"in x&&n(5,
o=x.onTrain),
"selectedTrainingDataType"in x&&n(0,
i=x.selectedTrainingDataType)
}
,
[i,
t,
...
l=E("div"),
c=E("div"),
c.innerHTML='<h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">训练数据</h2> <p class="text-sm text-gray-600 dark:text-gray-400">Add or remove training data. Good training data is the key to accuracy.</p>',
a=Z(),
d=E("div"),
g=E("div"),
k=E("button"),
...
(!at||He&4)&&j!==(j=X[2]+1+"")&&Ue(R,
j),
(!at||He&8)&&B!==(B=Math.min(X[3],
X[7].length)+"")&&Ue(N,
B),
X[5]!=null?Le?(Le.p(X,
He),
...
"onTrain"in f&&n(0,
o=f.onTrain),
"removeTrainingData"in f&&n(1,
i=f.removeTrainingData)
}
,
r.$$.update=()=>{
r.$$.dirty&98304&&n(2,
...
=e;
return r.$$set=s=>{
"trainingData"in s&&n(0,
t=s.trainingData),
"removeTrainingData"in s&&n(1,
o=s.removeTrainingData),
"onTrain"in s&&n(2,
i=s.onTrain)
}
,
...
;
return r[4]!==void 0&&(a.question_asked=r[4]),
...
!n&&g&16&&(n=!0,
k.question_asked=d[4],
nn(()=>n=!1)),
!t&&g&32&&(t=!0,
k.thinking=d[5],
nn(()=>t=!1)),
!o&&g&1&&(o=!0,
k.marked_correct=d[0],
nn(()=>o=!1)),
e.$set(k)
}
,
...
sr(async()=>{
D(),
new URL(window.location.href).hash.slice(1)==="training-data"?L():m()
}
);
let t=[],
o=null,
...
B.type==="sql"&&(window.location.hash=B.id,
f("run_sql",
"GET",
{
id:B.id
...
N.type==="df"&&f("generate_plotly_figure",
"GET",
{
id:N.id
}
).then(_).then(ie=>{
ie.type==="plotly_figure"&&(n(7,
d=[...d,
{
question:q,
id:ie.id
...
B.type==="df"&&f("generate_plotly_figure",
"GET",
{
id:B.id
}
).then(_).then(N=>{
N.type==="plotly_figure"&&f("generate_followup_questions",
"GET",
{
id:N.id
}
...
function T(q){
return q.type==="question_history"&&n(7,
d=q.questions),
q
}
function u(q,
...
"POST",
N).then(A).then(ie=>{
ie.type!=="error"&&f("get_training_data",
"GET",
[]).then(A)
}
)
...
let ie="",
re;
if(B==="GET")ie=Object.entries(N).filter(([Ae,
De])=>Ae!=="endpoint"&&Ae!=="addMessage").map(([Ae,
De])=>`${
...
if(!re.ok)throw new 错误("The server returned an error. See the server logs for more details.");
...
N),
n(1,
t=t.filter(ie=>ie.type!=="user_sql")),
_({
type:"sql",
text:q,
