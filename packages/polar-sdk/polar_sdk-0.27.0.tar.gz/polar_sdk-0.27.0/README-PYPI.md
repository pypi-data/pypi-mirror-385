...
* [get_balance](https://github.com/polarsource/polar-python/blob/master/docs/sdks/customers/README.md#get_balance) - Get Customer Balance
...
### [metrics](https://github.com/polarsource/polar-python/blob/master/docs/sdks/metrics/README.md)

* [get](https://github.com/polarsource/polar-python/blob/master/docs/sdks/metrics/README.md#get) - Get Metrics
* [limits](https://github.com/polarsource/polar-python/blob/master/docs/sdks/metrics/README.md#limits) - Get Metrics Limits
...
* [`PolarExceptionsResourceNotFound`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsresourcenotfound.py): Status code `404`. Applicable to 77 of 142 methods.*
* [`PolarExceptionsNotPermitted`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsnotpermitted.py): Status code `403`. Applicable to 10 of 142 methods.*
* [`Unauthorized`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/unauthorized.py): Not authorized to manage license key. Status code `401`. Applicable to 5 of 142 methods.*
* [`PolarExceptionsAlreadyCanceledSubscription`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsalreadycanceledsubscription.py): Status code `403`. Applicable to 4 of 142 methods.*
* [`AlreadyActiveSubscriptionError`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/alreadyactivesubscriptionerror.py): The checkout is expired, the customer already has an active subscription, or the organization is not ready to accept payments. Status code `403`. Applicable to 3 of 142 methods.*
* [`NotOpenCheckout`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/notopencheckout.py): The checkout is expired, the customer already has an active subscription, or the organization is not ready to accept payments. Status code `403`. Applicable to 3 of 142 methods.*
* [`PaymentNotReady`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/paymentnotready.py): The checkout is expired, the customer already has an active subscription, or the organization is not ready to accept payments. Status code `403`. Applicable to 3 of 142 methods.*
* [`ExpiredCheckoutError`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/expiredcheckouterror.py): The checkout session is expired. Status code `410`. Applicable to 3 of 142 methods.*
* [`PolarExceptionsSubscriptionLocked`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionssubscriptionlocked.py): Subscription is pending an update. Status code `409`. Applicable to 2 of 142 methods.*
* [`PolarExceptionsInvoiceAlreadyExists`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsinvoicealreadyexists.py): Order already has an invoice. Status code `409`. Applicable to 2 of 142 methods.*
* [`PolarExceptionsMissingInvoiceBillingDetails`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsmissinginvoicebillingdetails.py): Order is not paid or is missing billing name or address. Status code `422`. Applicable to 2 of 142 methods.*
* [`PolarExceptionsNotPaidOrder`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/polarexceptionsnotpaidorder.py): Order is not paid or is missing billing name or address. Status code `422`. Applicable to 2 of 142 methods.*
* [`RefundAmountTooHigh`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/refundamounttoohigh.py): Refund amount exceeds remaining order balance. Status code `400`. Applicable to 1 of 142 methods.*
* [`PaymentError`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/paymenterror.py): The payment failed. Status code `400`. Applicable to 1 of 142 methods.*
* [`CustomerNotReady`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/customernotready.py): Customer is not ready to confirm a payment method. Status code `400`. Applicable to 1 of 142 methods.*
* [`PaymentMethodInUseByActiveSubscription`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/paymentmethodinusebyactivesubscription.py): Payment method is used by active subscription(s). Status code `400`. Applicable to 1 of 142 methods.*
* [`RefundedAlready`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/refundedalready.py): Order is already fully refunded. Status code `403`. Applicable to 1 of 142 methods.*
* [`PaymentAlreadyInProgress`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/paymentalreadyinprogress.py): Payment already in progress. Status code `409`. Applicable to 1 of 142 methods.*
* [`OrderNotEligibleForRetry`](https://github.com/polarsource/polar-python/blob/master/./src/polar_sdk/models/ordernoteligibleforretry.py): Order not eligible for retry or payment confirmation failed. Status code `422`. Applicable to 1 of 142 methods.*
