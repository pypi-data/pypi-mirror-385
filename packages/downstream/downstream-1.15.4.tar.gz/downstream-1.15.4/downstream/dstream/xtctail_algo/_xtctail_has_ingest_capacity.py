from ._xtctail_get_ingest_capacity import xtctail_get_ingest_capacity


def xtctail_has_ingest_capacity(S: int, T: int) -> bool:
    ...
    """
    assert T >= 0
    ingest_capacity = xtctail_get_ingest_capacity(S)
    return ingest_capacity is None or T < ingest_capacity


has_ingest_capacity = xtctail_has_ingest_capacity  # lazy loader workaround
