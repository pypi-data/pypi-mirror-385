from ._sticky_get_ingest_capacity import sticky_get_ingest_capacity


def sticky_has_ingest_capacity(S: int, T: int) -> bool:
    ...
    """
    assert T >= 0
    ingest_capacity = sticky_get_ingest_capacity(S)
    return ingest_capacity is None or T < ingest_capacity


has_ingest_capacity = sticky_has_ingest_capacity  # lazy loader workaround
