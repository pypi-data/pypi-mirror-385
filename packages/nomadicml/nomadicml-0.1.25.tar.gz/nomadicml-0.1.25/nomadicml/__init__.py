...
__version__ = "0.1.25"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "2cfab1f"      # This will hold the commit hash or full build string, populated by CI
