...
class VertexaiMemoryConfig(BaseModel):
    ...
    @classmethod  # Keep classmethod for access to cls if needed (though not strictly for this validator)
    def validate_not_empty(
        cls, v: str, info: FieldValidationInfo
    ) -> str:  # Added info: FieldValidationInfo
        ...
        if not v or not v.strip():
            ...
            # Access field name from info object in Pydantic v2
