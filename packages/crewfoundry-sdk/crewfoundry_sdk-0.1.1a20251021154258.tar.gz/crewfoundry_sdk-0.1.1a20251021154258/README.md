# Crewfoundry Sdk-python

A Python SDK crewfoundry for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from crewfoundry_sdk import BoilerSDK, BoilerSDKConfig
from crewfoundry_sdk.types.common import UserRegisterInput
...
```python
from crewfoundry_sdk import BoilerSDKConfig
...
pytest --cov=crewfoundry_sdk --cov-report=html
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/crewfoundry-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/crewfoundry-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../crewfoundry-frontend) - Frontend crewfoundry
- [Boiler Backend](../crewfoundry-python-be-graphql) - Python GraphQL backend crewfoundry