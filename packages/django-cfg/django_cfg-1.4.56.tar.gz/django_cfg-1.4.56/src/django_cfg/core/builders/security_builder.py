...
class SecurityBuilder:
    ...
    def _get_localhost_csrf_origins(self) -> List[str]:
        ...
        Include extended list to cover Docker, frontend frameworks, and backends.

        Returns:
            List of localhost origins with common ports for CSRF
        """
        # Extended list of common development ports
        dev_ports = [
            # Frontend frameworks
            ...
            5000,              # Flask
            4000,              # Express
            # Docker exposed ports (Django-CFG specific)
            7301, 7310, 7311, 7320, 7321, 7330, 7331,
        ]
