...
from django_cfg.modules.django_admin.models import DateTimeDisplayConfig, MoneyDisplayConfig, StatusBadgeConfig
...
document_archive_config = AdminConfig(
    ...
    list_filter=['processing_status', 'archive_type', 'is_public', 'created_at', 'processed_at'],
...
class DocumentArchiveAdmin(PydanticAdmin):
    ...
    - Custom actions for visibility and reprocessing
    """
    ...
    fieldsets = [
        ...
        FieldsetConfig(
            ...
            fields=['processing_status', 'processed_at', 'processing_duration_ms', 'processing_error']
        ),
        FieldsetConfig(
            title="Statistics",
    ...
    reprocess_archives.short_description = "Reprocess archives"
...
archive_item_config = AdminConfig(
    ...
    list_filter=['content_type', 'is_processable', 'created_at'],
...
class ArchiveItemAdmin(PydanticAdmin):
    ...
    mark_as_processable.short_description = "Mark as processable"
    ...
    mark_as_not_processable.short_description = "Mark as not processable"
