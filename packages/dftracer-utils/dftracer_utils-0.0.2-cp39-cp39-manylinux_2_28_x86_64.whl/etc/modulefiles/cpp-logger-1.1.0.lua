...
-- CMAKE_INSTALL_PREFIX: /var/tmp/haridev/tmpjffztcsw/wheel/platlib
...
help(
[[
CPP Logger (CPP_LOGGER) version (0, 0, 6).
]])
...
whatis("CMAKE_INSTALL_PREFIX: /var/tmp/haridev/tmpjffztcsw/wheel/platlib")
...
prepend_path("PATH","/var/tmp/haridev/tmpjffztcsw/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/var/tmp/haridev/tmpjffztcsw/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/var/tmp/haridev/tmpjffztcsw/wheel/platlib/")
