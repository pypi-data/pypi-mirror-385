...
-- CMAKE_INSTALL_PREFIX: /tmp/tmphyaiz79y/wheel/platlib
...
whatis("CMAKE_INSTALL_PREFIX: /tmp/tmphyaiz79y/wheel/platlib")
...
prepend_path("PATH","/tmp/tmphyaiz79y/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/tmp/tmphyaiz79y/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/tmp/tmphyaiz79y/wheel/platlib/")
