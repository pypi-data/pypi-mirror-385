...
-- CMAKE_INSTALL_PREFIX: /tmp/tmpbe0q7ftk/wheel/platlib
...
whatis("CMAKE_INSTALL_PREFIX: /tmp/tmpbe0q7ftk/wheel/platlib")
whatis("CMAKE_BUILD_TYPE: Release")
whatis("C Compiler: /usr/bin/gcc")
...
prepend_path("PATH","/tmp/tmpbe0q7ftk/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/tmp/tmpbe0q7ftk/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/tmp/tmpbe0q7ftk/wheel/platlib/")
