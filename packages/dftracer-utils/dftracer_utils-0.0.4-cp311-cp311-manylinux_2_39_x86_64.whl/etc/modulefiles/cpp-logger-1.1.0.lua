...
-- CMAKE_INSTALL_PREFIX: /tmp/tmps23y3hwq/wheel/platlib
...
whatis("CMAKE_INSTALL_PREFIX: /tmp/tmps23y3hwq/wheel/platlib")
...
prepend_path("PATH","/tmp/tmps23y3hwq/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/tmp/tmps23y3hwq/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/tmp/tmps23y3hwq/wheel/platlib/")
