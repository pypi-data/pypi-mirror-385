...
-- CMAKE_INSTALL_PREFIX: /tmp/tmp6yvkhpfh/wheel/platlib
...
whatis("CMAKE_INSTALL_PREFIX: /tmp/tmp6yvkhpfh/wheel/platlib")
...
prepend_path("PATH","/tmp/tmp6yvkhpfh/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/tmp/tmp6yvkhpfh/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/tmp/tmp6yvkhpfh/wheel/platlib/")
