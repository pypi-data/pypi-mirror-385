...
-- CMAKE_INSTALL_PREFIX: /tmp/tmpad8fro7u/wheel/platlib
...
whatis("CMAKE_INSTALL_PREFIX: /tmp/tmpad8fro7u/wheel/platlib")
...
prepend_path("PATH","/tmp/tmpad8fro7u/wheel/platlib/dftracer/bin")
prepend_path("LD_LIBRARY_PATH","/tmp/tmpad8fro7u/wheel/platlib/dftracer/lib")

pushenv("CPP_LOGGER_DIR","/tmp/tmpad8fro7u/wheel/platlib/")
