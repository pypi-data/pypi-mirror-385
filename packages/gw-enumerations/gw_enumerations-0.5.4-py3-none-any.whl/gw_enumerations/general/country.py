...
class Country(SmartEnum):
    """
    Country Enumeration Class

    This class represents an enumeration of countries, each defined by a unique 
    two-letter ISO 3166-1 alpha-2 country code and its corresponding name.
    """
