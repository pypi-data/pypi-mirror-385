...
else: _import_structure["modeling_donut_swin"] = ["DonutSwinModel", "DonutSwinPreTrainedModel"]
try:
...
if TYPE_CHECKING:
    ...
    else: from .modeling_donut_swin import (DonutSwinModel, DonutSwinPreTrainedModel)
    try:
        if not is_vision_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: pass
    else:
