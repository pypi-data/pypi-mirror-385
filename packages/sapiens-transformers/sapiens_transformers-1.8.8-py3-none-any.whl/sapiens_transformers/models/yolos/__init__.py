...
else: _import_structure["modeling_yolos"] = ["YolosForObjectDetection", "YolosModel", "YolosPreTrainedModel"]
if TYPE_CHECKING:
    ...
    else: from .modeling_yolos import (YolosForObjectDetection, YolosModel, YolosPreTrainedModel)
else:
    import sys
