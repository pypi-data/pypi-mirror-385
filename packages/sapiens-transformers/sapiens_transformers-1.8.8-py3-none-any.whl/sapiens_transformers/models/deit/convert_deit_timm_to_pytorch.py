...
from sapiens_transformers import DeiTConfig, DeiTForImageClassificationWithTeacher, DeiTImageProcessor
...
def create_rename_keys(config, base_model=False):
    ...
    rename_keys.extend([("cls_token", "deit.embeddings.cls_token"), ("dist_token", "deit.embeddings.distillation_token"), ("patch_embed.proj.weight", "deit.embeddings.patch_embeddings.projection.weight"),
    ("patch_embed.proj.bias", "deit.embeddings.patch_embeddings.projection.bias"), ("pos_embed", "deit.embeddings.position_embeddings")])
    if base_model:
        ...
        rename_keys.extend([("norm.weight", "deit.layernorm.weight"), ("norm.bias", "deit.layernorm.bias"), ("head.weight", "cls_classifier.weight"),
        ("head.bias", "cls_classifier.bias"), ("head_dist.weight", "distillation_classifier.weight"), ("head_dist.bias", "distillation_classifier.bias")])
    return rename_keys
...
def convert_deit_checkpoint(deit_name, pytorch_dump_folder_path):
    ...
    if deit_name[9:].startswith("base"): pass
