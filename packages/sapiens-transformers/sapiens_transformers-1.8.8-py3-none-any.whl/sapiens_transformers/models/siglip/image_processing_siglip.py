...
class SiglipImageProcessor(BaseImageProcessor):
    ...
    do_convert_rgb: bool = None, **kwargs) -> None:
    ...
    def preprocess(self, images: ImageInput, do_resize: bool = None, size: Dict[str, int] = None, resample: PILImageResampling = None, do_rescale: bool = None,
    ...
    return_tensors: Optional[Union[str, TensorType]] = None, data_format: Optional[ChannelDimension] = ChannelDimension.FIRST, input_data_format: Optional[Union[str, ChannelDimension]] = None,
    do_convert_rgb: bool = None) -> PIL.Image.Image:
