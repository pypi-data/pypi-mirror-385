...
else: _import_structure["modeling_deformable_detr"] = ["DeformableDetrForObjectDetection", "DeformableDetrModel", "DeformableDetrPreTrainedModel"]
if TYPE_CHECKING:
    ...
    else: from .modeling_deformable_detr import (DeformableDetrForObjectDetection, DeformableDetrModel, DeformableDetrPreTrainedModel)
else:
    import sys
