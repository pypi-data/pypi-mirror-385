...
from sapiens_transformers import DetaConfig, DetaForObjectDetection, DetaImageProcessor, SwinConfig
...
def convert_deta_checkpoint(model_name, pytorch_dump_folder_path, push_to_hub):
    ...
    if model_name == "deta-swin-large": checkpoint_path = hf_hub_download(repo_id="nielsr/deta-checkpoints", filename="adet_swin_ft.pth")
    elif model_name == "deta-swin-large-o365": checkpoint_path = hf_hub_download(repo_id="jozhang97/deta-swin-l-o365", filename="deta_swin_pt_o365.pth")
    ...
    if model_name == "deta-swin-large":
        ...
        expected_logits = torch.tensor([[-8.0122, -3.5720, -4.9717], [-8.1547, -3.6886, -4.6389], [-7.6610, -3.6194, -5.0134]])
