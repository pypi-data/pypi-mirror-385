...
class CogVideoXDDIMScheduler(SchedulerMixin, ConfigMixin):
    ...
    List[float]]]=None, clip_sample: bool=True, set_alpha_to_one: bool=True, steps_offset: int=0, prediction_type: str='epsilon', clip_sample_range: float=1.0, sample_max_value: float=1.0,
    timestep_spacing: str='leading', rescale_betas_zero_snr: bool=False, snr_shift_scale: float=3.0):
    ...
    variance_noise: Optional[torch.Tensor]=None, return_dict: bool=True) -> Union[DDIMSchedulerOutput, Tuple]:
        """Returns:"""
