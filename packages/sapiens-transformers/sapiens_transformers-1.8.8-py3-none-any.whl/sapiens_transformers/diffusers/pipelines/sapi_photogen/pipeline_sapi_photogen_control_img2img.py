...
class SAPIPhotoGenControlImg2ImgPipeline(DiffusionPipeline, SAPIPhotoGenLoraLoaderMixin, FromSingleFileMixin):
    """Args:"""
    ...
    callback_on_step_end_tensor_inputs: List[str]=['latents'], max_sequence_length: int=512):
        ...
        latents, latent_image_ids = self.prepare_latents(init_image, latent_timestep, batch_size * num_images_per_prompt, num_channels_latents,
