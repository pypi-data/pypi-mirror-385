...
_dummy_objects = {}
_import_structure = {'timesteps': ['fast27_timesteps', 'smart100_timesteps', 'smart185_timesteps', 'smart27_timesteps', 'smart50_timesteps', 'super100_timesteps', 'super27_timesteps', 'super40_timesteps']}
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .timesteps import fast27_timesteps, smart27_timesteps, smart50_timesteps, smart100_timesteps, smart185_timesteps, super27_timesteps, super40_timesteps, super100_timesteps
