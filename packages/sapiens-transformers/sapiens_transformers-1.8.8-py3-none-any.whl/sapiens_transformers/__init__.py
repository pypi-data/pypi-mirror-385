...
"""
__version__ = "1.0.0"
from .utils import (OptionalDependencyNotAvailable, _LazyModule, is_sapiens_machine_available, is_essentia_available, is_flax_available, is_g2p_en_available, is_keras_nlp_available,
is_librosa_available, is_pretty_midi_available, is_scipy_available, is_sentencepiece_available, is_speech_available, is_tensorflow_text_available, is_tf_available, is_timm_available,
...
try:
    ...
    _import_structure["models.entity"].append("EntityTokenizer")
    ...
    _import_structure["models.sapama"].append("SapamaTokenizer")
...
try:
    ...
    _import_structure["models.entity"].append("EntityTokenizerFast")
    ...
    _import_structure["models.sapama"].append("SapamaTokenizerFast")
    _import_structure["models.sapi_audio"].append("SAPIAudioTokenizerFast")
    _import_structure["models.sapiens"].append("SapiensTokenizerFast")
...
try:
    if not (is_sentencepiece_available() and is_tokenizers_available()): raise OptionalDependencyNotAvailable()
except OptionalDependencyNotAvailable:
...
else: _import_structure["convert_slow_tokenizer"] = ["SLOW_TO_FAST_CONVERTERS", "convert_slow_tokenizer"]
try:
...
else: _import_structure["models.bert"].append("TFBertTokenizer")
try:
...
else: _import_structure["models.gpt2"].append("TFGPT2Tokenizer")
try:
    ...
    _import_structure["models.hurlm"].extend(["HurLMImageProcessor"])
    ...
    _import_structure["models.modular_entity"].extend(["ModularEntityImageProcessor"])
    ...
    _import_structure["models.sapi_image"].append("SAPIImageImageProcessor")
    _import_structure["models.sapi_video"].append("SAPIVideoImageProcessor")
    _import_structure["models.sapiens_vision"].extend(["SapiensVisionImageProcessor"])
...
try:
    ...
    _import_structure["data.datasets"] = ["GlueDataset", "GlueDataTrainingArguments", "LineByLineTextDataset", "LineByLineWithRefDataset", "LineByLineWithSOPTextDataset", "SAPIAudioTimeStampLogitsProcessor", "SquadDataset", "SquadDataTrainingArguments", "TextDataset", "TextDatasetForNextSentencePrediction"]
    _import_structure["generation"].extend(["AlternatingCodebooksLogitsProcessor", "BeamScorer", "BeamSearchScorer", "ClassifierFreeGuidanceLogitsProcessor", "ConstrainedBeamSearchScorer", "Constraint", "ConstraintListState", "DisjunctiveConstraint", "EncoderNoRepeatNGramLogitsProcessor", "EncoderRepetitionPenaltyLogitsProcessor", "EosTokenCriteria", "EpsilonLogitsWarper",
    ...
    "TopKLogitsWarper", "TopPLogitsWarper", "TypicalLogitsWarper", "UnbatchedClassifierFreeGuidanceLogitsProcessor", "WatermarkDetector", "WatermarkLogitsProcessor", "WhisperTimeStampLogitsProcessor"])
    ...
    "MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING", "MODEL_FOR_IMAGE_MAPPING", "MODEL_FOR_IMAGE_SEGMENTATION_MAPPING", "MODEL_FOR_IMAGE_TO_IMAGE_MAPPING", "MODEL_FOR_INSTANCE_SEGMENTATION_MAPPING", "MODEL_FOR_KEYPOINT_DETECTION_MAPPING", "MODEL_FOR_MASKED_IMAGE_MODELING_MAPPING", "MODEL_FOR_MASKED_LM_MAPPING", "MODEL_FOR_MASK_GENERATION_MAPPING", "MODEL_FOR_MULTIPLE_CHOICE_MAPPING",
    "MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING", "MODEL_FOR_OBJECT_DETECTION_MAPPING", "MODEL_FOR_PRETRAINING_MAPPING", "MODEL_FOR_QUESTION_ANSWERING_MAPPING", "MODEL_FOR_SEMANTIC_SEGMENTATION_MAPPING", "MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING", "MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING", "MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING", "MODEL_FOR_TABLE_QUESTION_ANSWERING_MAPPING",
    "MODEL_FOR_TEXT_ENCODING_MAPPING", "MODEL_FOR_TEXT_TO_SPECTROGRAM_MAPPING", "MODEL_FOR_TEXT_TO_WAVEFORM_MAPPING", "MODEL_FOR_TIME_SERIES_CLASSIFICATION_MAPPING", "MODEL_FOR_TIME_SERIES_REGRESSION_MAPPING", "MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING", "MODEL_FOR_UNIVERSAL_SEGMENTATION_MAPPING", "MODEL_FOR_VIDEO_CLASSIFICATION_MAPPING", "MODEL_FOR_VISION_2_SEQ_MAPPING",
    "MODEL_FOR_VISUAL_QUESTION_ANSWERING_MAPPING", "MODEL_FOR_ZERO_SHOT_IMAGE_CLASSIFICATION_MAPPING", "MODEL_FOR_ZERO_SHOT_OBJECT_DETECTION_MAPPING", "MODEL_MAPPING", "MODEL_WITH_LM_HEAD_MAPPING", "AutoBackbone", "AutoModel", "AutoModelForAudioClassification", "AutoModelForAudioFrameClassification", "AutoModelForAudioXVector", "AutoModelForCausalLM", "AutoModelForCTC",
    "AutoModelForDepthEstimation", "AutoModelForDocumentQuestionAnswering", "AutoModelForImageClassification", "AutoModelForImageSegmentation", "AutoModelForImageToImage", "AutoModelForInstanceSegmentation", "AutoModelForKeypointDetection", "AutoModelForMaskedImageModeling", "AutoModelForMaskedLM", "AutoModelForMaskGeneration", "AutoModelForMultipleChoice", "AutoModelForNextSentencePrediction",
    ...
    "AutoModelForUniversalSegmentation", "AutoModelForVideoClassification", "AutoModelForVision2Seq", "AutoModelForVisualQuestionAnswering", "AutoModelForZeroShotImageClassification", "AutoModelForZeroShotObjectDetection", "AutoModelWithLMHead"])
    ...
    _import_structure["models.data2vec"].extend(["Data2VecAudioForAudioFrameClassification", "Data2VecAudioForCTC", "Data2VecAudioForSequenceClassification", "Data2VecAudioForXVector", "Data2VecAudioModel", "Data2VecAudioPreTrainedModel", "Data2VecTextForCausalLM", "Data2VecTextForMaskedLM",
    ...
    _import_structure["models.entity"].extend(["EntityForCausalLM", "EntityForQuestionAnswering", "EntityForSequenceClassification", "EntityForTokenClassification", "EntityModel", "EntityPreTrainedModel"])
    ...
    _import_structure["models.granitemoe"].extend(["GraniteMoeForCausalLM", "GraniteMoeModel", "GraniteMoePreTrainedModel"])
    ...
    _import_structure["models.hurlm"].extend(["HurLMForConditionalGeneration", "HurLMModel", "HurLMPreTrainedModel", "HurLMProcessor"])
    ...
    _import_structure["models.megatron_bert"].extend(["MegatronBertForCausalLM", "MegatronBertForMaskedLM", "MegatronBertForMultipleChoice", "MegatronBertForNextSentencePrediction", "MegatronBertForPreTraining", "MegatronBertForQuestionAnswering",
    "MegatronBertForSequenceClassification", "MegatronBertForTokenClassification", "MegatronBertModel", "MegatronBertPreTrainedModel"])
    _import_structure["models.mgp_str"].extend(["MgpstrForSceneTextRecognition", "MgpstrModel", "MgpstrPreTrainedModel"])
    _import_structure["models.mimi"].extend(["MimiModel", "MimiPreTrainedModel"])
    ...
    _import_structure["models.mllama"].extend(["MllamaForCausalLM", "MllamaForConditionalGeneration", "MllamaPreTrainedModel", "MllamaProcessor", "MllamaTextModel", "MllamaVisionModel"])
    ...
    _import_structure["models.modular_entity"].extend(["ModularEntityForCausalLM", "ModularEntityForConditionalGeneration", "ModularEntityPreTrainedModel", "ModularEntityProcessor", "ModularEntityTextModel", "ModularEntityVisionModel"])
    ...
    _import_structure["models.musicgen"].extend(["MusicgenForCausalLM", "MusicgenForConditionalGeneration", "MusicgenModel", "MusicgenPreTrainedModel", "MusicgenProcessor", "SAPIMusicForConditionalGeneration"])
    ...
    _import_structure["models.omdet_turbo"].extend(["OmDetTurboForObjectDetection", "OmDetTurboPreTrainedModel"])
    ...
    _import_structure["models.sapama"].extend(["SapamaForCausalLM", "SapamaForQuestionAnswering", "SapamaForSequenceClassification", "SapamaForTokenClassification", "SapamaModel", "SapamaPreTrainedModel"])
    _import_structure["models.sapi"].extend(["SAPIForCausalLM", "SAPIForQuestionAnswering", "SAPIForSequenceClassification", "SAPIForTokenClassification", "SAPIModel", "SAPIPreTrainedModel"])
    _import_structure["models.sapi_audio"].extend(["SAPIAudioForAudioClassification", "SAPIAudioForCausalLM", "SAPIAudioForConditionalGeneration", "SAPIAudioModel", "SAPIAudioPreTrainedModel"])
    _import_structure["models.sapi_image"].extend(["SAPIImageForConditionalGeneration", "SAPIImagePreTrainedModel"])
    _import_structure["models.sapi_music"].extend(["SAPIMusicModel", "SAPIMusicPreTrainedModel"])
    _import_structure["models.sapi_musicgen"].extend(["SAPIMusicGenForCausalLM", "SAPIMusicGenForConditionalGeneration", "SAPIMusicGenModel", "SAPIMusicGenPreTrainedModel", "SAPIMusicGenProcessor", "SAPIMusicForConditionalGeneration"])
    _import_structure["models.sapi_video"].extend(["SAPIVideoForConditionalGeneration", "SAPIVideoPreTrainedModel"])
    _import_structure["models.sapi_zero"].extend(["SAPIZeroForCausalLM", "SAPIZeroModel", "SAPIZeroPreTrainedModel"])
    _import_structure["models.sapiens"].extend(["SapiensForCausalLM", "SapiensForSequenceClassification", "SapiensForTokenClassification", "SapiensModel", "SapiensPreTrainedModel"])
    _import_structure["models.sapiens_code"].extend(["SapiensCodeForCausalLM", "SapiensCodeForSequenceClassification", "SapiensCodeForTokenClassification", "SapiensCodeModel", "SapiensCodePreTrainedModel"])
    _import_structure["models.sapiens_vision"].extend(["SapiensVisionForConditionalGeneration", "SapiensVisionModel", "SapiensVisionPreTrainedModel"])
    _import_structure["models.sastral"].extend(["SastralForCausalLM", "SastralForSequenceClassification", "SastralForTokenClassification", "SastralModel", "SastralPreTrainedModel"])
...
try:
    ...
    _import_structure["models.auto"].extend(["TF_MODEL_FOR_AUDIO_CLASSIFICATION_MAPPING", "TF_MODEL_FOR_CAUSAL_LM_MAPPING", "TF_MODEL_FOR_DOCUMENT_QUESTION_ANSWERING_MAPPING", "TF_MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING", "TF_MODEL_FOR_MASKED_IMAGE_MODELING_MAPPING", "TF_MODEL_FOR_MASKED_LM_MAPPING",
    "TF_MODEL_FOR_MASK_GENERATION_MAPPING", "TF_MODEL_FOR_MULTIPLE_CHOICE_MAPPING", "TF_MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING", "TF_MODEL_FOR_PRETRAINING_MAPPING", "TF_MODEL_FOR_QUESTION_ANSWERING_MAPPING", "TF_MODEL_FOR_SEMANTIC_SEGMENTATION_MAPPING", "TF_MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING",
    "TF_MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING", "TF_MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING", "TF_MODEL_FOR_TABLE_QUESTION_ANSWERING_MAPPING", "TF_MODEL_FOR_TEXT_ENCODING_MAPPING", "TF_MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING", "TF_MODEL_FOR_VISION_2_SEQ_MAPPING", "TF_MODEL_FOR_ZERO_SHOT_IMAGE_CLASSIFICATION_MAPPING",
    "TFAutoModelForMaskedLM", "TFAutoModelForMaskGeneration", "TFAutoModelForMultipleChoice", "TFAutoModelForNextSentencePrediction", "TFAutoModelForPreTraining", "TFAutoModelForQuestionAnswering", "TFAutoModelForSemanticSegmentation", "TFAutoModelForSeq2SeqLM", "TFAutoModelForSequenceClassification",
    "TFAutoModelForSpeechSeq2Seq", "TFAutoModelForTableQuestionAnswering", "TFAutoModelForTextEncoding", "TFAutoModelForTokenClassification", "TFAutoModelForVision2Seq", "TFAutoModelForZeroShotImageClassification", "TFAutoModelWithLMHead"])
    ...
    _import_structure["models.sapi_audio"].extend(["TFSAPIAudioForConditionalGeneration", "TFSAPIAudioModel", "TFSAPIAudioPreTrainedModel"])
    _import_structure["models.sastral"].extend(["TFSastralForCausalLM", "TFSastralForSequenceClassification", "TFSastralModel", "TFSastralPreTrainedModel"])
...
try:
    if not (is_librosa_available() and is_essentia_available() and is_scipy_available() and is_torch_available() and is_pretty_midi_available()): raise OptionalDependencyNotAvailable()
except OptionalDependencyNotAvailable:
...
try:
    ...
    _import_structure["generation"].extend(["FlaxForcedBOSTokenLogitsProcessor", "FlaxForcedEOSTokenLogitsProcessor", "FlaxForceTokensLogitsProcessor", "FlaxGenerationMixin", "FlaxLogitsProcessor",
    "FlaxLogitsProcessorList", "FlaxLogitsWarper", "FlaxMinLengthLogitsProcessor", "FlaxTemperatureLogitsWarper", "FlaxSAPIAudioTimeStampLogitsProcessor", "FlaxSuppressTokensAtBeginLogitsProcessor",
     "FlaxSuppressTokensLogitsProcessor", "FlaxTopKLogitsWarper", "FlaxTopPLogitsWarper", "FlaxWhisperTimeStampLogitsProcessor"])
    _import_structure["modeling_flax_outputs"] = []
    _import_structure["modeling_flax_utils"] = ["FlaxPreTrainedModel"]
    _import_structure["models.albert"].extend(["FlaxAlbertForMaskedLM", "FlaxAlbertForMultipleChoice", "FlaxAlbertForPreTraining", "FlaxAlbertForQuestionAnswering",
    "FlaxAlbertForSequenceClassification", "FlaxAlbertForTokenClassification", "FlaxAlbertModel", "FlaxAlbertPreTrainedModel"])
    ...
    "FLAX_MODEL_FOR_MULTIPLE_CHOICE_MAPPING", "FLAX_MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING", "FLAX_MODEL_FOR_PRETRAINING_MAPPING", "FLAX_MODEL_FOR_QUESTION_ANSWERING_MAPPING",
    "FLAX_MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING", "FLAX_MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING", "FLAX_MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING", "FLAX_MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING",
    "FLAX_MODEL_FOR_VISION_2_SEQ_MAPPING", "FLAX_MODEL_MAPPING", "FlaxAutoModel", "FlaxAutoModelForCausalLM", "FlaxAutoModelForImageClassification", "FlaxAutoModelForMaskedLM",
    "FlaxAutoModelForMultipleChoice", "FlaxAutoModelForNextSentencePrediction", "FlaxAutoModelForPreTraining", "FlaxAutoModelForQuestionAnswering", "FlaxAutoModelForSeq2SeqLM",
    "FlaxAutoModelForSequenceClassification", "FlaxAutoModelForSpeechSeq2Seq", "FlaxAutoModelForTokenClassification", "FlaxAutoModelForVision2Seq"])
    ...
    _import_structure["models.entity"].extend(["FlaxEntityForCausalLM", "FlaxEntityModel", "FlaxEntityPreTrainedModel"])
    ...
    _import_structure["models.sapama"].extend(["FlaxSapamaForCausalLM", "FlaxSapamaModel", "FlaxSapamaPreTrainedModel"])
    _import_structure["models.sapi_audio"].extend(["FlaxSAPIAudioForConditionalGeneration", "FlaxSAPIAudioModel", "FlaxSAPIAudioPreTrainedModel", "FlaxSAPIAudioForAudioClassification"])
    _import_structure["models.sastral"].extend(["FlaxSastralForCausalLM", "FlaxSastralModel", "FlaxSastralPreTrainedModel"])
...
if TYPE_CHECKING:
    from .agents import (Agent, CodeAgent, HfApiEngine, ManagedAgent, PipelineTool, ReactAgent, ReactCodeAgent, ReactJsonAgent, Tool, Toolbox, ToolCollection, TransformersEngine, launch_gradio_demo, load_tool, stream_to_gradio, tool)
    ...
    from .models.hurlm import HurLMConfig
    ...
    from .models.modular_entity import (ModularEntityConfig, ModularEntityProcessor)
    ...
    from .models.sapama import SapamaConfig
    from .models.sapi import SAPIConfig
    from .models.sapi_audio import (SAPIAudioConfig, SAPIAudioFeatureExtractor, SAPIAudioProcessor, SAPIAudioTokenizer)
    from .models.sapi_image import (SAPIImageConfig, SAPIImageProcessor)
    from .models.sapi_music import (SAPIMusicConfig, SAPIMusicFeatureExtractor)
    from .models.sapi_musicgen import (SAPIMusicGenConfig, SAPIMusicGenDecoderConfig)
    from .models.sapi_video import (SAPIVideoConfig, SAPIVideoProcessor)
    from .models.sapi_zero import SAPIZeroConfig
    from .models.sapiens import SapiensConfig, SapiensTokenizer
    from .models.sapiens_code import (SapiensCodeConfig)
    from .models.sapiens_vision import (SapiensVisionConfig, SapiensVisionProcessor)
    from .models.sastral import SastralConfig
    ...
    from .pipelines import (AudioClassificationPipeline, AutomaticSpeechRecognitionPipeline, CsvPipelineDataFormat, DepthEstimationPipeline, DocumentQuestionAnsweringPipeline, FeatureExtractionPipeline, FillMaskPipeline, ImageClassificationPipeline, ImageFeatureExtractionPipeline,
    ImageSegmentationPipeline, ImageToImagePipeline, ImageToTextPipeline, JsonPipelineDataFormat, MaskGenerationPipeline, NerPipeline, ObjectDetectionPipeline, PipedPipelineDataFormat, Pipeline, PipelineDataFormat, QuestionAnsweringPipeline, SummarizationPipeline,
    TableQuestionAnsweringPipeline, Text2TextGenerationPipeline, TextClassificationPipeline, TextGenerationPipeline, TextToAudioPipeline, TokenClassificationPipeline, TranslationPipeline, VideoClassificationPipeline, VisualQuestionAnsweringPipeline,
    ZeroShotAudioClassificationPipeline, ZeroShotClassificationPipeline, ZeroShotImageClassificationPipeline, ZeroShotObjectDetectionPipeline, pipeline)
    ...
    from .utils import (CONFIG_NAME, MODEL_CARD_NAME, PYTORCH_PRETRAINED_BERT_CACHE, PYTORCH_TRANSFORMERS_CACHE, SPIECE_UNDERLINE, TF2_WEIGHTS_NAME, TF_WEIGHTS_NAME, TRANSFORMERS_CACHE, WEIGHTS_NAME, TensorType, add_end_docstrings, add_start_docstrings, is_apex_available,
    is_av_available, is_sapiens_machine_available, is_datasets_available, is_decord_available, is_faiss_available, is_flax_available, is_keras_nlp_available, is_phonemizer_available, is_psutil_available, is_py3nvml_available, is_pyctcdecode_available, is_sacremoses_available,
    is_safetensors_available, is_scipy_available, is_sentencepiece_available, is_sklearn_available, is_speech_available, is_tensorflow_text_available, is_tf_available, is_timm_available, is_tokenizers_available, is_torch_available, is_torch_mlu_available,
    is_torch_musa_available, is_torch_neuroncore_available, is_torch_npu_available, is_torch_tpu_available, is_torch_xla_available, is_torch_xpu_available, is_torchvision_available, is_vision_available, logging)
    from .utils.quantization_config import (AqlmConfig, AwqConfig, SapiensMachineConfig, CompressedTensorsConfig, EetqConfig, FbgemmFp8Config, GPTQConfig, HqqConfig, QuantoConfig, TorchAoConfig)
    try:
        if not is_sentencepiece_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_sentencepiece_objects import *
    else:
        ...
        from .models.entity import EntityTokenizer
        ...
        from .models.sapama import SapamaTokenizer
    ...
    try:
        if not is_tokenizers_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_tokenizers_objects import *
    else:
        ...
        from .models.entity import EntityTokenizerFast
        ...
        from .models.sapama import SapamaTokenizerFast
        from .models.sapi_audio import SAPIAudioTokenizerFast
        from .models.sapiens import SapiensTokenizerFast
    ...
    try:
        if not (is_sentencepiece_available() and is_tokenizers_available()): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummies_sentencepiece_and_tokenizers_objects import *
    else: from .convert_slow_tokenizer import (SLOW_TO_FAST_CONVERTERS, convert_slow_tokenizer)
    try:
        if not is_tensorflow_text_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_tensorflow_text_objects import *
    else: from .models.bert import TFBertTokenizer
    try:
        if not is_keras_nlp_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_keras_nlp_objects import *
    else: from .models.gpt2 import TFGPT2Tokenizer
    try:
        if not is_vision_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_vision_objects import *
    else:
        ...
        from .models.hurlm import HurLMImageProcessor
        ...
        from .models.modular_entity import ModularEntityImageProcessor
        ...
        from .models.sapi_image import SAPIImageImageProcessor
        from .models.sapi_video import SAPIVideoImageProcessor
        from .models.sapiens_vision import SapiensVisionImageProcessor
    ...
    try:
        if not is_torchvision_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_torchvision_objects import *
    else:
    ...
    try:
        ...
        from .generation import (AlternatingCodebooksLogitsProcessor, BeamScorer, BeamSearchScorer, ClassifierFreeGuidanceLogitsProcessor, ConstrainedBeamSearchScorer, Constraint, ConstraintListState, DisjunctiveConstraint, EncoderNoRepeatNGramLogitsProcessor, EncoderRepetitionPenaltyLogitsProcessor,
        EosTokenCriteria, EpsilonLogitsWarper, EtaLogitsWarper, ExponentialDecayLengthPenalty, ForcedBOSTokenLogitsProcessor, ForcedEOSTokenLogitsProcessor, GenerationMixin, HammingDiversityLogitsProcessor, InfNanRemoveLogitsProcessor, LogitNormalization, LogitsProcessor, LogitsProcessorList, LogitsWarper,
        MaxLengthCriteria, MaxTimeCriteria, MinLengthLogitsProcessor, MinNewTokensLengthLogitsProcessor, MinPLogitsWarper, NoBadWordsLogitsProcessor, NoRepeatNGramLogitsProcessor, PhrasalConstraint, PrefixConstrainedLogitsProcessor, RepetitionPenaltyLogitsProcessor, SAPIAudioTimeStampLogitsProcessor, SequenceBiasLogitsProcessor, StoppingCriteria,
        ...
        from .models.auto import (MODEL_FOR_AUDIO_CLASSIFICATION_MAPPING, MODEL_FOR_AUDIO_FRAME_CLASSIFICATION_MAPPING, MODEL_FOR_AUDIO_XVECTOR_MAPPING, MODEL_FOR_BACKBONE_MAPPING, MODEL_FOR_CAUSAL_IMAGE_MODELING_MAPPING, MODEL_FOR_CAUSAL_LM_MAPPING, MODEL_FOR_CTC_MAPPING, MODEL_FOR_DEPTH_ESTIMATION_MAPPING,
        MODEL_FOR_DOCUMENT_QUESTION_ANSWERING_MAPPING, MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING, MODEL_FOR_IMAGE_MAPPING, MODEL_FOR_IMAGE_SEGMENTATION_MAPPING, MODEL_FOR_IMAGE_TO_IMAGE_MAPPING, MODEL_FOR_INSTANCE_SEGMENTATION_MAPPING, MODEL_FOR_KEYPOINT_DETECTION_MAPPING, MODEL_FOR_MASK_GENERATION_MAPPING,
        MODEL_FOR_MASKED_IMAGE_MODELING_MAPPING, MODEL_FOR_MASKED_LM_MAPPING, MODEL_FOR_MULTIPLE_CHOICE_MAPPING, MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING, MODEL_FOR_OBJECT_DETECTION_MAPPING, MODEL_FOR_PRETRAINING_MAPPING, MODEL_FOR_QUESTION_ANSWERING_MAPPING, MODEL_FOR_SEMANTIC_SEGMENTATION_MAPPING,
        MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING, MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING, MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING, MODEL_FOR_TABLE_QUESTION_ANSWERING_MAPPING, MODEL_FOR_TEXT_ENCODING_MAPPING, MODEL_FOR_TEXT_TO_SPECTROGRAM_MAPPING, MODEL_FOR_TEXT_TO_WAVEFORM_MAPPING, MODEL_FOR_TIME_SERIES_CLASSIFICATION_MAPPING,
        MODEL_FOR_TIME_SERIES_REGRESSION_MAPPING, MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING, MODEL_FOR_UNIVERSAL_SEGMENTATION_MAPPING, MODEL_FOR_VIDEO_CLASSIFICATION_MAPPING, MODEL_FOR_VISION_2_SEQ_MAPPING, MODEL_FOR_VISUAL_QUESTION_ANSWERING_MAPPING, MODEL_FOR_ZERO_SHOT_IMAGE_CLASSIFICATION_MAPPING,
        MODEL_FOR_ZERO_SHOT_OBJECT_DETECTION_MAPPING, MODEL_MAPPING, MODEL_WITH_LM_HEAD_MAPPING, AutoBackbone, AutoModel, AutoModelForAudioClassification, AutoModelForAudioFrameClassification, AutoModelForAudioXVector, AutoModelForCausalLM, AutoModelForCTC, AutoModelForDepthEstimation,
        AutoModelForDocumentQuestionAnswering, AutoModelForImageClassification, AutoModelForImageSegmentation, AutoModelForImageToImage, AutoModelForInstanceSegmentation, AutoModelForKeypointDetection, AutoModelForMaskedImageModeling, AutoModelForMaskedLM, AutoModelForMaskGeneration,
        AutoModelForMultipleChoice, AutoModelForNextSentencePrediction, AutoModelForObjectDetection, AutoModelForPreTraining, AutoModelForQuestionAnswering, AutoModelForSemanticSegmentation, AutoModelForSeq2SeqLM, AutoModelForSequenceClassification, AutoModelForSpeechSeq2Seq,
        AutoModelForTableQuestionAnswering, AutoModelForTextEncoding, AutoModelForTextToSpectrogram, AutoModelForTextToWaveform, AutoModelForTokenClassification, AutoModelForUniversalSegmentation, AutoModelForVideoClassification, AutoModelForVision2Seq,
        AutoModelForVisualQuestionAnswering, AutoModelForZeroShotImageClassification, AutoModelForZeroShotObjectDetection, AutoModelWithLMHead)
        ...
        from .models.data2vec import (Data2VecAudioForAudioFrameClassification, Data2VecAudioForCTC, Data2VecAudioForSequenceClassification, Data2VecAudioForXVector, Data2VecAudioModel, Data2VecAudioPreTrainedModel, Data2VecTextForCausalLM, Data2VecTextForMaskedLM, Data2VecTextForMultipleChoice,
        Data2VecTextForQuestionAnswering, Data2VecTextForSequenceClassification, Data2VecTextForTokenClassification, Data2VecTextModel, Data2VecTextPreTrainedModel, Data2VecVisionForImageClassification, Data2VecVisionForSemanticSegmentation, Data2VecVisionModel, Data2VecVisionPreTrainedModel)
        ...
        from .models.entity import (EntityForCausalLM, EntityForQuestionAnswering, EntityForSequenceClassification, EntityForTokenClassification, EntityModel, EntityPreTrainedModel)
        ...
        from .models.hurlm import (HurLMForConditionalGeneration, HurLMModel, HurLMPreTrainedModel, HurLMProcessor)
        ...
        from .models.mllama import (MllamaForCausalLM, MllamaForConditionalGeneration, MllamaPreTrainedModel, MllamaProcessor, MllamaTextModel, MllamaVisionModel)
        ...
        from .models.modular_entity import (ModularEntityForCausalLM, ModularEntityForConditionalGeneration, ModularEntityPreTrainedModel, ModularEntityProcessor, ModularEntityTextModel, ModularEntityVisionModel)
        ...
        from .models.musicgen import (MusicgenForCausalLM, MusicgenForConditionalGeneration, MusicgenModel, MusicgenPreTrainedModel, MusicgenProcessor, SAPIMusicForConditionalGeneration)
        ...
        from .models.sapama import (SapamaForCausalLM, SapamaForQuestionAnswering, SapamaForSequenceClassification, SapamaForTokenClassification, SapamaModel, SapamaPreTrainedModel)
        from .models.sapi import (SAPIForCausalLM, SAPIForQuestionAnswering, SAPIForSequenceClassification, SAPIForTokenClassification, SAPIModel, SAPIPreTrainedModel)
        from .models.sapi_audio import (SAPIAudioForAudioClassification, SAPIAudioForCausalLM, SAPIAudioForConditionalGeneration, SAPIAudioModel, SAPIAudioPreTrainedModel)
        from .models.sapi_image import (SAPIImageForConditionalGeneration, SAPIImagePreTrainedModel)
        from .models.sapi_music import (SAPIMusicModel, SAPIMusicPreTrainedModel)
        from .models.sapi_musicgen import (SAPIMusicGenForCausalLM, SAPIMusicGenForConditionalGeneration, SAPIMusicGenModel, SAPIMusicGenPreTrainedModel, SAPIMusicGenProcessor, SAPIMusicForConditionalGeneration)
        from .models.sapi_video import (SAPIVideoForConditionalGeneration, SAPIVideoPreTrainedModel)
        from .models.sapi_zero import (SAPIZeroForCausalLM, SAPIZeroModel, SAPIZeroPreTrainedModel)
        from .models.sapiens import (SapiensForCausalLM, SapiensForSequenceClassification, SapiensForTokenClassification, SapiensModel, SapiensPreTrainedModel)
        from .models.sapiens_code import (SapiensCodeForCausalLM, SapiensCodeForSequenceClassification, SapiensCodeForTokenClassification, SapiensCodeModel, SapiensCodePreTrainedModel)
        from .models.sapiens_vision import (SapiensVisionForConditionalGeneration, SapiensVisionModel, SapiensVisionPreTrainedModel)
        from .models.sastral import (SastralForCausalLM, SastralForSequenceClassification, SastralForTokenClassification, SastralModel, SastralPreTrainedModel)
    ...
    try:
        if not is_tf_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_tf_objects import *
    else:
        ...
        from .models.sapi_audio import (TFSAPIAudioForConditionalGeneration, TFSAPIAudioModel, TFSAPIAudioPreTrainedModel)
        from .models.sastral import (TFSastralForCausalLM, TFSastralForSequenceClassification, TFSastralModel, TFSastralPreTrainedModel)
    ...
    try:
        if not (is_librosa_available() and is_essentia_available() and is_scipy_available() and is_torch_available() and is_pretty_midi_available()): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_essentia_and_librosa_and_pretty_midi_and_scipy_and_torch_objects import *
    else: from .models.pop2piano import (Pop2PianoFeatureExtractor, Pop2PianoProcessor, Pop2PianoTokenizer)
    try:
        if not is_torchaudio_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_torchaudio_objects import *
    else: from .models.musicgen_melody import MusicgenMelodyFeatureExtractor, MusicgenMelodyProcessor
    try:
        if not is_flax_available(): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from .utils.dummy_flax_objects import *
    else:
        from .generation import (FlaxForcedBOSTokenLogitsProcessor, FlaxForcedEOSTokenLogitsProcessor, FlaxForceTokensLogitsProcessor, FlaxGenerationMixin, FlaxLogitsProcessor, FlaxLogitsProcessorList, FlaxLogitsWarper, FlaxMinLengthLogitsProcessor, FlaxSAPIAudioTimeStampLogitsProcessor, FlaxSuppressTokensAtBeginLogitsProcessor, FlaxSuppressTokensLogitsProcessor, FlaxTemperatureLogitsWarper, FlaxTopKLogitsWarper, FlaxTopPLogitsWarper, FlaxWhisperTimeStampLogitsProcessor)
        ...
        FlaxAutoModelForPreTraining, FlaxAutoModelForQuestionAnswering, FlaxAutoModelForSeq2SeqLM, FlaxAutoModelForSequenceClassification, FlaxAutoModelForSpeechSeq2Seq, FlaxAutoModelForTokenClassification, FlaxAutoModelForVision2Seq)
        ...
        from .models.entity import (FlaxEntityForCausalLM, FlaxEntityModel, FlaxEntityPreTrainedModel)
        ...
        from .models.sapama import (FlaxSapamaForCausalLM, FlaxSapamaModel, FlaxSapamaPreTrainedModel)
        from .models.sapi_audio import (FlaxSAPIAudioForAudioClassification, FlaxSAPIAudioForConditionalGeneration, FlaxSAPIAudioModel, FlaxSAPIAudioPreTrainedModel)
        from .models.sastral import (FlaxSastralForCausalLM, FlaxSastralModel, FlaxSastralPreTrainedModel)
...
if not is_tf_available() and not is_torch_available() and not is_flax_available(): logger.warning_advice("None of PyTorch, TensorFlow >= 2.0, or Flax have been found. Models won't be available and only tokenizers, configuration and file/data utilities can be used.")
"""
    #################################################################################################################################################################################################
    # This code library is an adaptation of the original Transformers and was designed, developed and programmed by Sapiens Technology®.                                                            #
    # Any alteration and/or disclosure of this code without prior authorization is strictly prohibited and is subject to legal action that will be forwarded by the Sapiens Technology® legal team. #
