...
from ..sapi_videogen.pipeline_output import SAPIVideoGenPipelineOutput
from ..free_init_utils import FreeInitMixin
from ..free_noise_utils import SAPIVideoGenFreeNoiseMixin
from ..pipeline_utils import DiffusionPipeline, StableDiffusionMixin
from .pag_utils import PAGMixin
EXAMPLE_DOC_STRING = ''
class SAPIVideoGenPAGPipeline(DiffusionPipeline, StableDiffusionMixin, TextualInversionLoaderMixin, IPAdapterMixin, StableDiffusionLoraLoaderMixin, FreeInitMixin, SAPIVideoGenFreeNoiseMixin, PAGMixin):
    """Args:"""
