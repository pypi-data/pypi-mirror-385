...
from ...utils import DIFFUSERS_SLOW_IMPORT, OptionalDependencyNotAvailable, _LazyModule, get_objects_from_module, is_torch_available, is_transformers_available, is_sapiens_transformers_version
_dummy_objects = {}
_import_structure = {}
try:
...
else: _import_structure['pipeline_musicldm'] = ['MusicLDMPipeline']
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        if not (is_transformers_available() and is_torch_available() and is_sapiens_transformers_version('>=', '4.27.0')): raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable: from ...utils.dummy_torch_and_transformers_objects import *
    else: from .pipeline_musicldm import MusicLDMPipeline
else:
    import sys
