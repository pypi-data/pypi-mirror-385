...
try:
    ...
    _import_structure['renderer'] = ['BoundingBoxVolume', 'ImportanceRaySampler', 'MLPNeRFModelOutput', 'MLPNeRSTFModel', 'ShapEParamsProjModel', 'ShapERenderer', 'StratifiedRaySampler', 'VoidNeRFModel']
