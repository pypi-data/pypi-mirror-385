...
else: _import_structure["modeling_jukebox"] = ["JukeboxModel", "JukeboxPreTrainedModel", "JukeboxVQVAE", "JukeboxPrior"]
if TYPE_CHECKING:
    ...
    else: from .modeling_jukebox import (JukeboxModel, JukeboxPreTrainedModel, JukeboxPrior, JukeboxVQVAE)
else:
    import sys
