...
if is_sentencepiece_available(): from .tokenization_barthez import BarthezTokenizer
else: BarthezTokenizer = None
...
class BarthezTokenizerFast(PreTrainedTokenizerFast):
    ...
    pad_token="<pad>", mask_token="<mask>", **kwargs):
        ...
        super().__init__(vocab_file, tokenizer_file=tokenizer_file, bos_token=bos_token, eos_token=eos_token, unk_token=unk_token,
        sep_token=sep_token, cls_token=cls_token, pad_token=pad_token, mask_token=mask_token, **kwargs)
