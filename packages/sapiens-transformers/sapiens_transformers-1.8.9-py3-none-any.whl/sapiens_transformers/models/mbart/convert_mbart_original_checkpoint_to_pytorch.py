...
from sapiens_transformers import MBartConfig, MBartForConditionalGeneration
...
def convert_fairseq_mbart_checkpoint_from_disk(checkpoint_path, hf_config_path="facebook/mbart-large-en-ro", finetuned=False, mbart_50=False):
    ...
    if mbart_50 and finetuned: mbart_config.activation_function = "relu"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hf_config", default="facebook/mbart-large-cc25", type=str, help="Which architecture to use: mbart-large")
