...
else: _import_structure["modeling_owlvit"] = ["OwlViTModel", "OwlViTPreTrainedModel", "OwlViTTextModel", "OwlViTVisionModel", "OwlViTForObjectDetection"]
if TYPE_CHECKING:
    ...
    else: from .modeling_owlvit import (OwlViTForObjectDetection, OwlViTModel, OwlViTPreTrainedModel, OwlViTTextModel, OwlViTVisionModel)
else:
    import sys
