...
else: _import_structure["modeling_levit"] = ["LevitForImageClassification", "LevitForImageClassificationWithTeacher", "LevitModel", "LevitPreTrainedModel"]
if TYPE_CHECKING:
    ...
    else: from .modeling_levit import (LevitForImageClassification, LevitForImageClassificationWithTeacher, LevitModel, LevitPreTrainedModel)
else:
    import sys
