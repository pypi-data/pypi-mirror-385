...
try:
    ...
    _import_structure['pipeline_pag_sapi_imagegen'] = ['SAPIImageGenPAGPipeline']
    _import_structure['pipeline_pag_sapi_imagegen_img2img'] = ['SAPIImageGenPAGImg2ImgPipeline']
    _import_structure['pipeline_pag_sapiens_imagegen'] = ['SapiensImageGenPAGPipeline']
    ...
    _import_structure['pipeline_pag_sd_sapi_videogen'] = ['SAPIVideoGenPAGPipeline']
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_pag_sapi_imagegen import SAPIImageGenPAGPipeline
        from .pipeline_pag_sapi_imagegen_img2img import SAPIImageGenPAGImg2ImgPipeline
        from .pipeline_pag_sapiens_imagegen import SapiensImageGenPAGPipeline
        ...
        from .pipeline_pag_sd_sapi_videogen import SAPIVideoGenPAGPipeline
