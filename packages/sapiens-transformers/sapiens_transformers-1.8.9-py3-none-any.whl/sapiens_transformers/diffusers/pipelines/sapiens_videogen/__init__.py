...
try:
    ...
    _import_structure['pipeline_sapiens_videogen'] = ['SapiensVideoGenPipeline']
    _import_structure['pipeline_sapiens_videogen_image2video'] = ['SapiensVideoGenImageToVideoPipeline']
if SAPIENS_TECHNOLOGY_CHECKING or SAPIENS_TECHNOLOGY_IMPORT:
    try:
        ...
        from .pipeline_sapiens_videogen import SapiensVideoGenPipeline
        from .pipeline_sapiens_videogen_image2video import SapiensVideoGenImageToVideoPipeline
else:
    import sys
