...
from sapiens_transformers import FlaxT5ForConditionalGeneration, T5Config
def convert_t5x_checkpoint_to_flax(t5x_checkpoint_path, config_name, flax_dump_folder_path):
    ...
    for layer_index in range(config.num_layers):
        ...
        else: flax_model.params["encoder"]["block"][str(layer_index)]["layer"]["1"]["DenseReluDense"]["wi"]["kernel"] = (t5x_mlp_wi)
    ...
    for layer_index in range(config.num_decoder_layers):
        ...
        else: flax_model.params["decoder"]["block"][str(layer_index)]["layer"]["2"]["DenseReluDense"]["wi"]["kernel"] = (t5x_mlp_wi)
