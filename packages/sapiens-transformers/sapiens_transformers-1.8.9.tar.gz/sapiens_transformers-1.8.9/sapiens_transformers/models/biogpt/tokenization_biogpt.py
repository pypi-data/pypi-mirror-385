...
class BioGptTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, merges_file, unk_token="<unk>", bos_token="<s>", eos_token="</s>", sep_token="</s>", pad_token="<pad>", **kwargs):
        ...
        except ImportError: raise ImportError("You need to install sacremoses to use BioGptTokenizer. See https://pypi.org/project/sacremoses/ for installation.")
        self.lang = "en"
        self.sm = sacremoses
    ...
    def _tokenize(self, text, bypass_tokenizer=False):
        ...
        else: text = self.moses_tokenize(text, self.lang)
        split_tokens = []
        for token in text:
