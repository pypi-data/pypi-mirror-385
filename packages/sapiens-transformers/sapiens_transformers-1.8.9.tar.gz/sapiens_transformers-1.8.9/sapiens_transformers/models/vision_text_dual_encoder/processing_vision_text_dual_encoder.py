...
class VisionTextDualEncoderProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, **kwargs):
        ...
        if image_processor is None: raise ValueError("You have to specify an image_processor.")
        if tokenizer is None: raise ValueError("You have to specify a tokenizer.")
