...
else: _import_structure["modeling_m2m_100"] = ["M2M100ForConditionalGeneration", "M2M100Model", "M2M100PreTrainedModel"]
if TYPE_CHECKING:
    ...
    else: from .modeling_m2m_100 import (M2M100ForConditionalGeneration, M2M100Model, M2M100PreTrainedModel)
else:
    import sys
