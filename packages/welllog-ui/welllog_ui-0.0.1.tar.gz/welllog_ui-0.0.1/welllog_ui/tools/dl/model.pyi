...
class VQVAE1D(DLModelManager):
    def __init__(self: Self, cfg: WellLogTrainConfig, scaler_mean: Any, scaler_std: Any) -> None: ...
...
class WellLogModel_Lightning(DLModelManager):
    def __init__(self: Self, wltcfg: WellLogTrainConfig, scaler_mean: Any, scaler_std: Any, label_ch_idxs: Optional[Sequence[int]], label_ch_names: Optional[Sequence[str]], mlm_prob: float, block_size: int, density_threshold: float) -> None: ...
