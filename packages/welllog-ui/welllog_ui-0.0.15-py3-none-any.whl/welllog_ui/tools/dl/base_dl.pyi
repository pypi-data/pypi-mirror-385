...
class UiProgressCallback:
    def __init__(self: Self, total_epochs: int, on_log: Optional[Callable[[str], None]], on_metrics: Optional[Callable[[dict], None]], on_progress: Optional[Callable[[int], None]], should_stop_fn: Optional[Callable[[], bool]]) -> None: ...
