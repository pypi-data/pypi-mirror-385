...
def basic_operations_example():
    ...
    # Vektorlar yaratish (b <= a <= c sharti bajarilgan)
    # v1 = FuzzyTriangular(5.0, 0.4, 0.6)  # a > 0
    # v2 = FuzzyTriangular(3.0, 0.5, 0.7)  # a > 0
    v1 = FuzzyTriangular(5.0, 5.0 - 0.4, 5.0 + 0.6)  # core=5.0, left=4.6, right=5.6
    v2 = FuzzyTriangular(3.0, 3.0 - 0.5, 3.0 + 0.7)  # core=3.0, left=2.5, right=3.7
