# Cosmicintersection Sdk-python

A Python SDK cosmicintersection for building GraphQL-based API clients quickly. This SDK provides a structured foundation for creating Python SDKs that interact with GraphQL APIs, similar to the Node.js workspace SDK but adapted for Python.
...
```python
import asyncio
from cosmicintersection_sdk import BoilerSDK, BoilerSDKConfig
from cosmicintersection_sdk.types.common import UserRegisterInput
...
```python
from cosmicintersection_sdk import BoilerSDKConfig
...
cd cosmicintersection-sdk-python
...
pytest --cov=cosmicintersection_sdk --cov-report=html
```
...
# Run with coverage
pytest --cov=cosmicintersection_sdk
...
```bash
mypy src/cosmicintersection_sdk
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/algoshred/cosmicintersection-sdk-python/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/algoshred/cosmicintersection-sdk-python/discussions)

## Related Projects

- [Workspaces SDK Node.js](../workspaces-sdk-node) - The Node.js version this SDK is based on
- [Boiler Frontend](../cosmicintersection-frontend) - Frontend cosmicintersection
- [Boiler Backend](../cosmicintersection-python-be-graphql) - Python GraphQL backend cosmicintersection