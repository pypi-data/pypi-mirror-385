...
Simply import `AsyncRactorlabs` instead of `Ractorlabs` and use `await` with each API call:
...
```sh
# install from PyPI
pip install ractorlabs[aiohttp]
```
