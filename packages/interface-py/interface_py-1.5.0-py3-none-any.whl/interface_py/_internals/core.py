    ...
    def __new__(mcls, name, bases, namespace):
        ...
        for ann_attr, _ in annotations.items():
            if ann_attr not in namespace:
                cls._interface_contracts_[ann_attr] = ("field", None, None)
    ...
    def __validate__(cls):
        ...
        if cls._is_interface_:
            ...
            for attr, value in all_attrs:
                ...
                if ann is not None:
                    cls._interface_contracts_[attr] = ("field", None, ann)
                    setattr(cls, attr, Ellipsis)
                    continue
                ...
                if isinstance(value, type):
                    cls._interface_contracts_[attr] = ("field", None, value)
                    setattr(cls, attr, Ellipsis)
                    continue
