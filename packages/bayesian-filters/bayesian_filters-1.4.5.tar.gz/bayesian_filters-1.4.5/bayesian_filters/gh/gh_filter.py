...
def optimal_noise_smoothing(g):
    ...
    .. code-block:: Python
        ...
        from bayesian_filters.gh import GHKFilter, optimal_noise_smoothing
    ...
    h = ((2 * g**3 - 4 * g**2) + (4 * g**6 - 64 * g**5 + 64 * g**4) ** 0.5) / (8 * (1 - g))
    k = (h * (2 - g) - g**2) / g
...
def least_squares_parameters(n):
    ...
    .. code-block:: Python
        ...
        from bayesian_filters.gh import GHFilter, least_squares_parameters
...
def critical_damping_parameters(theta, order=2):
    ...
    .. code-block:: Python
        ...
        from bayesian_filters.gh import GHFilter, critical_damping_parameters
...
def benedict_bornder_constants(g, critical=False):
    ...
    .. code-block:: Python
        ...
        from bayesian_filters.gh import GHFilter, benedict_bornder_constants
