...
class Lotacao(BaseModel):
    ...
    codigoUnidade: str = Field(
        ..., description="Código do organograma da unidade raiz/pai"
    )
    numeroUnidade: int = Field(..., description="Integer do número da unidade")
    unidadeOriginal: str = Field(..., description="Sigla da unidade raiz/pai")
    nomeUnidade: str = Field(
        ..., description="Nome da unidade raiz/pai em caixa alta sem acentuação"
    )
    nomeUnidadeAcentuada: Optional[str] = Field(
        None, description="Nome da unidade formatado e acentuado"
    )
    categoriaUnidade: str = Field(..., description="Categoria da unidade")
    local: str = Field(..., description="Sigla do local")
    nomeLocal: Optional[str] = Field(None, description="Nome do local")
    codigoLocal: str = Field(..., description="Código do organograma do local")
    numeroLocal: int = Field(..., description="Número da lotação da unidade")
