...
class Timeseries(AsyncApiServiceModel):
    @classmethod
    ...
    async def list_timeseries(
        ...
        **kwargs:
        ...
        return (
            cast(
                Union[KList[type.TimeseriesData], responses.TimeseriesListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/timeseries/list", result, "POST", data),
            )
    ...
    @classmethod
    async def download_timeseries_range(
        cls,
    ...
    async def get_timeseries_range(
        ...
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
    ) -> AsyncKIterator[responses.TimeseriesRangeGet]:
        """
