...
class AppWorkloads(AsyncApiServiceModel):
    @classmethod
    ...
    @classmethod
    async def update_workloads_bulk(
        cls,
    ...
    async def list_workloads(
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        return (
            cast(
                Union[KList[type.WorkloadSummary], responses.WorkloadsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/apps/workloads/list", result, "GET"),
            )
    ...
    @classmethod
    async def add_workload_resources(
        cls,
        workload_name: str,
    ...
    @classmethod
    async def remove_workload_resources(
        cls,
        workload_name: str,
