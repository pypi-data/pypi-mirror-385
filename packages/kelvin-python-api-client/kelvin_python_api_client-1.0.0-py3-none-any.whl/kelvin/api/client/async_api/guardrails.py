...
class Guardrails(AsyncApiServiceModel):
    @classmethod
    async def create_bulk_guardrails(
        cls,
        data: Optional[Union[requests.BulkGuardrailsCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/guardrails/bulk/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.BulkGuardrailsCreate,
            array_body=False,
            result_types={
    ...
    @classmethod
    async def delete_bulk_guardrails(
        cls,
        data: Optional[Union[requests.BulkGuardrailsDelete, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
    ) -> None:
        ...
        **kwargs:
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/guardrails/bulk/delete",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.BulkGuardrailsDelete,
            array_body=False,
            result_types={
                "200": None,
                "207": None,
    ...
    async def create_guardrail(
        cls,
        data: Optional[Union[requests.GuardrailCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/guardrails/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.GuardrailCreate,
            array_body=False,
            result_types={
    ...
    async def list_guardrails(
        ...
        data: Optional[Union[requests.GuardrailsList, Mapping[str, object]]] = None,
        fetch: bool = True,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            ...
            headers={},
            data=data,
            body_type=requests.GuardrailsList,
            array_body=False,
            result_types={
        ...
        return (
            cast(
                Union[KList[type.Guardrail], responses.GuardrailsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/guardrails/list", result, "POST", data),
            )
    ...
    async def delete_guardrail(
        ...
        **Permission Required:** `kelvin.permission.guardrails.delete`.
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/guardrails/{resource}/delete",
    ...
    async def get_guardrail(
        ...
        **Permission Required:** `kelvin.permission.guardrails.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/guardrails/{resource}/get",
            values={"resource": resource},
            params={},
            files={},
            headers={},
    ...
    async def update_guardrail(
        cls,
        resource: str,
        data: Optional[Union[requests.GuardrailUpdate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/guardrails/{resource}/update",
            values={"resource": resource},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.GuardrailUpdate,
            array_body=False,
            result_types={
