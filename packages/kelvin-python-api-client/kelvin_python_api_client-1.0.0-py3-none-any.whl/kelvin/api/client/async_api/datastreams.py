...
class Datastreams(AsyncApiServiceModel):
    @classmethod
    async def create_bulk_data_stream(
        cls,
        data: Optional[Union[requests.BulkDataStreamCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        ...
        **kwargs:
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/bulk/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.BulkDataStreamCreate,
            array_body=False,
            result_types={
                "201": None,
                "207": None,
    ...
    @classmethod
    async def delete_bulk_data_stream(
        cls,
        data: Optional[Union[requests.BulkDataStreamDelete, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
    ) -> None:
        ...
        **kwargs:
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/bulk/delete",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.BulkDataStreamDelete,
            array_body=False,
            result_types={
                "200": None,
                "207": None,
    ...
    @classmethod
    async def list_data_stream_contexts(
        cls,
        ...
        data: Optional[Union[requests.DataStreamContextsList, Mapping[str, object]]] = None,
        fetch: bool = True,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/context/list",
            values={},
            params={
            ...
            headers={},
            data=data,
            body_type=requests.DataStreamContextsList,
            array_body=False,
            result_types={
        ...
        return (
            cast(
                Union[KList[responses.DataStreamContext], responses.DataStreamContextsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/datastreams/context/list", result, "POST", data),
            )
    ...
    async def create_data_stream(
        cls,
        data: Optional[Union[requests.DataStreamCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamCreate,
            array_body=False,
            result_types={
                "201": responses.DataStreamCreate,
                "400": response.Error,
                "401": response.Error,
                "409": response.Error,
            },
    ...
    @classmethod
    async def list_data_streams_data_types(
        cls,
        pagination_type: Optional[Literal["limits", "cursor", "stream"]] = None,
        page_size: Optional[int] = 10000,
        page: Optional[int] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/data-types/list",
            values={},
            params={
                "pagination_type": pagination_type,
                "page_size": page_size,
        ...
        return (
            cast(
                Union[KList[type.DataStreamDataType], responses.DataStreamsDataTypesListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/datastreams/data-types/list", result, "GET"),
            )
            if fetch and not _dry_run
            else result
        )
    ...
    async def list_data_streams(
        ...
        direction: Optional[Literal["asc", "desc"]] = None,
        sort_by: Optional[Sequence[str]] = None,
        data: Optional[Union[requests.DataStreamsList, Mapping[str, object]]] = None,
        fetch: bool = True,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            ...
            headers={},
            data=data,
            body_type=requests.DataStreamsList,
            array_body=False,
            result_types={
                "200": responses.DataStreamsListPaginatedResponseCursor,
                "400": response.Error,
                "401": response.Error,
            },
            stream=False,
        ...
        return (
            cast(
                Union[KList[responses.DataStream], responses.DataStreamsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/datastreams/list", result, "POST", data),
            )
            if fetch and not _dry_run
            else result
        )
    ...
    @classmethod
    async def create_data_stream_semantic_type(
        cls,
        data: Optional[Union[requests.DataStreamSemanticTypeCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/semantic-types/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamSemanticTypeCreate,
            array_body=False,
            result_types={
    ...
    @classmethod
    async def list_data_streams_semantic_types(
        cls,
        pagination_type: Optional[Literal["limits", "cursor", "stream"]] = None,
        page_size: Optional[int] = 10000,
        page: Optional[int] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/semantic-types/list",
            values={},
            params={
                "pagination_type": pagination_type,
                "page_size": page_size,
        ...
        return (
            cast(
                ...
                await cls.fetch(_client, "/api/v4/datastreams/semantic-types/list", result, "GET"),
            )
            if fetch and not _dry_run
            else result
        )
    ...
    @classmethod
    async def delete_data_stream_semantic_type(
        cls,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/semantic-types/{semantic_type_name}/delete",
            values={"semantic_type_name": semantic_type_name},
            params={},
            files={},
            headers={},
            data=None,
    ...
    @classmethod
    async def get_data_stream_semantic_type(
        cls,
        semantic_type_name: str,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/semantic-types/{semantic_type_name}/get",
            values={"semantic_type_name": semantic_type_name},
            params={},
            files={},
            headers={},
    ...
    @classmethod
    async def update_data_stream_semantic_type(
        cls,
        semantic_type_name: str,
        data: Optional[Union[requests.DataStreamSemanticTypeUpdate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/semantic-types/{semantic_type_name}/update",
            values={"semantic_type_name": semantic_type_name},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamSemanticTypeUpdate,
            array_body=False,
            result_types={
    ...
    @classmethod
    async def create_bulk_data_stream_unit(
        cls,
        data: Optional[Union[requests.BulkDataStreamUnitCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
    ) -> None:
        ...
        **kwargs:
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/units/bulk/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.BulkDataStreamUnitCreate,
            array_body=False,
            result_types={
                "201": None,
                "207": None,
    ...
    @classmethod
    async def create_data_stream_unit(
        cls,
        data: Optional[Union[requests.DataStreamUnitCreate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/units/create",
            values={},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamUnitCreate,
            array_body=False,
            result_types={
    ...
    @classmethod
    async def list_data_streams_units(
        cls,
        pagination_type: Optional[Literal["limits", "cursor", "stream"]] = None,
        page_size: Optional[int] = 10000,
        page: Optional[int] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/units/list",
            values={},
            params={
                "pagination_type": pagination_type,
                "page_size": page_size,
        ...
        return (
            cast(
                Union[KList[type.Unit], responses.DataStreamsUnitsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/datastreams/units/list", result, "GET"),
            )
            if fetch and not _dry_run
            else result
        )
    ...
    @classmethod
    async def delete_data_stream_unit(
        cls,
        unit_name: str,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.delete`.
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/units/{unit_name}/delete",
    ...
    @classmethod
    async def get_data_stream_unit(
        cls,
        unit_name: str,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/units/{unit_name}/get",
            values={"unit_name": unit_name},
            params={},
            files={},
            headers={},
            ...
            array_body=False,
            result_types={
                "200": responses.DataStreamUnitGet,
                "400": response.Error,
                "401": response.Error,
                "404": response.Error,
            },
    ...
    @classmethod
    async def update_data_stream_unit(
        cls,
        unit_name: str,
        data: Optional[Union[requests.DataStreamUnitUpdate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/units/{unit_name}/update",
            values={"unit_name": unit_name},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamUnitUpdate,
            array_body=False,
            result_types={
    ...
    @classmethod
    async def get_data_stream_context(
        cls,
        datastream_name: str,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/{datastream_name}/context/get",
            values={"datastream_name": datastream_name},
            params={},
            files={},
            headers={},
            data=None,
    ...
    async def delete_data_stream(
        ...
        **Permission Required:** `kelvin.permission.datastreams.delete`.
        ...
        await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/{datastream_name}/delete",
            values={"datastream_name": datastream_name},
            params={},
            files={},
            headers={},
    ...
    async def get_data_stream(
        ...
        **Permission Required:** `kelvin.permission.datastreams.read`.
        ...
        result = await cls._make_request(
            client=_client,
            method="get",
            path="/api/v4/datastreams/{datastream_name}/get",
            values={"datastream_name": datastream_name},
            params={},
            files={},
            headers={},
    ...
    async def update_data_stream(
        cls,
        datastream_name: str,
        data: Optional[Union[requests.DataStreamUpdate, Mapping[str, object]]] = None,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
        **kwargs: object,
        ...
        **kwargs:
        ...
        result = await cls._make_request(
            client=_client,
            method="post",
            path="/api/v4/datastreams/{datastream_name}/update",
            values={"datastream_name": datastream_name},
            params={},
            files={},
            headers={},
            data=data,
            body_type=requests.DataStreamUpdate,
            array_body=False,
            result_types={
                "200": responses.DataStreamUpdate,
                "400": response.Error,
                "401": response.Error,
                "404": response.Error,
            },
