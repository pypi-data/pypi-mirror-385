...
class DeprecatedWorkload(AsyncApiServiceModel):
    @classmethod
    async def apply_legacy_workload(
        cls,
    ...
    @classmethod
    async def deploy_legacy_workload(
        cls,
    ...
    @classmethod
    async def list_legacy_workloads(
        cls,
        ...
        **Permission Required:** `kelvin.permission.workload.read`.
        ...
        return (
            cast(
                Union[KList[responses.LegacyWorkloadItem], responses.LegacyWorkloadsListPaginatedResponseCursor],
                await cls.fetch(_client, "/api/v4/workloads/list", result, "GET"),
            )
    ...
    @classmethod
    async def get_legacy_workload_configuration(
        cls,
        workload_name: str,
        _dry_run: bool = False,
        _client: Optional[AsyncBaseClient] = None,
    ...
    @classmethod
    async def update_legacy_workload_configuration(
        cls,
        workload_name: str,
    ...
    @classmethod
    async def download_legacy_workload(
        cls,
        workload_name: str,
    ...
    @classmethod
    async def get_legacy_workload_logs(
        cls,
        workload_name: str,
