...
The package ``ut_log`` can be installed from PyPI.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ut_log
...
The Package ``ut_log`` consist of the following file types (c.f.: **Appendix**: `Python Terminology`):
...
The Package ``ut_log`` contains the following modules.

  .. ut_log-Modules-label:
  .. table:: *ut_log Modules*
...
Module: log.py of Package: ut_log
=====================================
