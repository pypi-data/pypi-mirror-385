...
def print_version(ctx, param, value):
    ...
    if not value or ctx.resilient_parsing:
        return
    console.print("[bold green]Quantum Docker Engine[/bold green]")
    console.print(f"Version: [cyan]1.0.3[/cyan]")
    console.print(f"Python Package: [yellow]quantum-docker-engine[/yellow]")
    ctx.exit()
